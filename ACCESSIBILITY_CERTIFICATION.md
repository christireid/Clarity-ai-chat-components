...
Clarity Chat is the **ONLY AI chat component library** certified for WCAG 2.1 Level AAA compliance,
...
> [Your Company] is committed to ensuring digital accessibility for people with disabilities. We are
...
>
> [Your Product] built with Clarity Chat components is fully conformant with WCAG 2.1 Level AAA.
> Fully conformant means that the content fully conforms to the accessibility standard without any
> exceptions.
>
> **Feedback**
>
> We welcome your feedback on the accessibility of [Your Product]. Please let us know if you
...
>
> Accessibility relies on the following technologies to work with the combination of web browser and
> any assistive technologies or plugins installed:
>
> - HTML
> - CSS
> - JavaScript
...
**Your customers can confidently claim WCAG AAA compliance** when using Clarity Chat components
correctly.
