 ...
 *
 * @deprecated This legacy ToolRegistry has been removed.
 * Please use the canonical ToolRegistry from '@clarity/core/tool-registry':
 *
 * ```typescript
 * // Old (removed):
 ...
 */
// Re-export canonical ToolRegistry for backward compatibility
