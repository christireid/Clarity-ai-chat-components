...
export interface Conversation {
  ...
  updatedAt?: number
  /** When the conversation was archived (if archived) */
  archivedAt?: number
}
...
export interface FilterOptions {
  ...
  /** Show archived conversations (default: false) */
  showArchived?: boolean
  /** Show only archived conversations (default: false) */
...
export interface ConversationListProps {
  ...
  /** Callback when conversation is archived/unarchived */
