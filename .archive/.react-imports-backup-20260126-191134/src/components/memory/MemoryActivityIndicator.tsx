...
import { getActivityLabel, getActivityIcon } from '../../hooks/memory/use-memory-feedback'
    ...
    <AnimatePresence>
      {activity && (
        <motion.div
          ...
          animate="visible"
          exit="exit"
          transition={ANIMATION_PRESETS.springBouncy}
          className={cn(
        ...
        >
          ...
          {activity.success !== false && (
            <motion.div
              initial={{ scale: 0 }}
              animate={{ scale: 1 }}
              transition={{ delay: 0.2, ...ANIMATION_PRESETS.springBouncy }}
