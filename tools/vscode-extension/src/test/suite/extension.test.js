...
suite('Configuration', () => {
    test('Default configuration values should be set', () => {
        ...
        assert.strictEqual(config.get('enableIntelliSense'), true, 'enableIntelliSense should default to true');
        assert.strictEqual(config.get('enableCodeLens'), true, 'enableCodeLens should default to true');
        assert.strictEqual(config.get('defaultProvider'), 'openai', 'defaultProvider should default to openai');
        assert.strictEqual(config.get('showInlineHints'), true, 'showInlineHints should default to true');
    });
});
