...
async function checkCodePatterns(issues, warnings) {
...
function showValidationResults(issues, warnings) {
    ...
    const panel = vscode.window.createWebviewPanel('validationResults', 'Clarity Chat Validation Results', vscode.ViewColumn.One, {});
    panel.webview.html = `
    <!DOCTYPE html>
    <html>
    <head>
