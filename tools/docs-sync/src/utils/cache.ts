...
export function loadCache(cachePath: string): APICache {
  try {
...
/** Save cache to disk */
export function saveCache(cache: APICache, cachePath: string): void {
...
/** Create empty cache */
export function createEmptyCache(): APICache {
  return {
...
export function pruneCache(cache: APICache, validPaths: Set<string>): number {
  let removed = 0
...
export function mergeCaches(caches: APICache[]): APICache {
