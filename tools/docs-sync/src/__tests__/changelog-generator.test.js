...
import { parseConventionalCommit, generateChangelogEntries, formatChangelogMarkdown, suggestNextVersion, } from '../changelog-generator.js';
describe('Changelog Generator', () => {
    ...
    describe('formatChangelogMarkdown', () => {
        it('should format entry as markdown', () => {
            ...
            const markdown = formatChangelogMarkdown(entry, 'https://github.com/user/repo');
        ...
        it('should include links when repo URL is provided', () => {
            ...
            expect(markdown).toContain('[`abc123d`](https://github.com/user/repo/commit/abc123def456)');
        });
    });
...
//# sourceMappingURL=changelog-generator.test.js.map