...
import { escapeTableCell, escapeType, toSlug, toKebabCase, createTable, createPropsTable, createParametersTable, codeBlock, createCallout, createDeprecationWarning, normalizeWhitespace, } from '../utils/markdown.js';
...
describe('Markdown Utilities', () => {
    ...
    describe('createPropsTable', () => {
        it('should create a props table', () => {
            ...
            expect(table).toContain('| Prop | Type | Required | Default | Description |');
    ...
    describe('createDeprecationWarning', () => {
        ...
        it('should include alternative if provided', () => {
            const warning = createDeprecationWarning('This is deprecated', 'useNewAPI');
