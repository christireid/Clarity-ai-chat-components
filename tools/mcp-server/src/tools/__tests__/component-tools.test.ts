...
describe('Component Discovery Tools', () => {
  ...
  describe('clarity_discover_components', () => {
    ...
    it('should filter by category', async () => {
      ...
      expect(
        result.components.every((c: any) => c.category === 'message')
      ).toBe(true)
    })
    ...
    it('should validate query is not empty', async () => {
      await expect(
        handleToolCall('clarity_discover_components', { query: '' })
      ).rejects.toThrow()
    })
  ...
  describe('clarity_discover_hooks', () => {
    ...
    it('should validate required query parameter', async () => {
      await expect(
        handleToolCall('clarity_discover_hooks', {})
      ).rejects.toThrow()
    })

    it('should validate query is not empty', async () => {
      await expect(
        handleToolCall('clarity_discover_hooks', { query: '' })
      ).rejects.toThrow()
    })
  })
  ...
  describe('clarity_get_hook_docs', () => {
    ...
    it('should throw NotFoundError for unknown hook', async () => {
      await expect(
        handleToolCall('clarity_get_hook_docs', {
  ...
  describe('clarity_get_accessibility', () => {
    ...
    it('should throw NotFoundError for unknown component', async () => {
      await expect(
        handleToolCall('clarity_get_accessibility', {
          componentName: 'NonExistentComponent',
        })
      ).rejects.toThrow()
    })
  ...
  describe('clarity_generate_code', () => {
    ...
    it('should throw NotFoundError for unknown component', async () => {
      await expect(
        handleToolCall('clarity_generate_code', {
          componentName: 'NonExistentComponent',
          variant: 'basic',
        })
      ).rejects.toThrow()
  ...
  describe('clarity_get_related_components', () => {
    ...
    it('should throw NotFoundError for unknown component', async () => {
      await expect(
        handleToolCall('clarity_get_related_components', {
          componentName: 'NonExistentComponent',
        })
      ).rejects.toThrow()
    })
  ...
  describe('clarity_list_categories', () => {
    ...
    it('should include component counts per category', async () => {
      ...
      const totalComponents = result.categories.reduce(
        (sum: number, cat: any) => sum + cat.componentCount,
        0
      )
