...
describe('MCP Server Integration', () => {
    ...
    describe('Tool Integration', () => {
        describe('Component Discovery Flow', () => {
            it('should complete full component discovery workflow', async () => {
                ...
                const searchResult = await handleToolCall('clarity_discover_components', {
                    query: 'chat',
                });
    ...
    describe('Resource Integration', () => {
        ...
        it('should read examples list', async () => {
            ...
            expect(Array.isArray(examples) || (examples && typeof examples === 'object')).toBe(true);
        });
        ...
        it('should throw for unknown resource', async () => {
            await expect(handleResourceRead('clarity://nonexistent/resource')).rejects.toThrow();
        });
    ...
    describe('Prompt Integration', () => {
        ...
        describe('Error Handling', () => {
            it('should throw for unknown prompt', async () => {
                await expect(handlePromptGet('nonexistent-prompt', {})).rejects.toThrow();
            });
    ...
    describe('Cross-Feature Integration', () => {
        it('should support building a complete chat implementation', async () => {
            ...
            const inputComponents = await handleToolCall('clarity_discover_components', {
                query: 'input',
                category: 'input',
            });
