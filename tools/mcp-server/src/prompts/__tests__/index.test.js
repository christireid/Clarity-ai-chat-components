...
describe('handlePromptGet', () => {
    ...
    describe('debug-issue', () => {
        ...
        it('should validate required parameter', async () => {
            await expect(handlePromptGet('debug-issue', {})).rejects.toThrow();
        });
    });
    describe('optimize-performance', () => {
        ...
        it('should validate required parameter', async () => {
            await expect(handlePromptGet('optimize-performance', {})).rejects.toThrow();
        });
    });
    describe('review-code', () => {
        ...
        it('should validate required parameter', async () => {
            await expect(handlePromptGet('review-code', {})).rejects.toThrow();
        });
    });
    describe('convert-example', () => {
        ...
        it('should validate required parameters', async () => {
            await expect(handlePromptGet('convert-example', { code: 'test' })).rejects.toThrow();
        });
    });
    describe('unknown prompt', () => {
        it('should throw NotFoundError for unknown prompt', async () => {
            await expect(handlePromptGet('unknown-prompt', {})).rejects.toThrow();
        });
    });
});
