declare const _default: ({
    ...
    languageOptions: {
        ...
        globals: {
            ...
            IntersectionObserverEntry: string;
            IntersectionObserverCallback: string;
            MutationObserver: string;
            ResizeObserver: string;
            ResizeObserverCallback: string;
            Blob: string;
            File: string;
            FileReader: string;
            DataTransfer: string;
            performance: string;
            PerformanceEntry: string;
            PerformanceObserver: string;
            ErrorEvent: string;
            ...
            confirm: string;
            prompt: string;
            IntersectionObserverInit: string;
            MediaQueryList: string;
            MediaQueryListEvent: string;
            WebSocket: string;
            MessageEvent: string;
            CloseEvent: string;
            ...
            WindowEventMap: string;
            DocumentEventMap: string;
            AddEventListenerOptions: string;
            Document: string;
            crypto: string;
            Crypto: string;
            SubtleCrypto: string;
    ...
    languageOptions: {
        ...
        globals: {
            ...
            WindowEventMap?: undefined;
            DocumentEventMap?: undefined;
