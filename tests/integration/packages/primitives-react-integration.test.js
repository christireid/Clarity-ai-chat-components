...
describe('Primitives + React Integration', () => {
    describe('ChatInput uses Primitives', () => {
        it('renders with primitive components', () => {
            ...
            render(value, "", onChange = { handleChange }, onSubmit = { handleSubmit }, placeholder = "Type a message"
                /  >
            );
...
describe('Custom Button with Chat Components', () => {
    it('allows custom button in chat interface', () => {
        const CustomButton = () => variant = "outline" > Custom, Send;
        /Button>;
    });
    render(placeholder, "Chat message" /  >
        />
        < /div>);
...
//# sourceMappingURL=primitives-react-integration.test.js.map