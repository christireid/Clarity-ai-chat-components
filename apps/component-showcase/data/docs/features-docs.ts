...
<div className="grid grid-cols-2 gap-4">
  ...
  <Card>After</Card>
    ...
    props: [
      {
        ...
        type: 'BeforeMetrics',
        required: true,
        description: 'Before optimization metrics',
      },
      {
        name: 'after',
        type: 'AfterMetrics',
        required: true,
        description: 'After optimization metrics',
      },
      {
        name: 'comparisonType',
        type: 'ComparisonType',
      ...
      },
      {
        name: 'unit',
        type: 'string',
        description: 'Custom unit for display (e.g., "ms", "$", "tokens")',
      },
      {
        name: 'strategies',
        type: 'StrategyContribution[]',
        description: 'Strategy breakdown showing contribution to savings',
      },
      {
        name: 'showAnimation',
        type: 'boolean',
        description: 'Show animated transition when component appears',
      },
      {
        name: 'showSavingsBadge',
        type: 'boolean',
        description: 'Show percentage savings badge prominently',
      },
      {
        name: 'showStrategies',
        type: 'boolean',
        description: 'Show strategy breakdown section',
      },
      {
        name: 'visualStyle',
    ...
    sourceFile: 'components/BeforeAfterComparison.tsx',
  },
...
/>`,
  ...
  'Safety Components': {
    ...
    importName: 'ClarityComponents',
    usageCode: `import { ClarityComponents } from '@clarity-chat/react'
<ClarityComponents.ModerationBadge
  level="warning"
...
/>`,
  ...
  'Read Receipts': {
    ...
    importName: 'ClarityComponents',
    usageCode: `import { ClarityComponents } from '@clarity-chat/react'
<ClarityComponents.MessageStatusIndicator
  status="read"
  timestamp="2 min ago"
/>`,
    props: [
...
/>`,
  ...
  'Password Input': {
    ...
    importName: 'ClarityComponents',
    usageCode: `import { ClarityComponents } from '@clarity-chat/react'
<ClarityComponents.PasswordStrengthIndicator
...
<ClarityComponents.ModelSelector
  models={models}
  onSelect={(m) => compare(m)}
/>`,
    props: [],
    sourceFile: 'components/clarity/model-selector.tsx',
  },
...
>
  <ChildComponent />
    ...
    sourceFile: 'examples/integrations/remix-example.tsx',
  },
...
/>`,
    props: [
      ...
      { name: 'size', type: "'sm' | 'md' | 'lg'", description: 'Size variant' },
      {
        name: 'className',
        type: 'string',
        description: 'Additional CSS classes.',
    ...
    sourceFile: 'components/clarity/prompt-manager.tsx',
  },
...
/>`,
    props: [
      ...
      },
      {
        name: 'isCalculating',
        type: 'boolean',
        description: 'Whether token calculation is in progress',
      },
      {
        name: 'showTooltip',
        type: 'boolean',
      ...
      { name: 'showLabel', type: 'boolean', description: 'Show text labels' },
      { name: 'size', type: "'sm' | 'md' | 'lg'", description: 'Size variant' },
      {
        name: 'compact',
        type: 'boolean',
        description: 'Compact mode (bar only, no labels)',
      },
      {
        name: 'className',
        type: 'string',
      ...
      },
      {
        name: 'onClick',
        type: '() => void',
        description: 'Called when user clicks the bar (e.g., to trigger trim)',
      },
      {
        name: 'animated',
        type: 'boolean',
        description: 'Animate bar transitions',
      },
      {
        name: 'model',
        type: 'BudgetMonitorModel',
        description: 'Model for cost estimation (enables cost display)',
      },
      {
        name: 'showCost',
        type: 'boolean',
        description: 'Show estimated cost (requires model prop)',
      },
      {
        name: 'ariaLabel',
        type: 'string',
      ...
      },
      {
        name: 'id',
        type: 'string',
        description: 'ID for the component (used for aria relationships)',
      },
      {
        name: 'used',
        type: 'number',
    ...
    sourceFile: 'components/token/TokenBudgetBar.tsx',
  },
  ...
  'Token Optimization Badge': {
    ...
    importName: 'ClarityComponents',
    usageCode: `import { ClarityComponents } from '@clarity-chat/react'
<ClarityComponents.TokenStatusBadge
  status="optimized"
  savings={25}
/>`,
    props: [
...
/>`,
    props: [
      ...
      },
      {
        ...
        type: 'number',
        description: 'Cost per input token (in cents or dollars)',
      },
      {
        name: 'costPerOutputToken',
        type: 'number',
        description: 'Cost per output token (in cents or dollars)',
      },
      {
        name: 'optimizationPercent',
        type: 'number',
        description: 'Optimization percentage (0-100)',
      },
      {
      ...
      },
      {
        name: 'showBreakEven',
        type: 'boolean',
        description: 'Show break-even analysis',
      },
      {
        name: 'enableSliders',
        type: 'boolean',
        description: 'Enable interactive sliders',
      },
      {
        name: 'scenarios',
        type: 'OptimizationScenario[]',
        description: 'Custom scenarios to compare',
      },
      {
        name: 'onCalculate',
        type: '(results: ROIResults) => void',
        description: 'Callback when calculations update',
      },
      { name: 'className', type: 'string', description: 'Custom className' },
      {
        name: 'disableAnimations',
    ...
    sourceFile: 'components/token/TokenROICalculator.tsx',
  },
...
/>`,
    ...
    sourceFile: 'components/ui/progress.tsx',
  },
...
/>`,
    props: [
      ...
      { name: 'showTools', type: 'boolean', description: 'Show tool calls' },
      {
        name: 'onToolApprove',
      ...
      },
      {
        ...
        type: 'boolean',
        description:
          'Enable smooth text streaming animation (2024 trend) Instead of showing text in chunks as received, this buffers content and renders at a consistent, readable pace for a polished UX.',
      },
      {
        name: 'streamingSpeed',
        type: "'fast' | 'normal' | 'slow'",
        description: 'Speed for smooth streaming (characters per second)',
      },
    ],
