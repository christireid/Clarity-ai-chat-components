...
/>`,
    ...
    sourceFile: 'components/clarity/chat-sidebar.tsx',
  },
...
/>`,
      props: [
        ...
        },
        {
          ...
          description: 'Whether to auto-resize',
        },
        {
          name: 'maxLength',
          type: 'number',
        ...
        },
        {
          name: 'isLoading',
          type: 'boolean',
          description: 'Whether input is loading',
        },
        { name: 'loadingText', type: 'string', description: 'Loading text' },
        {
          name: 'allowAttachments',
          type: 'boolean',
          description: 'Whether to allow attachments',
        },
        {
        ...
        },
        {
          ...
          description: 'Current attachments',
        },
        {
          name: 'allowVoice',
          type: 'boolean',
        ...
        },
        {
          name: 'isRecording',
          type: 'boolean',
          description: 'Whether currently recording voice',
        },
        {
          name: 'submitOnEnter',
          type: 'boolean',
        ...
        {
          name: 'shiftEnterForNewline',
          type: 'boolean',
          description: 'Require Shift+Enter for newline',
        },
        {
          name: 'actions',
          type: 'SenderAction[]',
        ...
        },
        {
          name: 'showSendButton',
          type: 'boolean',
          description: 'Whether to show send button',
        },
        {
          name: 'onChange',
          type: '(value: string) => void',
        ...
        {
          name: 'onSend',
          type: '(value: string, attachments?: SenderAttachment[]) => void',
          description: 'Send/submit handler',
        },
        {
          name: 'onAttachmentAdd',
          type: '(files: File[]) => void',
          description: 'Attachment added handler',
        },
        {
          name: 'onAttachmentRemove',
          type: '(attachment: SenderAttachment) => void',
          description: 'Attachment removed handler',
        },
        {
          name: 'onVoiceStart',
          type: '() => void',
          description: 'Voice recording start handler',
        },
        {
          name: 'onVoiceStop',
          type: '() => void',
          description: 'Voice recording stop handler',
        },
  ...
  {messages.map((msg) => (
    <MessageBubble key={msg.id} message={msg} />
      ...
      props: [
        ...
        { name: 'asChild', type: 'boolean', description: 'The asChild prop.' },
        {
          name: 'className',
          type: 'string',
...
/>`,
      ...
      sourceFile: 'components/clarity/expandable-chat.tsx',
    },
    {
