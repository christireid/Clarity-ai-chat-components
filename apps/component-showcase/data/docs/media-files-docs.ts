...
<DocumentIntegration
  ...
  onContentExtract={(content) => console.log('Extracted:', content)}
  fetchDocument={async (id, platform) => fetchDoc(id, platform)}
...
<MultiModalPreview
  ...
  onRemove={(attachment) => console.log('Remove:', attachment)}
/>`,
    props: [
      {
        name: 'attachments',
...
<DocumentViewer
  document={{
    ...
    summary: 'A comprehensive overview of the platform architecture and design decisions.',
