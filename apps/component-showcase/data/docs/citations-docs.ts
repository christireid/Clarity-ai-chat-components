...
<p>
  ...
  without writing a class.
      ...
      props: [
        ...
        {
          name: 'variant',
          type: "'number' | 'bracket' | 'superscript' | 'footnote' | 'link'",
          default: '"number"',
          description:
...
<SourceCitation
  sources={[
    ...
    },
    {
      ...
      snippet: 'JavaScript is a lightweight, interpreted...',
      confidence: 0.82,
    },
  ]}
  variant="card"
  ...
  showFavicons
  showDomain
  onSourceClick={(source, index) => console.log('Clicked:', source.title)}
/>`,
      props: [
        {
          name: 'sources',
...
<CitationCard
  citation={{
    ...
    chunkText: 'Hooks are a new addition in React 16.8. They let you use state and other React features without writing a class component...',
    confidence: 0.92,
    url: 'https://react.dev/docs/hooks-intro',
    metadata: {
      author: 'React Team',
...
<LinkPreviewList
  links={[
    { url: 'https://react.dev', title: 'React', description: '...' },
    { url: 'https://nextjs.org', title: 'Next.js', description: '...' },
  ]}
  variant="compact"
  layout="vertical"
  maxItems={5}
...
/>`,
      props: [
        ...
        {
          name: 'variant',
          type: "'card' | 'inline' | 'compact' | 'minimal'",
          default: '"compact"',
...
<CitationList
  ...
  onCitationClick={(citation) => console.log('Selected:', citation.title)}
  collapsible
  maxVisible={3}
/>`,
      props: [
