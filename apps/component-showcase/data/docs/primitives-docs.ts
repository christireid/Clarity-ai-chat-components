...
<Button asChild>
  <a href="/page">Navigate</a>
    ...
    sourceFile: 'hooks/prompt-composer/providers/file-provider.ts',
  },
  ...
  <PopoverContent>
    <div className="space-y-2">
      ...
      <p className="text-sm text-muted-foreground">
        This is the popover content. You can put any content
        here.
      </p>
    </div>
  </PopoverContent>
...
<div className="flex items-center gap-2">
  ...
  <span className="text-muted-foreground">Open command palette</span>
      ...
      sourceFile: 'components/clarity/command-palette.tsx',
    },
  ],
}
