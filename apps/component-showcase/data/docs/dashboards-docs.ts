...
export const dashboardsDocs: Record<string, ComponentDoc | ComponentDoc[]> = {
  ...
  stats={{
    ...
    costs: { total: 15.5, breakdown: [] },
  }}
  limits={[
    { metric: 'tokensUsed', current: 25000, limit: 100000 },
  ]}
...
/>`,
      ...
      sourceFile: 'components/dashboards/UsageDashboard.tsx',
    },
    {
...
/>`,
      ...
      sourceFile: 'components/dashboards/SavingsDashboard.tsx',
    },
  ],
  ...
  insights={[
    {
      title: 'Top performer',
      description: 'Code Review prompt usage up 23%',
      type: 'positive',
    },
...
/>`,
    ...
    sourceFile: 'components/dashboards/AnalyticsDashboard.tsx',
  },
...
/>`,
    ...
    sourceFile: 'components/dashboards/ConversationAnalyticsDashboard.tsx',
  },
...
/>`,
    ...
    sourceFile: 'components/dashboards/UserInteractionAnalytics.tsx',
  },
...
/>`,
      ...
      sourceFile: 'components/dashboards/PerformanceAnalyticsDashboard.tsx',
    },
    {
      ...
      importPath: '@clarity-chat/react',
      usageCode: `<PerformanceDashboard autoRefresh refreshInterval={5000} />`,
      props: [
        {
          name: 'className',
          type: 'string',
      ...
      sourceFile: 'components/dashboards/PerformanceDashboard.tsx',
    },
    {
  ...
  metrics={[
    {
      ...
      score: 0.85,
      target: 0.75,
      description: 'How well-grounded in source material',
    },
    {
      id: 'coverage',
      label: 'Coverage',
      score: 0.72,
      target: 0.8,
      description: 'Topic coverage completeness',
    },
    {
      id: 'coherence',
      label: 'Coherence',
      score: 0.91,
      description: 'Response logical consistency',
    },
  ]}
  overallScore={0.83}
...
/>`,
      ...
      sourceFile: 'components/dashboards/response-quality-meter.tsx',
    },
  ],
}
