...
/>`,
      ...
      sourceFile: 'components/ui/AnimatedDots.tsx',
    },
...
<Skeleton variant="pulse" width="80%" height={16} />`,
        ...
        sourceFile: 'components/clarity/skeletons.tsx',
      },
      {
        name: 'SkeletonText',
        description:
...
<InlineShimmer width="60px" />`,
        props: [
          { name: 'text', type: 'string', description: 'The text prop.' },
          {
            name: 'duration',
            type: 'number',
            description: 'The duration prop.',
          },
          { name: 'spread', type: 'number', description: 'The spread prop.' },
          {
            name: 'className',
            type: 'string',
            description: 'Additional CSS class names for the container.',
...
>
  {content}
        ...
        sourceFile: 'components/ai/StreamingTextShimmer.tsx',
      },
    ],
...
>
  <ProgressWidget data={data} />
      ...
      sourceFile: 'components/ui/DashboardSkeleton.tsx',
    },
...
/>`,
        props: [
          {
            name: 'variant',
            type: "'pulse' | 'shimmer' | 'none' | 'wave' | 'gradient' | 'dots'",
            default: '"shimmer"',
            description:
        ...
        sourceFile: 'components/ui/skeleton-enhanced.tsx',
      },
    ],
  }
