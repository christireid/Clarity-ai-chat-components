...
/>`,
      ...
      sourceFile: 'components/chat/ChatWindow.tsx',
    },
    {
      name: 'ChatInput',
      description:
...
/>`,
      ...
      sourceFile: 'components/clarity/chat/ChatInput.tsx',
    },
    {
...
/>`,
      props: [
        ...
        },
        {
          name: 'className',
          type: 'string',
          description: 'The className prop.',
        },
        {
          name: 'config',
      ...
      sourceFile: 'components/clarity/markdown-renderer.tsx',
    },
    {
...
/>`,
      ...
      sourceFile: 'components/input/VoiceInput.tsx',
    },
  ],
...
/>`,
  ...
  onReject={(tool, reason) =>
    rejectToolExecution(tool, reason)
  }
...
/>`,
    ...
    sourceFile: 'components/feedback/NetworkStatus.tsx',
  },
...
/>`,
      ...
      sourceFile: 'components/prompt/PromptSuggestions.tsx',
    },
  ],
...
/>`,
  ...
  citation={{
    ...
    sourceId: 'doc-123',
    chunkText:
      'React components are reusable pieces of UI that can manage their own state...',
...
/>`,
  ...
  'Citation List': {
    name: 'CitationCard',
    description:
      'Displays citation sources with title, URL, and snippet preview. Used to show references and external links alongside AI-generated responses.',
    importPath: '@clarity-chat/react',
    usageCode: `<CitationCard
  citations={[
    {
  ...
  onCitationClick={(citation) => window.open(citation.url)}
/>`,
    props: [
      {
        name: 'citation',
      ...
      { name: 'onClick', type: '() => void', description: 'The onClick prop.' },
      { name: 'onCopy', type: '() => void', description: 'The onCopy prop.' },
      { name: 'copied', type: 'boolean', description: 'The copied prop.' },
      {
        name: 'className',
      ...
      },
      {
        ...
        type: 'Citation[]',
        required: true,
        description: 'Array of citation objects to display.',
        commonlyUsed: true,
      },
      {
        name: 'onCitationClick',
        type: '(citation: Citation) => void',
        description: 'Callback when a citation is clicked.',
        commonlyUsed: true,
      },
      {
        name: 'variant',
        ...
        default: "'compact'",
        description: 'Display variant for citation cards.',
      },
    ],
    notes: [
      'Citations are numbered automatically based on array order.',
      'Supports compact (inline) and expanded (card) display variants.',
    ],
    sourceFile: 'components/clarity/inline-citation.tsx',
  },
  ...
  'Connection Status': {
    name: 'NetworkStatus',
    description:
      'Displays real-time notification indicators and connection status. Shows unread counts, notification types, and provides dismiss actions for alert management.',
    importPath: '@clarity-chat/react',
    usageCode: `<NetworkStatus
  showNotifications
  onStatusChange={(status) =>
...
/>`,
    props: [
      ...
      },
      {
        ...
        type: 'boolean',
        default: 'false',
        description: 'Whether to show notification indicators.',
        commonlyUsed: true,
      },
      {
    ...
    notes: [
      'Automatically detects online/offline status via browser APIs.',
      'Provides visual indicators for connection quality.',
    ],
    sourceFile: 'components/feedback/NetworkStatus.tsx',
  },
  ...
  'Prompt Suggestions': {
    name: 'PromptSuggestions',
    description:
      'Displays selectable persona cards that configure the AI assistant behavior and tone. Each persona defines a system prompt context and can be visually distinguished with icons and descriptions.',
    importPath: '@clarity-chat/react',
    usageCode: `<PromptSuggestions
  suggestions={[
    {
  ...
  onSelect={(suggestion) => setActivePersona(suggestion)}
  variant="card"
/>`,
    props: [
      {
        ...
        type: 'PromptSuggestion[]',
        required: true,
        description: 'Array of persona/suggestion items to display.',
        commonlyUsed: true,
      },
      {
        name: 'onSelect',
        type: '(suggestion: PromptSuggestion) => void',
        required: true,
        description: 'Callback when a persona or suggestion is selected.',
        commonlyUsed: true,
      },
      {
        name: 'messages',
      ...
      { name: 'isLoading', type: 'boolean', description: 'Show loading state' },
      {
        name: 'maxSuggestions',
        type: 'number',
        description: 'Maximum number of suggestions to show',
      ...
      },
      {
        ...
        type: "'chip' | 'card' | 'list'",
        default: "'chip'",
        description: 'Display style for the suggestions.',
      },
    ],
    notes: [
      'Personas can be used with the variant="card" style for richer display.',
      'Works well as a sidebar or modal selection for switching AI behaviors.',
    ],
    sourceFile: 'components/prompt/PromptSuggestions.tsx',
  },
}
