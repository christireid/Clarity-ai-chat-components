...
/>`,
      props: [
        ...
        },
        {
          name: 'contextItems',
          type: 'ContextItem[]',
          description: 'The contextItems prop.',
        },
        {
          name: 'itemsIncluded',
          type: "Array<{ id: string level: 'summary' | 'preview' | 'full' tokens: number }>",
          description: 'The itemsIncluded prop.',
        },
        {
          name: 'className',
          type: 'string',
        ...
        },
        {
          name: 'showSavings',
          type: 'boolean',
          description: 'The showSavings prop.',
        },
        {
          name: 'showBreakdown',
          type: 'boolean',
          description: 'The showBreakdown prop.',
        },
        {
          name: 'usage',
          type: 'TokenUsage',
      ...
      sourceFile: 'components/prompt-composer/TokenBudgetIndicator.tsx',
    },
  ],
...
/>`,
      ...
      sourceFile: 'components/token/token-optimization-panel.tsx',
    },
    {
...
/>`,
      ...
      sourceFile: 'components/token/token-optimization-badge.tsx',
    },
    {
...
/>`,
      ...
      sourceFile: 'components/clarity/dashboards/token-dashboard.tsx',
    },
  ],
  ...
  onCostChange={(cost, tokens) => {
    if (cost > 0.1)
      showWarning('Message will cost more than \$0.10')
  }}
/>`,
      props: [
        {
  ...
  enableSliders
  onCalculate={(results) =>
    console.log('Savings:', results.savingsPerYear)
  }
/>`,
      props: [
        {
