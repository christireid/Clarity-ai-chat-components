...
/>`,
      props: [
        ...
        {
          name: 'variant',
          type: "'default' | 'subtle' | 'glass' | 'outline'",
          default: '"default"',
  ...
  steps={[
    {
      ...
      content: 'Parsing user intent and extracting key concepts...',
      status: 'complete',
      duration: 300,
    },
    {
      ...
      content: 'Querying relevant documentation and examples...',
      status: 'in-progress',
      progress: 60,
    },
    {
...
/>`,
  ...
  onReject={(tool, reason) => console.log('Rejected:', tool, reason)}
>
