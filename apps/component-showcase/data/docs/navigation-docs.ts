  ...
  commands={[
    {
      ...
      onSelect: () => {},
      children: [
        { id: 'new', label: 'New File', shortcut: 'Cmd+N', onSelect: () => newFile() },
        { id: 'open', label: 'Open File', shortcut: 'Cmd+O', onSelect: () => openFile() },
      ],
    },
  ]}
  open={isOpen}
...
>
  ...
  shortcuts={[
    { id: 'new-chat', keys: 'Cmd+N', description: 'New chat', category: 'General' },
    { id: 'search', keys: 'Cmd+K', description: 'Search messages', category: 'Navigation' },
    { id: 'history', keys: 'Cmd+H', description: 'Chat history', category: 'Navigation' },
    { id: 'vim-nav', keys: ['j', 'k'], description: 'Navigate items', category: 'Navigation' },
    { id: 'sequence', keys: 'g i', description: 'Go to inbox', category: 'Navigation', isSequence: true },
  ]}
/>`,
    props: [
      {
