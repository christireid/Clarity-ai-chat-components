    ...
    props: [
      {
        ...
        type: 'boolean',
        required: true,
        description: 'The showFollowUp prop.',
      },
      {
        name: 'followUpSuggestions',
        type: 'PromptSuggestion[]',
        description: 'The followUpSuggestions prop.',
      },
      {
        name: 'onPromptSelect',
        type: '(suggestion: PromptSuggestion) => void',
        required: true,
        description: 'The onPromptSelect prop.',
      },
      {
        name: 'suggestions',
...
/>`,
      ...
      sourceFile: 'components/clarity/quick-replies.tsx',
    },
    {
  ...
  categories={[
    {
      id: 'greetings',
      name: 'Greetings',
      replies: greetingReplies,
    },
    {
      id: 'closings',
      name: 'Closings',
      replies: closingReplies,
    },
  ]}
  onSelect={(reply) => sendMessage(reply.content)}
...
/>`,
    ...
    sourceFile: 'components/ai/ResponseActions.tsx',
  },
...
/>`,
      ...
      sourceFile: 'components/clarity/generative-ui.tsx',
    },
    {
...
/>`,
      ...
      sourceFile: 'components/clarity/suggestion-chips.tsx',
    },
    {
      name: 'QuickActions',
      description:
...
/>`,
      ...
      sourceFile: 'components/clarity/actions.tsx',
    },
  ],
}
