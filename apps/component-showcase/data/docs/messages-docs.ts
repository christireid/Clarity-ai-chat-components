...
>
  ...
  <AssistantMessage>Hello! How can I help?</AssistantMessage>
  <AssistantMessage>Feel free to ask anything.</AssistantMessage>
</MessageGroup>`,
      props: [
        {
          name: 'children',
  ...
  isStreaming={true}
  showThinking={true}
  thinkingSteps={['Analyzing question', 'Searching knowledge base']}
...
/>`,
  ...
  onMessageFeedback={(id, type, comment) => saveFeedback(id, type, comment)}
...
<Message ... />`,
  ...
  showFollowUp={true}
  followUpSuggestions={[
    { id: '1', text: 'Tell me more about React hooks', type: 'follow-up' },
    { id: '2', text: 'Show me a useEffect example', type: 'follow-up' },
    { id: '3', text: 'What are custom hooks?', type: 'follow-up' },
  ]}
