  ...
  if (collapsed) {
    return (
      <div className="w-12 border-r bg-card/50 flex flex-col items-center py-3 gap-2 shrink-0">
        <button onClick={onToggleCollapsed} className="p-2 rounded-lg hover:bg-muted transition-colors" title="Expand sidebar">
    ...
    <div className="w-64 border-r bg-card/50 flex flex-col shrink-0">
      ...
      <div className="flex items-center justify-between p-3 border-b">
        ...
        <div className="flex items-center gap-1">
          <button onClick={onNewConversation} className="p-1.5 rounded-md hover:bg-muted transition-colors" title="New session">
            <Plus className="h-3.5 w-3.5" />
          </button>
          <button onClick={onToggleCollapsed} className="p-1.5 rounded-md hover:bg-muted transition-colors" title="Collapse">
        ...
        {conversations.map(conv => (
          ...
          >
            ...
            <div className="flex items-center gap-1 shrink-0">
              <span className="text-[10px] text-muted-foreground">{conv.messages.length}</span>
              <button
