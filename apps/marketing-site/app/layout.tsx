...
export const metadata: Metadata = {
  ...
  description:
    'React components for AI chat. Multi-provider support (OpenAI, Anthropic, Gemini), intelligent memory, 40%+ token cost savings. Ship in days, not months.',
  keywords: [
    'AI chat',
    'React components',
    'OpenAI',
  ...
  openGraph: {
    ...
    description:
      'React components for AI chat. Multi-provider support, intelligent memory, 40%+ cost savings.',
