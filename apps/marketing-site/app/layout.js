...
export const metadata = {
    ...
    description: 'Ship production-ready AI chat interfaces in hours, not months. 70+ components, WCAG AAA accessible, enterprise features included.',
    keywords: [
        'react',
        'chat components',
        'ai chat',
    ...
    openGraph: {
        ...
        description: 'Ship production-ready AI chat interfaces in hours, not months. 70+ components, WCAG AAA accessible.',
