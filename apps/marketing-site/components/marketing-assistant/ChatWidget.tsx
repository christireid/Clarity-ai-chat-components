...
import { MessageSquare, X, Send, Sparkles, Users, Bot, Key, ChevronDown } from 'lucide-react'
    ...
    initialMessages: [
        {
            id: 'welcome',
            role: 'assistant',
            content: "Hi! 👋 I'm Aura, your AI UI specialist. Ask me anything about building chat interfaces, token optimization, or how to ship faster with Clarity!"
        }
    ],
    onError: (err: Error) => {
          ...
          >
            ...
            <div className="p-4 border-b border-white/5 bg-gradient-to-r from-surface-900 to-surface-800 flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="font-bold text-white text-sm">Aura</h3>
                  <p className="text-xs text-clarity-400">AI Specialist • Online</p>
                </div>
              </div>
