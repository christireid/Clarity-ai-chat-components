...
import { Calculator, DollarSign, Users, MessageSquare } from 'lucide-react'
...
export default function TokenSavingsCalculator() {
  ...
  const savings = estimatedCost * 0.40 // 40% savings claim
      ...
      <div className="grid gap-6 mb-8">
        <div>
            <label className="flex items-center justify-between text-sm text-gray-400 mb-2">
                <span className="flex items-center gap-2"><Users className="w-4 h-4" /> Monthly Active Users</span>
        ...
        <div>
            <label className="flex items-center justify-between text-sm text-gray-400 mb-2">
                <span className="flex items-center gap-2"><MessageSquare className="w-4 h-4" /> Msgs / User / Month</span>
