      ...
      <div className="relative mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold text-white mb-4">
            Don't Reinvent the{' '}
            <span className="gradient-text">Chat Interface</span>
          </h2>
          <p className="text-gray-400">
            Building a production-grade chat UI is harder than it looks. We've
        ...
        >
          <div className="grid grid-cols-3 border-b border-white/10 bg-surface-900/80">
            <div className="p-6 text-sm font-semibold text-gray-400">
              Feature
            </div>
            <div className="p-6 text-lg font-bold text-white bg-clarity-500/5 border-x border-white/5 flex items-center justify-center gap-2">
              Clarity Chat
              <span className="px-2 py-0.5 rounded-full bg-clarity-500 text-white text-[10px] uppercase tracking-wider">
                Pro
              </span>
            </div>
              ...
              <div className="p-5 flex items-center justify-center text-gray-500">
                {row.custom.includes('Month') || row.custom.includes('$') ? (
                  ...
                  <span className="flex items-center gap-2">
                    <ChevronRight className="w-4 h-4 opacity-50" /> {row.custom}
                  </span>
                )}
              </div>
            </div>
        ...
        <div className="mt-12 text-center">
          <p className="text-sm text-gray-400 mb-4">
            Building production-grade AI chat from scratch typically requires
            2-3 engineers for 2+ months. That's $45,000+ in development costs
