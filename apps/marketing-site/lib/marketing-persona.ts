...
import { animationPresets } from '@clarity-chat/primitives'

// We'll export this config so it can be imported by the consumer
export const marketingPersona = {
  initialMessage: "Hi! 👋 I'm Aura, your Clarity Chat specialist. I can help you understand our enterprise features, pricing, or how to integrate our AI components. What would you like to know?",
