...
import { Zap, Gauge, PackageCheck, TrendingUp, Award, CheckCircle2, Sparkles } from 'lucide-react'

export const metadata = {
  title: 'Performance | Clarity Chat',
  description: 'Real performance metrics, bundle size analysis, and optimization insights.',
}
...
const performanceMetrics = {
  ...
  comparison: [
    { library: 'Clarity Chat', size: '205 KB', gzipped: '68 KB', treeshakeable: true },
    { library: 'Material-UI', size: '328 KB', gzipped: '95 KB', treeshakeable: true },
    { library: 'Ant Design', size: '485 KB', gzipped: '142 KB', treeshakeable: false },
    { library: 'Chakra UI', size: '265 KB', gzipped: '78 KB', treeshakeable: true },
  ],
}
    ...
    <div className="container-docs py-8 sm:py-12">
      ...
      <ScrollReveal direction="up" delay={0.1}>
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
            Real performance metrics, bundle size analysis, and transparent optimization insights.
          </p>
        </div>
      </ScrollReveal>
      ...
      <ScrollReveal direction="up" delay={0.2}>
        <section className="mb-16">
          <h2 className="text-2xl font-bold mb-8 text-center">Lighthouse Scores</h2>
          
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {Object.entries(performanceMetrics.lighthouse).map(([key, value], index) => (
                ...
                <div className="relative rounded-xl overflow-hidden bg-white/60 dark:bg-white/[0.02] backdrop-blur-sm border border-neutral-200/60 dark:border-white/[0.06] p-6 text-center group hover:-translate-y-1 transition-all">
                  ...
                  <div className="relative z-10">
                    <div className="text-5xl font-bold mb-2">
                      <span className={`${
                        value >= 90 ? 'text-emerald-500' : value >= 50 ? 'text-amber-500' : 'text-red-500'
                      }`}>
                        {value}
                      </span>
                    </div>
        ...
        <section className="mb-16">
            ...
            <table className="w-full">
              <thead>
                <tr className="border-b border-neutral-200 dark:border-neutral-800">
                  ...
                  <th className="text-left py-3 px-4 font-semibold">Tree-shakeable</th>
                </tr>
              </thead>
              <tbody>
                  ...
                  >
                    <td className="py-3 px-4">
                      <div className="flex items-center gap-2">
                        {index === 0 && <Award className="w-4 h-4 text-brand-500" />}
                        <span className={index === 0 ? 'font-semibold' : ''}>{item.library}</span>
                      </div>
                    </td>
          ...
          <div className="mt-6 p-4 rounded-lg bg-brand-50 dark:bg-brand-950/20 border border-brand-200 dark:border-brand-800/50">
            <div className="flex items-start gap-3">
              ...
              <div className="text-sm text-neutral-600 dark:text-neutral-400">
                <strong className="text-brand-600 dark:text-brand-400">40% smaller</strong> than the average competitor. 
                Tree-shaking eliminates unused code, keeping your production bundle lean.
              </div>
            </div>
          </div>
        </section>
              ...
              {[
                {
                  ...
                  description: 'Import only what you need. Unused components are eliminated from your bundle.',
                },
                {
                  icon: <Zap className="w-5 h-5" />,
                  title: 'Lazy Loading',
                  description: 'Components load on-demand with React.lazy() and dynamic imports.',
                },
                {
                  icon: <Gauge className="w-5 h-5" />,
                  title: 'Zero Runtime CSS',
                  description: 'Tailwind CSS compiles to static CSS with no runtime overhead.',
                },
                {
                  icon: <Sparkles className="w-5 h-5" />,
                  title: 'Optimized Animations',
                  description: 'GPU-accelerated animations using transform and opacity only.',
                },
                {
                  icon: <CheckCircle2 className="w-5 h-5" />,
                  title: 'SSR Compatible',
                  description: 'Full support for Server-Side Rendering and Static Site Generation.',
                },
                {
                  icon: <TrendingUp className="w-5 h-5" />,
                  title: 'Production Optimized',
                  description: 'Minified, compressed, and optimized for production deployments.',
                },
              ].map((feature, i) => (
