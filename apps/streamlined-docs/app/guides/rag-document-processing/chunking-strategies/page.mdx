...
description: 'Comprehensive guide for choosing optimal text chunking strategies for RAG systems. Includes decision trees, performance comparisons, chunk size recommendations, and robust code examples.'
---
...
<div className="p-6 rounded-xl bg-gradient-to-br from-brand-50 to-purple-50 dark:from-brand-950/30 dark:to-purple-950/30 border border-brand-200/50 dark:border-brand-800/30 mb-8">
  ...
  <div className="grid sm:grid-cols-2 gap-3">
    {[
      ...
      'Robust code examples for each approach',
