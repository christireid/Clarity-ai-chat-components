        ...
        <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground max-w-3xl mb-6">
              Drop-in middleware for Express, Fastify, and Hono that automatically optimizes AI API calls with provider caching, compression, and smart routing.
            </p>
            ...
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg">
              ...
              <span className="font-semibold">Add 50-70% cost reduction to your backend</span>
            </div>

            {/* Quick Stats */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-8">
              <div className="rounded-lg border border-border bg-card p-4">
                <div className="text-2xl font-bold text-emerald-600 dark:text-emerald-400 mb-1">50-70%</div>
                <div className="text-sm text-muted-foreground">Cost Reduction</div>
              </div>
              <div className="rounded-lg border border-border bg-card p-4">
                <div className="text-2xl font-bold text-blue-600 dark:text-blue-400 mb-1">&lt;100ms</div>
                <div className="text-sm text-muted-foreground">Added Latency</div>
              </div>
              <div className="rounded-lg border border-border bg-card p-4">
                <div className="text-2xl font-bold text-purple-600 dark:text-purple-400 mb-1">3 Lines</div>
                <div className="text-sm text-muted-foreground">To Integrate</div>
              </div>
            </div>
          </motion.div>
        </div>
      ...
      <div className="container max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
        ...
        <section className="bg-muted/50 rounded-lg p-6 border border-border">
          ...
          <nav className="grid grid-cols-1 sm:grid-cols-2 gap-2">
            {[
              ...
              { id: 'request-response', label: 'Request/Response Augmentation' },
        ...
        <section id="overview" className="space-y-4">
          ...
          <p className="text-muted-foreground">
            The <code className="px-1.5 py-0.5 rounded bg-muted text-foreground font-mono text-sm">optimizationMiddleware</code> provides automatic token optimization for backend API routes. It intercepts AI API calls and applies provider caching, compression, and smart model routing to reduce costs by 50-70% without code changes in your route handlers.
          </p>
          ...
          <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg p-4">
            ...
            <ul className="space-y-1 text-sm text-emerald-800 dark:text-emerald-200">
              ...
              <li>• Automatic optimization: Provider caching + compression + routing</li>
              <li>• Cost tracking: Per-request and aggregate cost monitoring</li>
              <li>• Production-ready: Error handling, rate limiting, monitoring</li>
              <li>• Framework-agnostic: Works with Express, Fastify, and Hono</li>
            </ul>
          </div>
        </section>
...
npm install @upstash/redis`}
        ...
        <section id="middleware-signature" className="space-y-6">
          <h2 className="text-3xl font-bold text-foreground">Middleware Signature</h2>
...
function optimizationMiddleware(
  options?: OptimizationOptions
                ...
                <p className="text-sm text-muted-foreground">
                  Attaches optimization helpers to <code className="px-1 py-0.5 rounded bg-muted text-foreground font-mono text-xs">req.optimizedAI</code> for use in route handlers.
                </p>
              </div>
            )}
...
export default fp(optimizationPlugin, { name: 'optimization' })`}
                />
                <p className="text-sm text-muted-foreground">
                  Decorates Fastify instance with <code className="px-1 py-0.5 rounded bg-muted text-foreground font-mono text-xs">fastify.optimizedAI</code> for use in routes.
                </p>
              </div>
            )}
...
async function optimizationMiddleware(
  ...
  options?: OptimizationOptions
                ...
                />
                <p className="text-sm text-muted-foreground">
                  Sets optimization helpers on context via <code className="px-1 py-0.5 rounded bg-muted text-foreground font-mono text-xs">c.set('optimizedAI', ...)</code> for use in handlers.
                </p>
              </div>
            )}
          </div>
        ...
        <section id="configuration" className="space-y-4">
          <h2 className="text-3xl font-bold text-foreground">Configuration Options</h2>
            ...
            <table className="w-full border-collapse">
              ...
              <tbody className="text-sm">
                <tr className="border-b border-border/50">
                  ...
                  <td className="py-3 px-4"><code className="text-xs">'anthropic' | 'openai' | 'gemini'</code></td>
                  <td className="py-3 px-4"><code className="text-xs">'anthropic'</code></td>
                  <td className="py-3 px-4">AI provider for optimization</td>
                </tr>
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-mono text-xs">minCacheTokens</td>
                  <td className="py-3 px-4"><code className="text-xs">number</code></td>
                  <td className="py-3 px-4"><code className="text-xs">1024</code></td>
                  <td className="py-3 px-4">Minimum tokens required for caching</td>
                </tr>
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-mono text-xs">compressionRatio</td>
                  <td className="py-3 px-4"><code className="text-xs">number</code></td>
                  <td className="py-3 px-4"><code className="text-xs">0.5</code></td>
                  <td className="py-3 px-4">Target compression ratio (0.5 = 50% reduction)</td>
                </tr>
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-mono text-xs">compressionQuality</td>
                  <td className="py-3 px-4"><code className="text-xs">number</code></td>
                  <td className="py-3 px-4"><code className="text-xs">0.7</code></td>
                  <td className="py-3 px-4">Minimum quality threshold (0.0-1.0)</td>
                </tr>
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-mono text-xs">routingStrategy</td>
                  <td className="py-3 px-4"><code className="text-xs">'complexity' | 'intent' | 'hybrid'</code></td>
                  <td className="py-3 px-4"><code className="text-xs">'hybrid'</code></td>
                  <td className="py-3 px-4">Model routing strategy</td>
                </tr>
                <tr className="border-b border-border/50">
                  <td className="py-3 px-4 font-mono text-xs">enableTracking</td>
                  <td className="py-3 px-4"><code className="text-xs">boolean</code></td>
                  <td className="py-3 px-4"><code className="text-xs">true</code></td>
                  <td className="py-3 px-4">Enable cost and performance tracking</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section id="request-response" className="space-y-4">
          <h2 className="text-3xl font-bold text-foreground">Request/Response Augmentation</h2>
          <p className="text-muted-foreground">
            The middleware augments request/context objects with optimization helpers:
          </p>

          <div className="space-y-6">
            <div>
              <h3 className="text-lg font-semibold mb-3">optimizedAI.sendMessage()</h3>
              <CodeBlock
                language="typescript"
...
async sendMessage(messages: Message[]): Promise<AIResponse>`}
              ...
              <p className="text-sm text-muted-foreground mt-2">
                Sends messages with automatic optimization applied. Returns detailed usage and cost information.
              </p>
            </div>

            <div>
              <h3 className="text-lg font-semibold mb-3">optimizedAI.getCost()</h3>
              <CodeBlock
                language="typescript"
                code={`getCost(): number
...
const totalCost = req.optimizedAI.getCost() // 0.0234`}
            ...
            <div>
              <h3 className="text-lg font-semibold mb-3">optimizedAI.getStats()</h3>
              <CodeBlock
                language="typescript"
...
getStats(): OptimizationStats`}
        ...
        <section id="examples" className="space-y-6">
          <h2 className="text-3xl font-bold text-foreground">Framework Examples</h2>
...
export default app`}
        ...
        <section id="rate-limiting" className="space-y-4">
          <h2 className="text-3xl font-bold text-foreground">Rate Limiting with Cost Budgets</h2>
          <p className="text-muted-foreground">
            Protect your API from runaway costs by implementing per-user cost budgets:
          </p>
...
app.post('/api/chat', async (req, res) => {
  ...
  res.json(result) // Cost automatically tracked
          ...
          <div className="bg-brand-500/10 border border-brand-500/30 rounded-lg p-4">
            <h3 className="font-semibold text-brand-900 dark:text-brand-100 mb-2">Budget Protection Benefits</h3>
        ...
        <section id="error-handling" className="space-y-4">
          <h2 className="text-3xl font-bold text-foreground">Error Handling Integration</h2>
          <p className="text-muted-foreground">
  ...
  return await anthropic.messages.create({
    ...
    messages: cached.messages,
        ...
        <section id="monitoring" className="space-y-4">
          <h2 className="text-3xl font-bold text-foreground">Production Monitoring</h2>
          <p className="text-muted-foreground">
  ...
  res.json(result)
          ...
          <div className="bg-neutral-50 dark:bg-neutral-900 rounded-lg p-4 border border-border">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              <li className="flex items-start gap-2">
                ...
                <span><strong>Cost per request:</strong> Track average and p95 costs</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span><strong>Cache hit rate:</strong> Monitor caching effectiveness</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span><strong>Model distribution:</strong> Percentage of queries per model</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="w-4 h-4 text-emerald-600 flex-shrink-0 mt-0.5" />
                <span><strong>Error rate:</strong> Failed optimization attempts</span>
              </li>
            </ul>
          </div>
        </section>
        ...
        <section id="cost-impact" className="space-y-6">
          <div className="flex items-center gap-3">
            ...
            <h2 className="text-3xl font-bold text-foreground">Cost Impact: Add 50-70% Cost Reduction to Your Backend</h2>
          </div>

          <p className="text-lg text-muted-foreground">
            The optimizationMiddleware combines three powerful strategies to achieve significant cost savings:
          </p>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="rounded-lg border border-border bg-card p-6">
              <div className="text-3xl font-bold text-purple-600 dark:text-purple-400 mb-2">50-60%</div>
            ...
            <div className="rounded-lg border border-border bg-card p-6">
              <div className="text-3xl font-bold text-blue-600 dark:text-blue-400 mb-2">15-25%</div>
            ...
            <div className="rounded-lg border border-border bg-card p-6">
              <div className="text-3xl font-bold text-emerald-600 dark:text-emerald-400 mb-2">10-15%</div>
          ...
          <div className="bg-gradient-to-br from-purple-500/10 to-pink-500/10 border border-purple-500/30 rounded-lg p-6">
            <h3 className="text-xl font-semibold mb-4">Real-World Example: API Gateway</h3>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h4 className="font-semibold mb-3 text-red-600 dark:text-red-400">Before Optimization</h4>
                <ul className="space-y-2 text-sm">
                  <li>• 100,000 requests/day</li>
                  <li>• All queries to Claude Sonnet</li>
                  <li>• Average 1,500 tokens per request</li>
                  <li>• <strong className="text-red-600 dark:text-red-400">$3,000/day ($90,000/month)</strong></li>
                </ul>
              </div>

              <div>
                <h4 className="font-semibold mb-3 text-emerald-600 dark:text-emerald-400">After Optimization</h4>
                <ul className="space-y-2 text-sm">
                  <li>• 60% tokens cached (provider caching)</li>
                  <li>• 20% user input compressed</li>
                  <li>• 55% queries routed to Haiku</li>
                  <li>• <strong className="text-emerald-600 dark:text-emerald-400">$750/day ($22,500/month)</strong></li>
                </ul>
              </div>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-purple-500/30">
              ...
              <div className="text-sm text-muted-foreground mt-2">
                $67,500/month saved • 50ms added latency • Zero runaway cost incidents
              </div>
            </div>
          </div>
        </section>
        ...
        <div className="flex justify-center">
          <div className="inline-flex items-center gap-3 px-6 py-3 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-white shadow-lg">
            ...
            <span className="px-2 py-0.5 rounded-full bg-white/20 text-xs font-medium">50-70% Savings</span>
          </div>
        </div>
      </div>
    </div>
