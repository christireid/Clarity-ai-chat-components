...
export const metadata = {
  ...
  description:
    'Explore 15 beautiful themes and learn how to customize your chat interface.',
}

// ISR Configuration: Theme gallery is static, revalidate every 3 hours
      ...
      <ScrollReveal direction="up" delay={0.1}>
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mx-auto">
            Choose from pre-built themes or create your own. Full customization
            with Tailwind CSS.
          </p>
        </div>
      </ScrollReveal>
              ...
              {[
                {
                  ...
                  title: 'Color Palette',
                  description:
                    'Primary, secondary, accent colors with full shade ranges',
                },
                {
                ...
                },
                {
                  ...
                  title: 'Spacing',
                  description:
                    'Padding, margins, and gap values for consistent rhythm',
                },
                {
                  icon: <Sparkles className="w-5 h-5" />,
                  title: 'Border Radius',
                ...
                },
                {
                  ...
                  title: 'Shadows',
                  description:
                    'Elevation and depth with customizable shadow values',
                },
                {
                  icon: <Palette className="w-5 h-5" />,
                  title: 'Animations',
                  description:
                    'Duration, easing, and timing for all transitions',
                },
              ].map((feature, i) => (
      ...
      <ScrollReveal direction="up" delay={0.2}>
        <div className="mt-16 text-center p-12 rounded-2xl bg-gradient-to-br from-brand-500/10 via-purple-500/10 to-pink-500/10 border border-brand-200 dark:border-brand-800/50">
          ...
          <p className="text-neutral-600 dark:text-neutral-400 mb-6 max-w-xl mx-auto">
            Start with a pre-built theme or create your own from scratch. Full
