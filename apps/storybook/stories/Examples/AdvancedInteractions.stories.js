...
import { CommandPalette, KeyboardHint, Draggable, DropZone, ContextMenu, ThemeSwitcher, useTheme, 
// useUndoRedo,
// useUndoRedoShortcuts,
// useHaptic,
useKeyboardShortcuts, } from '@clarity-chat/react';
// ============================================================================
...
// ============================================================================
const UndoRedoDemo = () => {
    return (_jsx("div", { className: "p-8", children: _jsxs("div", { className: "max-w-2xl mx-auto space-y-4", children: [_jsx("h2", { className: "text-2xl font-bold", children: "Undo/Redo Demo" }), _jsx("p", { className: "text-muted-foreground", children: "This demo is currently disabled due to missing dependencies." })] }) }));
};
// ============================================================================
// Haptic Feedback Demo
// ============================================================================
const HapticDemo = () => {
    return (_jsx("div", { className: "p-8", children: _jsxs("div", { className: "max-w-2xl mx-auto space-y-4", children: [_jsx("h2", { className: "text-2xl font-bold", children: "Haptic Feedback Demo" }), _jsx("p", { className: "text-muted-foreground", children: "This demo is currently disabled due to missing dependencies." })] }) }));
};
// ============================================================================
