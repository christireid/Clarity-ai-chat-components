...
import { ChatWindow, ToolInvocationCard } from '@clarity-chat/react';
import { useState } from 'react';
const meta = {
    title: 'Examples/IndustrySolutions',
    parameters: {
        layout: 'fullscreen',
        docs: {
            description: {
 ...
 */
export const HealthcareAssistant = {
    render: () => {
...
**Note**: This is informational only. Please consult your physician for medical advice.`,
        ...
        return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "bg-gradient-to-r from-blue-600 to-cyan-600 text-white p-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "\uD83C\uDFE5 Healthcare Assistant" }), _jsx("p", { className: "text-blue-100 mt-1", children: "HIPAA-compliant AI medical assistant" })] }), _jsx("div", { className: "flex-1 p-6", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSend, showHeader: false, emptyState: _jsxs("div", { className: "text-center p-8", children: [_jsx("span", { className: "text-6xl mb-4 block", children: "\uD83C\uDFE5" }), _jsx("h3", { className: "text-xl font-semibold mb-2", children: "Healthcare Assistant Ready" }), _jsx("p", { className: "text-muted-foreground", children: "Ask about symptoms, medications, lab results, or appointments" })] }) }) }), _jsxs("div", { className: "p-4 bg-yellow-50 dark:bg-yellow-950 border-t border-yellow-200 dark:border-yellow-800 text-sm text-yellow-800 dark:text-yellow-200", children: ["\u26A0\uFE0F ", _jsx("strong", { children: "Demo Only" }), " - This is for demonstration purposes. Not a substitute for professional medical advice."] })] }));
    },
};
/**
...
Would you like me to analyze your current spending or adjust any categories?`,
        ...
        return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "bg-gradient-to-r from-green-600 to-emerald-600 text-white p-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "\uD83D\uDCB0 Financial Advisor" }), _jsx("p", { className: "text-green-100 mt-1", children: "Smart budgeting and financial planning" })] }), _jsx("div", { className: "flex-1 p-6", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSend, showHeader: false }) }), _jsxs("div", { className: "p-4 bg-yellow-50 dark:bg-yellow-950 border-t border-yellow-200 dark:border-yellow-800 text-sm text-yellow-800 dark:text-yellow-200", children: ["\u26A0\uFE0F ", _jsx("strong", { children: "Educational Only" }), " - Not financial advice. Consult licensed financial advisors."] })] }));
    },
};
/**
 ...
 * - Order tracking
 */
export const EcommerceAssistant = {
    render: () => {
        const [messages, setMessages] = useState([
            {
                id: '1',
...
- See customer reviews?`,
        ...
        return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "bg-gradient-to-r from-purple-600 to-pink-600 text-white p-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "\uD83D\uDECD\uFE0F Ecommerce Assistant" }), _jsx("p", { className: "text-purple-100 mt-1", children: "Smart product recommendations & shopping help" })] }), _jsx("div", { className: "flex-1 p-6", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSend, showHeader: false }) })] }));
    },
};
/**
...
Try answering these to test your understanding!`,
        ...
        return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "bg-gradient-to-r from-indigo-600 to-blue-600 text-white p-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "\uD83D\uDCDA Education Tutor" }), _jsx("p", { className: "text-indigo-100 mt-1", children: "Interactive AI learning assistant" })] }), _jsx("div", { className: "flex-1 p-6", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSend, showHeader: false }) })] }));
    },
};
/**
...
**Next Steps**: Would you like me to create detailed campaign plans?`,
        ...
        return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "bg-gradient-to-r from-violet-600 to-purple-600 text-white p-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "\uD83E\uDD16 AI Agents Workflow" }), _jsx("p", { className: "text-violet-100 mt-1", children: "Multi-agent orchestration system" })] }), _jsxs("div", { className: "flex-1 grid grid-cols-3 gap-6 p-6", children: [_jsx("div", { className: "col-span-2", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSend, showHeader: false }) }), _jsxs("div", { className: "space-y-4", children: [_jsx("h3", { className: "font-semibold text-lg", children: "\uD83D\uDEE0\uFE0F Tool Invocations" }), toolInvocations.map((tool) => (_jsx(ToolInvocationCard, { invocation: tool }, tool.id)))] })] })] }));
    },
};
/**
 * Code Assistant Demo
...
Need help with anything else?`,
        ...
        return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "bg-gradient-to-r from-slate-800 to-gray-900 text-white p-6", children: [_jsx("h1", { className: "text-2xl font-bold", children: "\uD83D\uDC68\u200D\uD83D\uDCBB Code Assistant" }), _jsx("p", { className: "text-slate-300 mt-1", children: "AI-powered coding help" })] }), _jsx("div", { className: "flex-1 p-6", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSend, showHeader: false }) })] }));
    },
};
//# sourceMappingURL=IndustrySolutions.stories.js.map