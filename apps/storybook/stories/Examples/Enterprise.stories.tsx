...
export const AuthTenantDashboardMultipleTenants: StoryObj<
  typeof AuthTenantDashboard
> = {
  render: () => (
    <div style={{ width: '1200px', height: '800px' }}>
      <AuthTenantDashboard
    ...
    <div className="max-w-4xl p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600">
          Advanced components for enterprise-grade applications with
          multi-tenancy, SSO, and comprehensive security features.
        </p>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div className="p-6 border rounded-lg">
          ...
          <p className="text-sm text-gray-600">
            Isolated workspaces for different organizations with tenant-level
        ...
        <div className="p-6 border rounded-lg">
          ...
          <p className="text-sm text-gray-600">
            Seamless single sign-on with SAML 2.0 and OAuth 2.0 support for
        ...
        <div className="p-6 border rounded-lg">
          ...
          <p className="text-sm text-gray-600">
            Generate and manage API tokens with granular permissions and usage
            tracking.
          </p>
        </div>
      ...
      <div className="p-6 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm text-gray-700">
          All enterprise features include 24/7 support, SLA guarantees,
