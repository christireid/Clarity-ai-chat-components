...
export default meta;
const eventTimestamp = (offsetMinutes) => new Date(Date.now() - offsetMinutes * 60_000);
export const FollowUp = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(FollowUpSuggestions, { suggestions: [
                {
                    id: '1',
                    title: 'Examples/AiExperience',
...
export const Personas = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(PersonaPanel, { personas: [
                {
                    id: 'analyst',
            ...
            ], activePersonaId: "analyst", onSelect: (persona) => alert(`Switched to ${persona.name}`) }) })),
};
export const Timeline = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(ConversationTimeline, { events: [
                {
                    id: 'event-1',
                    type: 'user',
                    title: 'Examples/AiExperience',
...
export const Memory = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(MemoryInspector, { memories: [
                {
                    id: 'm1',
            ...
            ], onRemove: (memory) => alert(`Removed ${memory.label}`), onPromote: (memory) => alert(`Promoted ${memory.label}`) }) })),
};
export const Safety = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(SafetyStatusCard, { checks: [
                {
                    id: 's1',
            ...
            ], lastReviewedAt: eventTimestamp(2), onReviewPolicy: () => alert('Open policy docs') }) })),
};
export const QualityMeter = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(ResponseQualityMeter, { overallScore: 0.78, metrics: [
                {
                    id: 'grounded',
                    label: 'Groundedness',
                    score: 0.92,
...
export const MultiModal = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(MultiModalPreview, { attachments: [
                {
                    id: 'img-1',
                    type: 'image',
                    title: 'Examples/AiExperience',
...
export const AgentFeed = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(AgentRunFeed, { steps: [
                {
                    id: 'step-1',
                    title: 'Examples/AiExperience',
                    status: 'succeeded',
...
export const SessionSummary = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(SessionSummaryCard, { summary: {
                title: 'Examples/AiExperience',
                highlights: [
...
export const WorkflowList = {
    render: () => (_jsx("div", { className: "w-full max-w-3xl", children: _jsx(WorkflowSuggestionList, { workflows: [
                {
                    id: 'wf-brief',
...
export const PromptHarness = {
    render: () => (_jsx("div", { className: "w-full max-w-4xl", children: _jsx(PromptTestHarness, { datasets: [{ id: 'dataset-1', name: 'Support tickets – Tier 1' }], variants: [
...
export const EvaluationBoard = {
    render: () => (_jsx("div", { className: "w-full max-w-5xl", children: _jsx(EvaluationDashboard, { metrics: [
...
export const SafetyConsole = {
    render: () => (_jsx("div", { className: "w-full max-w-5xl", children: _jsx(SafetyReviewConsole, { content: "Hi Taylor, we noticed your account 123-45-6789 might be impacted by the Phoenix launch embargo on Dec 12.", highlights: [
                {
                    id: 'flag-ssn',
                    start: 41,
                    end: 52,
...
export const AuthDashboard = {
    render: () => (_jsx("div", { className: "w-full max-w-4xl", children: _jsx(AuthTenantDashboard, { organizationName: "Phoenix Labs", planName: "Enterprise Annual", planBadge: "Paid", renewalDate: "Renews Dec 12, 2025", seatUsage: { label: 'Seats', used: 42, total: 60 }, apiUsage: { label: 'Usage this month', value: '1.2M tokens' }, actions: [
                { id: 'upgrade', label: 'Upgrade plan', onClick: () => alert('Upgrade flow') },
                { id: 'manage', label: 'Manage invoices', onClick: () => alert('Billing portal') },
            ] }) })),
};
export const ApiTokens = {
    render: () => (_jsx("div", { className: "w-full max-w-5xl", children: _jsx(ApiTokenManager, { tokens: [
                {
                    id: 'token-1',
            ...
            ], onCreate: () => alert('Generate token'), onRegenerate: (token) => alert(`Regenerate ${token.label}`), onRevoke: (token) => alert(`Revoke ${token.label}`) }) })),
};
export const SsoWizard = {
    render: () => (_jsx("div", { className: "w-full max-w-4xl", children: _jsx(SSOConfigWizard, { providerName: "Okta", steps: [
            ...
            ], metadata: { acsUrl: 'https://phoenix.ai/sso/acs', entityId: 'urn:phoenix:enterprise' }, notes: "Okta group `phoenix-admins` mapped to Administrator role.", onDownloadMetadata: () => alert('Download metadata'), onSubmit: () => alert('Save configuration') }) })),
};
export const InviteDialog = {
    render: () => (_jsx("div", { className: "flex w-full max-w-md justify-center", children: _jsx(SeatInviteDialog, { roles: ['Administrator', 'Editor', 'Support'], onInvite: (invite) => alert(`Invited ${invite.email} as ${invite.role}`) }) })),
};
//# sourceMappingURL=AiExperience.stories.js.map