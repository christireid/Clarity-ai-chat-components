...
const meta = {
    ...
    tags: ['autodocs'],
    decorators: [
        (Story) => (_jsx("div", { className: "w-full max-w-2xl h-[600px]", children: _jsx(Story, {}) })),
    ],
};
export default meta;
...
export const CustomEmptyState = {
    args: {
        document: null,
        emptyState: (_jsxs("div", { className: "text-center", children: [_jsx("p", { className: "text-lg font-semibold", children: "No document selected" }), _jsx("p", { className: "text-sm text-muted-foreground mt-2", children: "Please select a document from the list to view its contents." })] })),
    },
};
export const LongContent = {
    args: {
        document: {
            ...
            type: 'text/plain',
            content: Array(20)
                .fill('Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.')
                .join('\n\n'),
            summary: 'A document with extensive content to demonstrate scrolling',
        },
    },
};
//# sourceMappingURL=DocumentViewer.stories.js.map