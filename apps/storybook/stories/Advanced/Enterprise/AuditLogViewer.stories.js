...
const meta = {
    ...
    tags: ['autodocs'],
    decorators: [
        (Story) => (_jsx("div", { className: "w-full max-w-4xl h-[600px]", children: _jsx(Story, {}) })),
    ],
};
export default meta;
const sampleLogs = [
...
export const CustomEmptyState = {
    args: {
        logs: [],
        emptyState: (_jsxs("div", { className: "text-center", children: [_jsx("p", { className: "text-lg font-semibold", children: "No audit events found" }), _jsx("p", { className: "text-sm text-muted-foreground mt-2", children: "Audit logs will appear here as events occur in your system." })] })),
    },
};
...
//# sourceMappingURL=AuditLogViewer.stories.js.map