        ...
        savedPrompts={[
          {
            ...
            template:
              'You are a helpful customer support agent. User question: {{question}}',
            variables: ['question'],
          },
          {
            id: '2',
...
export const EvaluationDashboardComparison: StoryObj<
  typeof EvaluationDashboard
> = {
  render: () => (
    <div style={{ width: '100%', height: '800px' }}>
      <EvaluationDashboard
          ...
          flaggedContent={[
            {
              id: '1',
              content:
                'This message contains potentially sensitive information...',
              flagType: 'pii',
              severity: 'high',
              timestamp: Date.now() - 1800000,
              context: {
          ...
          flaggedContent={[
            {
              id: '1',
              content:
                'Message containing PII: email@example.com, phone: 555-0123',
              flagType: 'pii',
              severity: 'high',
    ...
    <div className="max-w-6xl p-8 space-y-8">
      <div>
        ...
        <p className="text-lg text-gray-600">
          Comprehensive tools for testing, monitoring, and optimizing your AI
          systems.
        </p>
      </div>
      ...
      <div className="grid grid-cols-3 gap-6">
        <div className="p-6 border rounded-lg hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-600 mb-4">
            Test and optimize prompts with A/B testing, variable substitution,
        ...
        <div className="p-6 border rounded-lg hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-600 mb-4">
            Monitor AI performance with real-time metrics, trends, and
        ...
        <div className="p-6 border rounded-lg hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-600 mb-4">
            Monitor and review content for safety, compliance, and policy
            violations with automated flagging.
          </p>
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-center gap-2">
              <svg
