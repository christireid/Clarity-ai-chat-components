...
export const EmptyState = {
    args: {
        suggestions: [],
        emptyState: (_jsx("div", { className: "text-center py-8 text-muted-foreground", children: _jsx("p", { children: "No suggestions available at this time." }) })),
        onSelect: () => { },
    },
};
...
//# sourceMappingURL=FollowUpSuggestions.stories.js.map