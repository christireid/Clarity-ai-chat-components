...
const meta = {
  title: 'Enterprise/SSO/Configuration Wizard',
...
const auth0Steps: SSOConfigStep[] = [
  ...
  {
    id: 'upload-metadata',
    title: 'Upload Service Provider Metadata',
