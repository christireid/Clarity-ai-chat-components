...
- **Accessibility** - WCAG AAA compliant
    ...
    decorators: [
        (Story) => (_jsx("div", { style: { maxWidth: '600px', margin: '0 auto' }, children: _jsx(Story, {}) })),
    ],
};
export default meta;
export const BasicInput = {
    render: () => {
        ...
        return (_jsx(ChatInput, { value: value, onChange: setValue, onSubmit: (val) => {
...
export const DisabledState = {
    render: () => {
        ...
        return (_jsx(ChatInput, { value: value, onChange: setValue, onSubmit: handleSubmit, disabled: isLoading, placeholder: isLoading ? 'Sending...' : 'Type a message...' }));
    },
    parameters: {
        docs: {
            description: `
...
export const WithMaxLength = {
    render: () => {
        ...
        return (_jsx(ChatInput, { value: value, onChange: setValue, onSubmit: (val) => {
                console.log('Submitted:', val);
                setValue('');
            }, maxLength: 100, placeholder: "Type a message (max 100 chars)..." }));
    },
    parameters: {
        docs: {
            description: {
...
export const WithFileUpload = {
    render: () => {
        ...
        return (_jsx(ChatInput, { value: value, onChange: setValue, onSubmit: (val) => {
                console.log('Submitted:', val);
                setValue('');
            }, allowFileUpload: true, onFileUpload: handleFileUpload, placeholder: "Type a message or upload a file..." }));
    },
    parameters: {
        docs: {
            description: {
...
export const Interactive = {
    render: () => {
        ...
        return (_jsxs("div", { children: [_jsxs("div", { style: { marginBottom: '16px', padding: '16px', background: '#f5f5f5', borderRadius: '8px' }, children: [_jsx("strong", { children: "Messages:" }), messages.length === 0 ? (_jsx("p", { style: { color: '#666', margin: '8px 0 0 0' }, children: "No messages yet. Try typing and pressing Enter!" })) : (_jsx("ul", { style: { margin: '8px 0 0 0', paddingLeft: '20px' }, children: messages.map((msg, i) => (_jsx("li", { style: { marginBottom: '4px' }, children: msg }, i))) }))] }), _jsx(ChatInput, { value: value, onChange: setValue, onSubmit: handleSubmit, placeholder: "Type a message and press Enter..." })] }));
    },
    parameters: {
        docs: {
            description: {
