...
const meta = {
    title: 'Components/DataDisplay/StreamingMessage',
...
• Easier to test and maintain`;
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsx("button", { onClick: startStreaming, disabled: isStreaming, className: "px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed", children: isStreaming ? 'Streaming...' : 'Start Streaming' }), _jsx(StreamingMessage, { content: content, isStreaming: isStreaming, showThinking: true, thinkingSteps: thinkingSteps, currentThinkingStep: currentStep })] }));
};
export const InteractiveStreaming = {
    render: () => _jsx(StreamingSimulation, {}),
};
const ToolApprovalDemo = () => {
    ...
    return (_jsxs("div", { className: "space-y-4", children: [_jsx("div", { className: "p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg", children: _jsx("p", { className: "text-sm text-blue-900 dark:text-blue-100", children: "\uD83D\uDCA1 Try approving or rejecting tool calls to see the interaction workflow" }) }), _jsx(StreamingMessage, { content: "I need to perform these actions to help you:", isStreaming: false, showTools: true, toolCalls: mockToolCalls, onToolApprove: handleApprove, onToolReject: handleReject }), Object.keys(toolStates).length > 0 && (_jsxs("div", { className: "p-4 bg-gray-50 dark:bg-gray-800 rounded-lg", children: [_jsx("h4", { className: "font-medium mb-2", children: "Tool States:" }), _jsx("pre", { className: "text-sm", children: JSON.stringify(toolStates, null, 2) })] }))] }));
};
export const InteractiveToolApproval = {
    render: () => _jsx(ToolApprovalDemo, {}),
};
// Edge Cases
...
export const AllFeaturesDisabled = {
    args: {
...
//# sourceMappingURL=StreamingMessage.stories.js.map