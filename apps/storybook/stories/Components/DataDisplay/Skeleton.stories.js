...
export const UserProfile = {
    render: () => (_jsxs("div", { className: "max-w-md p-6 border border-border/50 rounded-lg shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)] space-y-4", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx(SkeletonAvatar, { size: "lg" }), _jsxs("div", { className: "flex-1 space-y-2", children: [_jsx(Skeleton, { className: "h-4 w-32" }), _jsx(Skeleton, { className: "h-3 w-24" })] })] }), _jsxs("div", { className: "space-y-2", children: [_jsx(Skeleton, { className: "h-3 w-full" }), _jsx(Skeleton, { className: "h-3 w-full" }), _jsx(Skeleton, { className: "h-3 w-3/4" })] }), _jsxs("div", { className: "flex gap-2", children: [_jsx(SkeletonButton, { size: "sm" }), _jsx(SkeletonButton, { size: "sm" })] })] })),
    parameters: {
        docs: {
            description: {
...
export const ArticleLayout = {
    render: () => (_jsxs("div", { className: "max-w-3xl space-y-6", children: [_jsxs("div", { className: "space-y-3", children: [_jsx(Skeleton, { className: "h-8 w-3/4" }), _jsx(Skeleton, { className: "h-4 w-1/2" })] }), _jsx(Skeleton, { className: "h-64 w-full rounded-lg" }), _jsxs("div", { className: "space-y-2", children: [_jsx(Skeleton, { className: "h-4 w-full" }), _jsx(Skeleton, { className: "h-4 w-full" }), _jsx(Skeleton, { className: "h-4 w-5/6" })] }), _jsxs("div", { className: "space-y-2", children: [_jsx(Skeleton, { className: "h-4 w-full" }), _jsx(Skeleton, { className: "h-4 w-full" }), _jsx(Skeleton, { className: "h-4 w-4/5" })] })] })),
    parameters: {
        docs: {
            description: {
...
export const DashboardCards = {
    render: () => (_jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-4", children: [1, 2, 3].map((i) => (_jsxs("div", { className: "p-6 border border-border/50 rounded-lg shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)] space-y-3", children: [_jsx(Skeleton, { className: "h-6 w-24" }), _jsx(Skeleton, { className: "h-10 w-32" }), _jsx(Skeleton, { className: "h-3 w-full" })] }, i))) })),
    parameters: {
        docs: {
            description: {
...
export const LoadingSimulation = {
    render: () => {
        ...
        return (_jsxs("div", { className: "max-w-md p-6 border border-border/50 rounded-lg shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)]", children: [loading ? (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx(SkeletonAvatar, { size: "lg" }), _jsxs("div", { className: "flex-1 space-y-2", children: [_jsx(Skeleton, { className: "h-4 w-32" }), _jsx(Skeleton, { className: "h-3 w-24" })] })] }), _jsxs("div", { className: "space-y-2", children: [_jsx(Skeleton, { className: "h-3 w-full" }), _jsx(Skeleton, { className: "h-3 w-5/6" })] })] })) : (_jsxs("div", { className: "space-y-4", children: [_jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: "w-16 h-16 rounded-full bg-gradient-to-br from-blue-500 to-purple-600 flex items-center justify-center text-white text-2xl font-bold", children: "JD" }), _jsxs("div", { children: [_jsx("h3", { className: "font-semibold", children: data.name }), _jsx("p", { className: "text-sm text-muted-foreground", children: data.email })] })] }), _jsx("p", { className: "text-sm", children: data.bio })] })), _jsx("button", { onClick: () => {
                        setLoading(true);
                        setData(null);
                        setTimeout(() => {
                            setData({
