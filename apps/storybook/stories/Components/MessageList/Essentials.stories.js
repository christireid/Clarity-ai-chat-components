...
- **Accessibility** - WCAG AA compliant with AAA targets
    ...
    decorators: [
        (Story) => (_jsx("div", { style: { width: '600px', height: '500px', border: '1px solid #e5e7eb', borderRadius: '8px' }, children: _jsx(Story, {}) })),
    ],
};
export default meta;
...
export const LongConversation = {
    args: {
        messages: Array.from({ length: 50 }, (_, i) => {
            const isUser = i % 2 === 0;
            return createMessage(isUser ? 'user' : 'assistant', isUser
