...
- **Accessibility** - WCAG AAA compliant
    ...
    decorators: [
        (Story) => (_jsx("div", { style: { width: '600px', height: '600px', border: '1px solid #e5e7eb', borderRadius: '8px' }, children: _jsx(Story, {}) })),
    ],
};
export default meta;
...
const InteractiveChat = () => {
    ...
    const handleSendMessage = async (content) => {
        ...
        setTimeout(() => {
            const aiMessage = createMessage('assistant', `You said: "${content}". This is a demo response. In a real app, this would come from your AI API.`);
