...
const ThemePreview = ({ themeName }: { themeName: string }) => (
  <ThemeProvider defaultTheme={{ preset: themeName }}>
    <div className="p-6 rounded-xl border-2 border-border bg-background text-foreground space-y-4">
      <h4 className="font-semibold capitalize">{themeName.replace(/-/g, ' ')}</h4>
      ...
      <div className="p-4 rounded-lg bg-muted border border-border">
        <p className="text-sm">Sample text in this theme showing foreground and background colors.</p>
      </div>
    </div>
  </ThemeProvider>
)
    ...
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Primary brand colors used throughout the interface for CTAs, links, and brand identity.
        </p>
      </div>

      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-6">
        <ColorSwatch name="brand-50" value="#eff6ff" description="Lightest brand" />
        ...
        <ColorSwatch name="brand-500" value="#3b82f6" description="Primary brand" />
        ...
        <ColorSwatch name="brand-950" value="#172554" description="Darkest brand" />
      </div>
    </div>
  ),
  parameters: {
  ...
  render: () => (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Colors with specific meanings for success, warning, error, and informational states.
        </p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <ColorSwatch name="green-500" value="#10b981" description="Primary success" />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <ColorSwatch name="yellow-500" value="#f59e0b" description="Primary warning" />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <ColorSwatch name="red-500" value="#ef4444" description="Primary error" />
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-4">
            ...
            <ColorSwatch name="blue-500" value="#3b82f6" description="Primary info" />
  ...
  render: () => (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Grayscale colors for text, borders, backgrounds, and subtle UI elements.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6">
        ...
        <ColorSwatch name="gray-500" value="#6b7280" description="Secondary text" />
        <ColorSwatch name="gray-600" value="#4b5563" />
        <ColorSwatch name="gray-700" value="#374151" />
        <ColorSwatch name="gray-800" value="#1f2937" />
        <ColorSwatch name="gray-900" value="#111827" description="Primary text" />
      ...
      <div className="p-8 max-w-7xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-6">
            Clarity Chat includes {themes.length} professionally designed themes. Each theme includes both light and dark mode variants.
          </p>
        </div>
  ...
  render: () => (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          See how a component looks across different themes. Perfect for testing your custom components.
        </p>
      </div>

      <ThemeShowcase themes={['clarity-light', 'clarity-dark', 'sunset', 'ocean', 'forest']}>
        <div className="space-y-4">
          <h4 className="text-lg font-semibold">Sample Component</h4>
          <p className="text-sm">
            This is how text appears in this theme, with proper foreground and background contrast.
          </p>
          <div className="flex gap-2">
  ...
  render: () => (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Create your own theme by providing a custom theme object to ThemeProvider.
        </p>
      </div>
  ...
  render: () => (
    <div className="p-8 max-w-7xl mx-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Every theme includes carefully crafted dark mode variants. Toggle dark mode using the toolbar above.
        </p>
      </div>
