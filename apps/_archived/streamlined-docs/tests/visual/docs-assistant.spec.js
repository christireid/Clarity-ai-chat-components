...
test.describe('DocsAssistant Visual Tests', () => {
    ...
    test('DocsAssistant chatbot opens and displays correctly', async ({ page, }) => {
        ...
        const assistantButton = page
            ...
            .or(page.locator('button:has-text("Ask AI")').or(page.locator('[aria-label*="assistant"]').or(page
            .locator('button')
...
//# sourceMappingURL=docs-assistant.spec.js.map