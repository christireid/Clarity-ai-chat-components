...
import { extractMetadata, extractCodeBlocks, extractTextContent, estimateTokens, } from '../lib/content-extractor';
...
describe('extractTextContent', () => {
    ...
    it('should extract paragraph content', () => {
        const content = '<p className="text-lg">This is a paragraph with some text.</p>';
        const result = extractTextContent(content);
