...
describe('generateLlmsDocs integration', () => {
    ...
    describe('llms-full.txt output', () => {
        it('should start with documentation header', () => {
            expect(result.llmsFullTxt).toMatch(/^# Clarity Chat - Complete Documentation\n/);
        });
    ...
    describe('content quality', () => {
        ...
        it('should not have excessive className patterns outside code blocks', () => {
            ...
            const withoutCodeBlocks = result.llmsFullTxt.replace(/```[\s\S]*?```/g, '');
...
//# sourceMappingURL=generate-llms.integration.test.js.map