...
A demonstration of Clarity Chat Components showcasing pdf, reranking, embeddings, markdown, export, rag, streaming, file-upload.
...
- Cohere-powered semantic reranking for RAG
...
Estimated production bundle size (gzipped): **1.1MB**
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/christireid/Clarity-ai-chat-components/tree/main/apps/examples/rag-workbench-demo)
