...
A demonstration of Clarity Chat Components showcasing token-counting, syntax-highlighting, code-block, markdown, export, streaming, voice-input, theming.
...
- Code syntax highlighting with Shiki/Prism
...
Estimated production bundle size (gzipped): **619KB**
