...
export default function UseKeyboardShortcutsPage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsxs("div", { className: "docs-header", children: [_jsx("span", { className: "docs-badge", children: "Hook" }), _jsx("h1", { children: "useKeyboardShortcuts" }), _jsx("p", { className: "docs-lead", children: "Manage keyboard shortcuts with support for key combinations, sequences, and scoped contexts." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsxs("p", { children: ["The ", _jsx("code", { children: "useKeyboardShortcuts" }), " hook provides a declarative way to handle keyboard shortcuts in your chat application. It supports single keys, key combinations (like Cmd+K), key sequences (like g then i), and scoped contexts to prevent conflicts."] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(LiveDemo, { title: "Basic Keyboard Shortcuts", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithShortcuts`, height: "400px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Parameters" }), _jsx(ApiTable, { title: "useKeyboardShortcuts(config)", data: shortcutConfig })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Return Value" }), _jsx(ApiTable, { title: "Return Value", data: returnValue })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Key Sequences" }), _jsxs("p", { children: ["Support for multi-key sequences like Vim or Gmail shortcuts. Define sequences with the ", _jsx("code", { children: "then" }), " keyword."] }), _jsx(LiveDemo, { title: "Key Sequences", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithSequences`, height: "400px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Scoped Shortcuts" }), _jsx("p", { children: "Use scopes to enable/disable shortcuts based on context. This prevents conflicts when the same key has different meanings in different parts of your app." }), _jsx(LiveDemo, { title: "Scoped Shortcuts", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithScopes`, height: "600px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Preventing Default Behavior" }), _jsx("p", { children: "Control whether the browser's default behavior should be prevented for each shortcut." }), _jsx(LiveDemo, { title: "Prevent Default", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithPreventDefault`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Dynamic Shortcuts" }), _jsx("p", { children: "Enable or disable shortcuts dynamically based on application state." }), _jsx(LiveDemo, { title: "Dynamic Shortcuts", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithDynamicShortcuts`, height: "500px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Input Field Handling" }), _jsx("p", { children: "By default, shortcuts are disabled when typing in input fields. You can customize this behavior." }), _jsx(LiveDemo, { title: "Input Field Handling", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithInputHandling`, height: "550px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Shortcut Help Panel" }), _jsx("p", { children: "Build an interactive help panel that displays all available shortcuts." }), _jsx(LiveDemo, { title: "Shortcut Help Panel", code: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
export default ChatWithHelpPanel`, height: "700px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Chord Progressions" }), _jsx("p", { children: "Chain multiple shortcuts together to create complex interactions." }), _jsx("pre", { children: _jsx("code", { children: `// Emacs-style chord progressions
useKeyboardShortcuts({
...
useKeyboardShortcuts({
  ...
  'g then d': () => goToDrafts(),
})` }) }), _jsx("h3", { children: "Conditional Shortcuts" }), _jsx("p", { children: "Enable shortcuts only when specific conditions are met." }), _jsx("pre", { children: _jsx("code", { children: `function ChatWithConditionalShortcuts() {
  ...
  return <Chat />
}` }) }), _jsx("h3", { children: "Priority and Conflicts" }), _jsx("p", { children: "Handle conflicts when multiple components register the same shortcut." }), _jsx("pre", { children: _jsx("code", { children: `// Lower priority (runs first)
useKeyboardShortcuts({
  'cmd+k': () => globalSearch()
}, {
  priority: 1
...
useKeyboardShortcuts({
  ...
  priority: 10
})` }) }), _jsx("h3", { children: "Platform-Specific Shortcuts" }), _jsx("p", { children: "Automatically adapt shortcuts for different operating systems." }), _jsx("pre", { children: _jsx("code", { children: `useKeyboardShortcuts({
...
})` }) })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Integration Examples" }), _jsx("h3", { children: "With Command Palette" }), _jsx("pre", { children: _jsx("code", { children: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
function ChatWithCommandPalette() {
...
}` }) }), _jsx("h3", { children: "With Modal Dialogs" }), _jsx("pre", { children: _jsx("code", { children: `function ChatWithModals() {
  ...
  return <Chat />
}` }) }), _jsx("h3", { children: "With Undo/Redo" }), _jsx("pre", { children: _jsx("code", { children: `import { useKeyboardShortcuts } from '@clarity-chat/react'
...
function ChatWithUndoRedo() {
  ...
  return <Chat />
}` }) })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Best Practices" }), _jsxs(Callout, { type: "tip", title: "Discoverability", children: ["Always provide a way for users to discover available shortcuts. Consider adding:", _jsxs("ul", { children: [_jsxs("li", { children: ["A help panel (press ", _jsx("kbd", { children: "?" }), " to show)"] }), _jsx("li", { children: "Tooltips with keyboard hints" }), _jsx("li", { children: "Visual keyboard shortcut indicators next to actions" })] })] }), _jsxs(Callout, { type: "warning", title: "Avoid Conflicts", children: ["Be careful not to override browser or system shortcuts. Common conflicts:", _jsxs("ul", { children: [_jsxs("li", { children: [_jsx("kbd", { children: "Cmd+W" }), " - Close tab (don't override)"] }), _jsxs("li", { children: [_jsx("kbd", { children: "Cmd+T" }), " - New tab (don't override)"] }), _jsxs("li", { children: [_jsx("kbd", { children: "Cmd+R" }), " - Refresh (use with caution)"] }), _jsxs("li", { children: [_jsx("kbd", { children: "Cmd+Q" }), " - Quit app (don't override)"] })] })] }), _jsxs(Callout, { type: "info", title: "Platform Consistency", children: ["Follow platform conventions:", _jsxs("ul", { children: [_jsxs("li", { children: [_jsx("strong", { children: "macOS:" }), " Use Cmd for primary actions"] }), _jsxs("li", { children: [_jsx("strong", { children: "Windows/Linux:" }), " Use Ctrl for primary actions"] }), _jsxs("li", { children: [_jsx("strong", { children: "Cross-platform:" }), " Use ", _jsx("code", { children: "mod" }), " to automatically adapt"] })] })] }), _jsx("h3", { children: "Naming Conventions" }), _jsxs("ul", { children: [_jsxs("li", { children: [_jsx("strong", { children: "Lowercase modifiers:" }), " ", _jsx("code", { children: "cmd" }), ", ", _jsx("code", { children: "ctrl" }), ", ", _jsx("code", { children: "shift" }), ", ", _jsx("code", { children: "alt" })] }), _jsxs("li", { children: [_jsx("strong", { children: "Use + for combinations:" }), " ", _jsx("code", { children: "cmd+k" }), ", ", _jsx("code", { children: "ctrl+shift+d" })] }), _jsxs("li", { children: [_jsx("strong", { children: "Use \"then\" for sequences:" }), " ", _jsx("code", { children: "g then i" }), ", ", _jsx("code", { children: "ctrl+x then ctrl+c" })] }), _jsxs("li", { children: [_jsx("strong", { children: "Special keys:" }), " ", _jsx("code", { children: "esc" }), ", ", _jsx("code", { children: "enter" }), ", ", _jsx("code", { children: "space" }), ", ", _jsx("code", { children: "tab" })] })] }), _jsx("h3", { children: "Performance Tips" }), _jsxs("ul", { children: [_jsx("li", { children: "Shortcuts are automatically cleaned up when components unmount" }), _jsx("li", { children: "Use scoped shortcuts to reduce the number of active listeners" }), _jsx("li", { children: "Enable/disable shortcuts based on context to improve performance" }), _jsx("li", { children: "Avoid registering hundreds of shortcuts simultaneously" })] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Accessibility" }), _jsx("h3", { children: "Screen Reader Support" }), _jsx("p", { children: "Ensure keyboard shortcuts are announced to screen reader users:" }), _jsx("pre", { children: _jsx("code", { children: `<button aria-keyshortcuts="Control+K">
  Search
  <span className="kbd">Ctrl+K</span>
</button>` }) }), _jsx("h3", { children: "Focus Management" }), _jsx("p", { children: "Shortcuts should respect focus states and not interfere with screen reader navigation:" }), _jsx("pre", { children: _jsx("code", { children: `useKeyboardShortcuts({
  'cmd+k': () => search()
}, {
  enableInInput: false, // Don't interfere with form inputs
  respectFocusTraps: true // Don't work in modal focus traps
})` }) }), _jsx("h3", { children: "Alternative Actions" }), _jsx("p", { children: "Always provide mouse/touch alternatives to keyboard shortcuts:" }), _jsxs("ul", { children: [_jsx("li", { children: "Buttons for critical actions" }), _jsx("li", { children: "Menu items with shortcuts shown" }), _jsx("li", { children: "Context menus for advanced actions" })] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "TypeScript" }), _jsx("pre", { children: _jsx("code", { children: `import { useKeyboardShortcuts, KeyboardShortcutConfig } from '@clarity-chat/react'
...
function useKeyboardShortcuts(
  ...
  enable: () => void
  isEnabled: boolean
}` }) })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Related" }), _jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-4", children: [_jsxs("a", { href: "/reference/components/command-palette", className: "docs-card", children: [_jsx("h3", { children: "CommandPalette" }), _jsx("p", { children: "Keyboard-driven command interface" })] }), _jsxs("a", { href: "/reference/components/keyboard-hint", className: "docs-card", children: [_jsx("h3", { children: "KeyboardHint" }), _jsx("p", { children: "Visual keyboard shortcut indicators" })] }), _jsxs("a", { href: "/reference/hooks/use-undo-redo", className: "docs-card", children: [_jsx("h3", { children: "useUndoRedo" }), _jsx("p", { children: "Undo/redo with keyboard shortcuts" })] }), _jsxs("a", { href: "/learn/accessibility", className: "docs-card", children: [_jsx("h3", { children: "Accessibility Guide" }), _jsx("p", { children: "Making shortcuts accessible" })] })] })] })] }));
}
