...
export default BasicContextMenu`, height: "400px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "ContextMenu Props", data: contextMenuProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Menu Item Types" }), _jsx(ApiTable, { title: "MenuItem Interface", data: menuItemProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Icons and Shortcuts" }), _jsx(LiveDemo, { title: "Icons and Keyboard Shortcuts", code: `import { ContextMenu } from '@clarity-chat/react'
...
export default ContextMenuWithShortcuts`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Nested Submenus" }), _jsx(LiveDemo, { title: "Nested Submenus", code: `import { ContextMenu } from '@clarity-chat/react'
...
export default NestedContextMenu`, height: "500px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Disabled and Conditional Items" }), _jsx(LiveDemo, { title: "Disabled Items", code: `import { ContextMenu } from '@clarity-chat/react'
...
export default ConditionalContextMenu`, height: "550px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Custom Trigger Position" }), _jsx(LiveDemo, { title: "Custom Positioning", code: `import { ContextMenu } from '@clarity-chat/react'
...
export default CustomPositionMenu`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Checkboxes and Radio" }), _jsx(LiveDemo, { title: "Checkboxes and Radio Items", code: `import { ContextMenu } from '@clarity-chat/react'
...
export default SelectableContextMenu`, height: "550px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Chat Message Context Menu" }), _jsx("p", { children: "A complete example of a context menu for chat messages with all features." }), _jsx(LiveDemo, { title: "Chat Message Menu", code: `import { ContextMenu } from '@clarity-chat/react'
...
export default ChatMessageContextMenu`, height: "650px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Dynamic Menu Items" }), _jsx("p", { children: "Generate menu items dynamically based on application state:" }), _jsx("pre", { children: _jsx("code", { children: `function DynamicContextMenu() {
