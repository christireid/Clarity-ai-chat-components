...
export default function BasicPopover() {
  ...
  return (
    ...
    />
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Popover Props", data: [
                            {
                                name: 'trigger',
                                type: 'ReactNode',
                                default: 'undefined',
                        ...
                        ] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Placement Options" }), _jsx("p", { children: "Position the popover in 12 different locations relative to the trigger element." }), _jsx(LiveDemo, { code: `import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Trigger Methods" }), _jsx("p", { children: "Open popovers on click, hover, or focus events." }), _jsx(LiveDemo, { code: `import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Rich Content" }), _jsx("p", { children: "Popovers can contain complex content including images, forms, and interactive elements." }), _jsx(LiveDemo, { code: `import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Form in Popover" }), _jsx("p", { children: "Use popovers for inline forms and input collection." }), _jsx(LiveDemo, { code: `import { useState } from 'react';
import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Arrow" }), _jsx("p", { children: "Add an arrow indicator pointing from the popover to the trigger element." }), _jsx(LiveDemo, { code: `import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Controlled vs Uncontrolled" }), _jsx("p", { children: "Use controlled mode for programmatic control or uncontrolled for simpler usage." }), _jsx(LiveDemo, { code: `import { useState } from 'react';
import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Nested Popovers" }), _jsx("p", { children: "Open popovers from within other popovers for hierarchical content." }), _jsx(LiveDemo, { code: `import { Popover, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Info Card Popover" }), _jsx("p", { children: "Display detailed information cards on hover or click." }), _jsx(LiveDemo, { code: `import { Popover } from '@clarity/chat-components';
...
}` }), _jsx("h3", { children: "Share Popover" }), _jsx("p", { children: "Create social sharing popovers with multiple options." }), _jsx(LiveDemo, { code: `import { Popover, Button } from '@clarity/chat-components';
...
}` }), _jsx("h3", { children: "Color Picker Popover" }), _jsx("p", { children: "Use popovers for inline selectors and pickers." }), _jsx(LiveDemo, { code: `import { useState } from 'react';
