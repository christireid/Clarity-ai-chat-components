...
export default function InputPage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsx("header", { className: "docs-header", children: _jsxs("div", { children: [_jsx("h1", { children: "Input" }), _jsx("p", { className: "text-xl text-neutral-700 dark:text-neutral-300 mt-2", children: "A text input component for collecting user text input in forms and interfaces." })] }) }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsx("p", { children: "The Input component provides a flexible text input field with support for various types, sizes, states, and validation. Essential for forms, search bars, chat inputs, and any text entry interface." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(LiveDemo, { code: `import { Input } from '@clarity/chat-components';
  ...
  return (
    <div className="space-y-4">
      ...
      <Input placeholder="With helper text" helperText="Enter your email address" />
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Input Props", data: [
                        ...
                        ] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Sizes" }), _jsx(LiveDemo, { code: `import { Input } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Icons" }), _jsx(LiveDemo, { code: `import { Input } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Validation States" }), _jsx(LiveDemo, { code: `import { Input } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Controlled Input" }), _jsx(LiveDemo, { code: `import { useState } from 'react';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "TypeScript" }), _jsx("pre", { children: _jsx("code", { children: `interface InputProps extends React.InputHTMLAttributes<HTMLInputElement> {
  label?: string;
  helperText?: string;
