...
export default SimpleSuggestions`, height: "350px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Icons" }), _jsx("p", { children: "Add visual icons to make suggestions more scannable." }), _jsx(LiveDemo, { title: "Suggestions with Icons", code: `import { FollowUpSuggestions } from '@clarity-chat/react'
...
export default IconSuggestions`, height: "400px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Confidence Scores" }), _jsx("p", { children: "Show how relevant each suggestion is (useful for AI-generated suggestions)." }), _jsx(LiveDemo, { title: "AI-Ranked Suggestions", code: `import { FollowUpSuggestions } from '@clarity-chat/react'
...
export default RankedSuggestions`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Layout Options" }), _jsx("p", { children: "Choose between grid (default) or list layout." }), _jsx(LiveDemo, { title: "List vs Grid Layout", code: `import { FollowUpSuggestions } from '@clarity-chat/react'
...
export default LayoutOptions`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Loading State" }), _jsx("p", { children: "Show skeleton placeholders while AI generates suggestions." }), _jsx(LiveDemo, { title: "Loading Suggestions", code: `import { FollowUpSuggestions } from '@clarity-chat/react'
...
export default LoadingSuggestions`, height: "350px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Real-World Example: AI Chat with Smart Suggestions" }), _jsx(LiveDemo, { title: "Complete Chat Flow", code: `import { FollowUpSuggestions } from '@clarity-chat/react'
import { useState } from 'react'
