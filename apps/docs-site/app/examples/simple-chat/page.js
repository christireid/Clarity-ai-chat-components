...
export default function SimpleChatExample() {
    return (_jsxs(_Fragment, { children: [_jsx(Breadcrumbs, {}), _jsx("h1", { children: "Simple Chat Example" }), _jsx("p", { className: "lead", children: "A minimal chat interface that demonstrates the core functionality of Clarity Chat UI. This example includes message display, user input, and a simulated bot response." }), _jsx(Callout, { type: "info", children: _jsxs("p", { children: [_jsx("strong", { children: "What you'll learn:" }), " Basic ChatWindow usage, message state management, and handling user input."] }) }), _jsx("h2", { id: "live-demo", children: "Live Demo" }), _jsx("p", { children: "Try out the chat interface below. Type a message and see it appear instantly!" }), _jsx(LiveDemo, { title: "Simple Chat Interface", code: simpleChatCode, height: "650px" }), _jsx("h2", { id: "how-it-works", children: "How It Works" }), _jsx("h3", { children: "1. State Management" }), _jsxs("p", { children: ["We use React's ", _jsx("code", { children: "useState" }), " to manage the messages array:"] }), _jsx(CodeBlock, { code: `const [messages, setMessages] = useState<Message[]>([
  {
    id: '1',
    text: 'Hello! Welcome to Clarity Chat UI 👋',
    sender: 'bot',
