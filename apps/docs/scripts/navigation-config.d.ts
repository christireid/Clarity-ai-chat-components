 ...
 */
export declare const projectDescription = "Enterprise-grade React component library for building beautiful, accessible AI chat interfaces. Features 190+ robust components, 95+ custom hooks, 15 themes, and comprehensive token optimization. Built with TypeScript, React 19, and Tailwind CSS.\n\nClarity Chat is the most complete open-source solution for building AI chat interfaces in React. It provides everything you need from basic chat windows to enterprise features like SSO, multi-tenancy, and advanced analytics.";
/**
