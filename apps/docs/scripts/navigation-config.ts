  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        description: 'WCAG AA accessibility',
      },
      {
        title: 'Styling',
 ...
 */
export const projectDescription = `Enterprise-grade React component library for building beautiful, accessible AI chat interfaces. Features 150+ robust components, 95+ custom hooks, 15 themes, and comprehensive token optimization. Built with TypeScript, React 19, and Tailwind CSS.
