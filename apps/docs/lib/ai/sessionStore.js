...
export class RedisSessionStore {
    ...
    async getUserSessions(userId) {
        ...
        return sessions.sort((a, b) => new Date(b.metadata.lastActivity).getTime() -
 ...
 */
export async function getOrCreateSessionForRequest(sessionId, userId, userAgent) {
 ...
 */
export async function updateSessionWithMessages(sessionId, messages) {
    const store = getSessionStore();
