 ...
 */
import { extractTopics } from './advancedRAG';
/**
 ...
 */
function getComponentSuggestions(context) {
 ...
 */
function getHookSuggestions(context) {
 ...
 */
function getGuideSuggestions(context) {
    return [
        {
 ...
 */
function getExampleSuggestions(context) {
    return [
        {
            id: 'example-explain',
 ...
 */
function getRelatedTopicSuggestions(context) {
 ...
 */
function getPracticalSuggestions(context) {
 ...
 */
function extractComponentName(context) {
 ...
 */
function extractHookName(context) {
 ...
 */
function scoreAndDeduplicate(suggestions, context) {
 ...
 */
function calculateRelevance(suggestion, context) {
