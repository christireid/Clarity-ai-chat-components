...
_Newsletter version of: Managing 1M Tokens in Practice_
...
Marketing says "1M context window." Reality says performance degrades long before that limit. Your
45-message conversation shouldn't end with "Error: Maximum context length exceeded."

But in 23% of AI chat apps I've tested, it does.

## The Four Strategies That Work

**1. Sliding Window** Keep only the last N messages. Simple but lossy.
...
**3. RAG (Retrieval)** Don't send history—retrieve relevant context on demand.

Best for: Knowledge bases, documentation chat

**4. Semantic Pruning** Score message relevance, keep what matters.
