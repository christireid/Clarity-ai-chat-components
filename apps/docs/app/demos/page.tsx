...
const demos = [
  {
    id: 'zero-to-chat',
    title: 'Zero to Chat',
    description: 'A fully functional AI chat in under 10 lines of code. See instant gratification with beautiful defaults.',
    icon: Zap,
    priority: 'critical',
  ...
  },
  {
    ...
    description: 'Experience the full streaming lifecycle: thinking indicators, character-by-character text, syntax highlighting, and polished transitions.',
    icon: Play,
    priority: 'high',
  ...
  },
  {
    ...
    description: 'Switch between OpenAI, Claude, and Gemini mid-conversation. Same code, different providers.',
    icon: RefreshCw,
    priority: 'high',
  ...
  },
  {
    ...
    description: 'Interactive builder to toggle features, change themes, and export your configuration as starter code.',
    icon: Palette,
    priority: 'high',
  ...
  },
  {
    ...
    description: 'Real-time dashboard showing token counts, context window optimization, and cost savings.',
    icon: BarChart3,
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'See how the AI remembers your name, preferences, and context across sessions with a visual memory panel.',
    icon: Brain,
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'Watch AI agents search the web, generate images, create events, and execute code with custom tool UIs.',
    icon: Wrench,
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'Full keyboard navigation, screen reader support, focus management, and high contrast mode.',
    icon: Accessibility,
    priority: 'medium',
  ...
  },
  {
    ...
    description: 'See how Clarity Chat compares: 27KB vs competitors at 89-156KB. Tree-shaking visualization included.',
    icon: Package,
    priority: 'medium',
  ...
  },
  {
    ...
    description: '10K concurrent connections, error recovery, analytics, multi-tenancy, and audit logging.',
    icon: Building2,
    priority: 'niche',
...
const priorityBadge = {
  ...
  niche: { label: 'Enterprise', className: 'bg-purple-100 text-purple-700 dark:bg-purple-900 dark:text-purple-300' },
}
        ...
        <ScrollReveal>
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-text-secondary max-w-3xl mx-auto">
              Experience the power, polish, and flexibility of Clarity Chat through
              interactive demos. Every feature you see is available in the library.
            </p>
          </div>
        </ScrollReveal>
            ...
            <div className="relative flex flex-col md:flex-row items-center gap-8">
              ...
              <div className="flex-1 text-center md:text-left">
                ...
                <p className="text-lg text-text-secondary mb-4">
                  A fully functional AI chat in <strong>under 10 lines of code</strong>.
                  Type and get real AI responses right here in the docs.
                </p>
        ...
        <ScrollReveal delay={0.3}>
          <div className="mt-16 text-center p-8 md:p-12 rounded-3xl bg-gradient-to-r from-brand-50 via-purple-50 to-pink-50 dark:from-brand-950 dark:via-purple-950 dark:to-pink-950 border border-brand-200 dark:border-brand-800">
            ...
            <p className="text-lg text-text-secondary mb-8 max-w-2xl mx-auto">
              All these demos use the exact same components available in the library.
