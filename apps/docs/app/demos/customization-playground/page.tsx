        ...
        <ScrollReveal>
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-text-secondary max-w-2xl mx-auto">
              Toggle features, change themes, and see your configuration come to
              life. Export the code when you're happy with the result.
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
                    ...
                    <div className="grid grid-cols-6 gap-2">
                      {accentColors.map((color) => (
                        <button
                          key={color.value}
                          onClick={() =>
                            updateConfig('accentColor', color.value)
                          }
          ...
          <ScrollReveal delay={0.2}>
            <div className="lg:col-span-2">
              {/* Live Preview */}
              <div
                className={`rounded-2xl border-2 border-border overflow-hidden shadow-xl ${
                          ...
                          style={{
                            backgroundColor:
                              ...
                              messageStyle === 'bubbles'
                                ...
                                : undefined,
                            borderColor:
                              messageStyle === 'flat' ? accentColor : undefined,
                          }}
                        >
                          <p
            ...
            <div className="flex flex-col md:flex-row items-center justify-between gap-6">
              <div>
                ...
                <p className="text-text-secondary">
                  Copy the code above or download a complete starter project
                  with your settings.
                </p>
              </div>
