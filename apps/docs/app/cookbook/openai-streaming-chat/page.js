...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Complete Working Example" }), _jsx(LiveDemo, { title: "Full Streaming Chat", code: `import { ChatWindow, Message } from '@clarity-chat/react'
import { useState } from 'react'
...
export default StreamingChatDemo`, height: "550px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Improvements You Can Add" }), _jsx("h3", { children: "1. Add System Prompt" }), _jsx(CodeBlock, { language: "typescript", code: `const response = await openai.chat.completions.create({
  model: 'gpt-4-turbo-preview',
  stream: true,
  messages: [
    {
