...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Dynamic Theme Switching" }), _jsx(LiveDemo, { title: "Live Theme Switcher", code: `import { ThemeProvider, ChatWindow, ThemeSwitcher } from '@clarity-chat/react'
import { useState } from 'react'
