...
With Streaming:
User asks → "The" → "The answer" → "The answer is" → "The answer is 42"` }), _jsx("p", { className: "mt-4", children: "Technically, it's Server-Sent Events (SSE) - the server pushes data to the client as it becomes available." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Visual Comparison" }), _jsx(LiveDemo, { title: "Streaming vs Non-Streaming", code: `import { ChatWindow } from '@clarity-chat/react'
...
export default StreamingComparison`, height: "500px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Implementation: OpenAI" }), _jsx(CodeBlock, { language: "typescript", code: `// Server-side (API route)
