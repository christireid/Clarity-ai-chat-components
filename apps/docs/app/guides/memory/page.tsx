      ...
      <div className="max-w-5xl mx-auto px-4 py-8 space-y-12">
        <header>
          ...
          <p className="text-lg text-muted-foreground">
            Comprehensive guide to Clarity Chat's memory system, including
            strategies, providers, types, scopes, and best practices.
          </p>
        </header>
        ...
        <section>
          ...
          <p className="mb-4">
            Clarity Chat's memory system enables your AI assistant to remember
            information across conversations, maintain context, and provide
            personalized responses. The system supports multiple memory
            strategies, scopes, and types to fit different use cases.
          </p>
          <p className="mb-4">
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              <strong>Episodic Memory:</strong> Stores specific events with
              temporal context
            </li>
            <li>
              <strong>Semantic Memory:</strong> Stores compressed, generalized
              knowledge
            </li>
            <li>
              <strong>Short-term Memory:</strong> Recent conversation context
            </li>
            <li>
              <strong>Long-term Memory:</strong> Persistent user preferences and
              facts
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p className="mb-4">
            Clarity Chat supports three memory strategies, each optimized for
            different use cases:
          </p>

          <h3 className="text-2xl font-semibold mb-3">1. Sliding Window</h3>
          <p className="mb-4">
            The simplest strategy that keeps only the most recent messages
            within a token budget. Best for short conversations and when you
...
function SlidingWindowChat() {
  return (
    ...
    />
          ...
          <Callout type="info">
            <p>
              <strong>Use when:</strong> You need simple, predictable memory
              management with low overhead. Best for short conversations and
          ...
          <p className="mb-4">
            Groups related messages into semantic chunks and keeps the most
            relevant chunks. Better context retention than sliding window while
...
function SemanticChunksChat() {
  return (
    ...
    />
          ...
          <Callout type="info">
            <p>
              <strong>Use when:</strong> You need better context retention than
              sliding window but don't want the complexity of a vector store.
          ...
          <p className="mb-4">
            Uses semantic search to retrieve the most relevant memories based on
            query similarity. Best for long conversations and when you need to
  ...
  return (
    ...
    >
      ...
      />
          ...
          <Callout type="info">
            <p>
              <strong>Use when:</strong> You need the best context retention for
              long conversations. Requires a vector store but provides the most
        ...
        <section>
          ...
          <p className="mb-4">
            The <code>MemoryProvider</code> component provides memory context to
            all child components. Wrap your app or chat component with this
            provider to enable memory functionality.
          </p>
    ...
    >
      ...
      />
        ...
        <section>
          ...
          <p className="mb-4">
            Memory items are categorized by type, which determines how they're
            processed and retrieved:
          </p>

          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              <strong>episodic:</strong> Specific events with temporal context
              (e.g., "User asked about weather on Monday")
            </li>
            <li>
              <strong>semantic:</strong> Compressed, generalized knowledge
              (e.g., "User prefers dark mode")
            </li>
            <li>
              <strong>preference:</strong> User preferences and settings
            </li>
            <li>
              <strong>fact:</strong> Factual information about the user or
              domain
            </li>
            <li>
    ...
    <div>
      ...
      <button onClick={addFact}>Save Fact</button>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              <strong>session:</strong> Lives only for the current session
              (cleared on page refresh)
            </li>
            <li>
              <strong>thread:</strong> Persists for a specific conversation
              thread
            </li>
            <li>
              <strong>global:</strong> Persists across all conversations for the
              user
            </li>
            <li>
              <strong>user:</strong> User-specific memories (requires user
              authentication)
            </li>
          </ul>
      ...
      <button onClick={addGlobalMemory}>Add Global Memory</button>
        ...
        <section>
          <h2 className="text-3xl font-semibold mb-4">
            Using Memory with useClarityChat
          </h2>
          <p className="mb-4">
            The <code>useClarityChat</code> hook automatically integrates with
            the memory system when enabled:
          </p>
    ...
    <MemoryProvider config={{ maxTokens: 10000 }}>
      <ChatWithMemory />
        ...
        <section>
          ...
          <p className="mb-4">
            Use <code>useMemoryContext</code> to query memories by relevance,
            type, scope, or metadata:
          </p>
    ...
    <div>
      ...
      <div>
        ...
        <section>
          ...
          <p className="mb-4">
            The memory context provides several operations for managing
            memories:
          </p>
    ...
    <div>
      ...
      <p>Average Confidence: {(stats?.averageConfidence * 100).toFixed(1)}%</p>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Use <code>sliding-window</code> for short conversations and tight
              token budgets
            </li>
            <li>
              Use <code>semantic-chunks</code> for medium conversations needing
              better context
            </li>
            <li>
              Use <code>vector-store</code> for long conversations and best
              context retention
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Reserve tokens for the AI response (typically 20-30% of context
              window)
            </li>
            <li>
            ...
            <li>
              Monitor token usage with <code>memoryInfo</code> from{' '}
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Use <code>session</code> for temporary, conversation-specific
              information
            </li>
            <li>
              Use <code>thread</code> for conversation-specific context
            </li>
            <li>
              Use <code>global</code> for user preferences and persistent facts
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Set high confidence (0.8+) for verified facts and preferences
            </li>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            ...
            <li>
              Use <code>compressMemory</code> to reduce token usage
            </li>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            ...
            <li>
              Set <code>minConfidence</code> to filter low-quality memories
            </li>
            <li>
              Use <code>limit</code> to control result count
            </li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Ensure <code>MemoryProvider</code> wraps your chat component
            </li>
            <li>
              Check that <code>memory.enabled</code> is <code>true</code>
            </li>
            <li>
              Verify <code>memoryInfo</code> shows memory is enabled
            </li>
          </ul>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Ensure vector store is provided to <code>MemoryProvider</code>
            </li>
          ...
          <ul className="list-disc list-inside space-y-2 text-muted-foreground mb-4">
            <li>
              Reduce <code>maxTokens</code> in memory configuration
            </li>
