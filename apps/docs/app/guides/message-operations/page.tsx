...
export const metadata: Metadata = {
  ...
  description: 'Guide for message operations in Clarity Chat',
}

export default async function MessageOperationsGuidePage() {
  // Read markdown file
  let content: string
  try {
    const filePath = join(process.cwd(), 'content', 'vitepress-migration', 'guide', 'message-operations.md')
