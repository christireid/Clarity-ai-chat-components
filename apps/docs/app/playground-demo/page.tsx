    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Edit the code below to see real Clarity Chat components in action. All
          components are rendered using the actual library code - no mocks!
        </p>
      </div>
      ...
      <section className="docs-section">
        <div className="mb-6">
          ...
          <p className="text-gray-600 dark:text-gray-400">
            The playground below uses{' '}
            <code className="text-sm bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
              react-live
            </code>{' '}
            to render real components from{' '}
            <code className="text-sm bg-gray-100 dark:bg-gray-800 px-2 py-1 rounded">
              @clarity-chat/react
            </code>
            . Modify the code to experiment with different props, variants, and
            compositions.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
          <div className="p-4 bg-blue-50 dark:bg-blue-950/30 rounded-lg border border-blue-200 dark:border-blue-800">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Uses actual @clarity-chat/react components, not mocks. See exactly
              how your components will behave in production.
            </p>
          </div>
          ...
          <div className="p-4 bg-purple-50 dark:bg-purple-950/30 rounded-lg border border-purple-200 dark:border-purple-800">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              Changes update instantly as you type. Experiment with different
              props and see results in real-time.
            </p>
          </div>
          ...
          <div className="p-4 bg-green-50 dark:bg-green-950/30 rounded-lg border border-green-200 dark:border-green-800">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              All exported components, hooks, and utilities are available in
              scope. No imports needed in the playground.
            </p>
          </div>
          ...
          <div className="p-4 bg-orange-50 dark:bg-orange-950/30 rounded-lg border border-orange-200 dark:border-orange-800">
            ...
            <p className="text-sm text-gray-700 dark:text-gray-300">
              See helpful error messages and stack traces when something goes
              wrong. Great for learning.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="docs-section">
        ...
        <p className="mb-4">
          All Clarity Chat components and React hooks are available without
          imports:
        </p>
      ...
      <section className="docs-section">
        ...
        <ul className="space-y-2">
          ...
          <li>
            • Errors will appear above the preview with helpful debugging
            information
          </li>
