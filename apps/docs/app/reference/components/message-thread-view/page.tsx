...
export const metadata: Metadata = {
  ...
  description: 'Threaded conversations with nested replies, participant tracking, and thread management.',
}
    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Threaded conversations with nested replies, participant tracking, unread counts, and thread management.
        </p>
      </div>
      ...
      <section className="docs-section">
        <h2>Basic Usage</h2>
        <p>
          Display a thread view for a message:
        </p>
        <CodePlayground
  ...
  return (
    ...
    />
      ...
      <section className="docs-section">
        ...
        <p>
          Configure thread display and behavior:
        </p>
        <CodePlayground
          initialCode={`import { MessageThreadView } from '@clarity-chat/react'
  ...
  return (
    ...
    />
      ...
      <section className="docs-section">
        ...
        <p>
          Track thread participants and unread counts:
        </p>
        <CodePlayground
          initialCode={`import { MessageThreadView } from '@clarity-chat/react'
  ...
  return (
    ...
    />
      ...
      <section className="docs-section">
        ...
        <ul>
          <li><code>id</code>: Unique thread identifier</li>
          <li><code>parentMessageId</code>: ID of parent message</li>
          <li><code>messages</code>: Array of thread messages</li>
          <li><code>participants</code>: Array of thread participants</li>
          <li><code>unreadCount</code>: Number of unread messages</li>
          <li><code>lastActivity</code>: Timestamp of last activity</li>
          <li><code>isArchived</code>: Whether thread is archived</li>
        </ul>
      </section>
      ...
      <section className="docs-section">
        ...
        <ul>
          <li>Use <code>showPreview</code> to reduce visual clutter</li>
          <li>Set <code>collapseThreshold</code> to auto-collapse long threads</li>
          <li>Track <code>unreadCount</code> to show notification badges</li>
          <li>Use <code>layout="sidebar"</code> for better UX on larger screens</li>
      ...
      <section className="docs-section">
        ...
        <ul>
          ...
          <li><a href="/reference/components/message-list">MessageList</a> - Message display</li>
        </ul>
      </section>
    </div>
  )
