...
export default function MessagePage() {
    return (_jsx(ToastProvider, { children: _jsxs(_Fragment, { children: [_jsx(Breadcrumbs, {}), _jsx("h1", { children: "Message" }), _jsx("p", { className: "lead", children: "The Message component displays individual chat messages with support for avatars, timestamps, reactions, attachments, and more. It's highly customizable and accessible." }), _jsx(ViewInStorybook, { component: "Message" }), _jsx("h2", { id: "import", children: "Import" }), _jsx(EnhancedCodeBlock, { code: `import { Message } from '@clarity-chat/react'`, language: "tsx" }), _jsx("h2", { id: "basic-usage", children: "Basic Usage" }), _jsx(EnhancedCodeBlock, { code: `import { Message } from '@clarity-chat/react'
...
}`, language: "tsx", showLineNumbers: true }), _jsx("h2", { id: "with-avatar", children: "With Avatar" }), _jsx("p", { children: "Add user avatars to personalize messages:" }), _jsx(EnhancedCodeBlock, { code: `const message = {
  id: '1',
  text: 'Hello!',
  sender: 'user1',
  timestamp: new Date(),
...
<Message {...message} showAvatar />`, language: "tsx", showLineNumbers: true }), _jsx("h2", { id: "variants", children: "Message Variants" }), _jsx("p", { children: "Choose from different visual styles:" }), _jsx(EnhancedCodeBlock, { code: `// Default style (standard message box)
...
<Message {...message} variant="bubble" />`, language: "tsx" }), _jsx("h2", { id: "alignment", children: "Message Alignment" }), _jsx("p", { children: "Align messages left or right based on sender:" }), _jsx(EnhancedCodeBlock, { code: `// User messages (right-aligned)
<Message 
  {...userMessage} 
  align="right"
...
/>`, language: "tsx" }), _jsx("h2", { id: "reactions", children: "Message Reactions" }), _jsx("p", { children: "Enable emoji reactions on messages:" }), _jsx(EnhancedCodeBlock, { code: `const [message, setMessage] = useState({
  id: '1',
  text: 'Great idea!',
  sender: 'user1',
  timestamp: new Date(),
...
/>`, language: "tsx", showLineNumbers: true }), _jsx("h2", { id: "attachments", children: "File Attachments" }), _jsx("p", { children: "Display file attachments with messages:" }), _jsx(EnhancedCodeBlock, { code: `const message = {
  id: '1',
...
<Message {...message} />`, language: "tsx", showLineNumbers: true }), _jsx("h2", { id: "edit-delete", children: "Edit & Delete" }), _jsx("p", { children: "Add edit and delete actions:" }), _jsx(EnhancedCodeBlock, { code: `const handleEdit = (messageId: string) => {
...
/>`, language: "tsx", showLineNumbers: true }), _jsx("h2", { id: "edited-deleted", children: "Edited & Deleted States" }), _jsx(EnhancedCodeBlock, { code: `// Edited message
<Message 
  {...message}
  isEdited
/>
...
/>`, language: "tsx" }), _jsx("h2", { id: "markdown", children: "Markdown Support" }), _jsx("p", { children: "Enable markdown rendering in messages:" }), _jsx(EnhancedCodeBlock, { code: `import { Message } from '@clarity-chat/react'
...
const message = {
  ...
  sender: 'user1',
  timestamp: new Date(),
}`, language: "tsx", showLineNumbers: true }), _jsx(Callout, { type: "tip", children: _jsxs("p", { children: ["Markdown rendering is not included by default. Use libraries like", ' ', _jsx("code", { children: "react-markdown" }), " or ", _jsx("code", { children: "marked" }), " to parse markdown content."] }) }), _jsx("h2", { id: "props", children: "Props" }), _jsx(PropsTable, { props: messageProps }), _jsx("h2", { id: "types", children: "Type Definitions" }), _jsx("h3", { children: "Avatar Type" }), _jsx(EnhancedCodeBlock, { code: `interface Avatar {
  src: string
  alt: string
  fallback?: string
}`, language: "tsx" }), _jsx("h3", { children: "Attachment Type" }), _jsx(EnhancedCodeBlock, { code: `interface Attachment {
  id: string
  name: string
  size: number
  type: string
  ...
  thumbnail?: string
  preview?: string
}`, language: "tsx" }), _jsx("h2", { id: "styling", children: "Custom Styling" }), _jsx("p", { children: "Customize message appearance with CSS classes:" }), _jsx(EnhancedCodeBlock, { code: `// Custom user message style
<Message
  {...message}
  align="right"
...
}`, language: "tsx", showLineNumbers: true }), _jsx("h3", { children: "Rich Message with All Features" }), _jsx(EnhancedCodeBlock, { code: `const richMessage = {
  id: '1',
