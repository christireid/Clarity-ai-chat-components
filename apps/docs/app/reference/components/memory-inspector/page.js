...
render(<SimpleMemory />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Memory Scopes" }), _jsx("p", { children: "Memories can be scoped to different levels:" }), _jsxs("ul", { children: [_jsxs("li", { children: [_jsx("strong", { children: "Session" }), " \uD83D\uDCAC - Just this conversation (cleared when chat ends)"] }), _jsxs("li", { children: [_jsx("strong", { children: "Thread" }), " \uD83E\uDDF5 - This topic/thread (persists across sessions)"] }), _jsxs("li", { children: [_jsx("strong", { children: "Global" }), " \uD83C\uDF0D - Permanent user memory (never forgotten)"] })] }), _jsx(CodePlayground, { initialCode: `function MemoryScopes() {
  const memories = [
    {
      id: '1',
      label: 'Current topic',
...
render(<MemoryScopes />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Managing Memories" }), _jsx("p", { children: "Add remove and promote actions to let users control what the AI remembers." }), _jsx(CodePlayground, { initialCode: `import { useState } from 'react'
