...
export default SimpleQuality`, height: "350px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Targets" }), _jsx("p", { children: "Show target thresholds to highlight metrics that need improvement." }), _jsx(LiveDemo, { title: "Metrics with Targets", code: `import { ResponseQualityMeter } from '@clarity-chat/react'
...
export default MetricsWithTargets`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Real-World: RAG Quality Dashboard" }), _jsx(LiveDemo, { title: "RAG Quality Monitoring", code: `import { ResponseQualityMeter } from '@clarity-chat/react'
...
export default RAGQualityDashboard`, height: "600px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "ResponseQualityMeter Props", data: qualityProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Integration Example" }), _jsx("pre", { children: _jsx("code", { children: `// Integrate with LangSmith evaluation
