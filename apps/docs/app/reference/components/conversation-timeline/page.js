...
render(<SimpleTimeline />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Event Types" }), _jsx("p", { children: "Different event types are color-coded to make it easy to scan the timeline." }), _jsx(CodePlayground, { initialCode: `function EventTypes() {
  const events = [
    {
      id: '1',
      type: 'user',
...
render(<EventTypes />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Metadata" }), _jsx("p", { children: "Add extra details like tokens used, model name, or any custom data." }), _jsx(CodePlayground, { initialCode: `function MetadataTimeline() {
  const events = [
    {
      id: '1',
      type: 'assistant',
...
render(<MetadataTimeline />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Interactive Timeline" }), _jsx("p", { children: "Click events to jump to that point in the conversation, or retry failed steps." }), _jsx(CodePlayground, { initialCode: `import { useState } from 'react'
...
render(<InteractiveTimeline />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Real-World Example: Agent Debugging Dashboard" }), _jsx("p", { children: "Build a debugging interface to see exactly what your AI agent did." }), _jsx(CodePlayground, { initialCode: `import { useState } from 'react'
