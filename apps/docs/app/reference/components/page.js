...
export default function ComponentsPage() {
    ...
    return (_jsx("div", { className: "container-docs py-12", children: _jsxs("div", { className: "max-w-6xl", children: [_jsxs("div", { className: "mb-12", children: [_jsx("span", { className: "docs-badge mb-4", children: "Components" }), _jsx("h1", { className: "text-5xl font-bold mb-6", children: "Component Library" }), _jsxs("p", { className: "text-xl text-text-secondary mb-4", children: ["Browse ", totalComponents, "+ production-ready React components for building beautiful chat interfaces. Each component is fully typed, accessible, and customizable."] }), _jsxs("div", { className: "flex gap-4 flex-wrap", children: [_jsx(Link, { href: "/examples", className: "px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white rounded-lg font-semibold transition-colors", children: "View Examples" }), _jsx(Link, { href: "/learn/quick-start", className: "px-6 py-3 bg-bg-secondary hover:bg-bg-tertiary text-text-primary border-2 border-border rounded-lg font-semibold transition-colors", children: "Quick Start Guide" })] })] }), _jsx("div", { className: "space-y-12", children: componentCategories.map((category) => (_jsxs("div", { children: [_jsxs("div", { className: "mb-6", children: [_jsx("h2", { className: "text-3xl font-bold mb-2", children: category.title }), _jsx("p", { className: "text-text-secondary", children: category.description })] }), _jsx("div", { className: "grid sm:grid-cols-2 lg:grid-cols-3 gap-4", children: category.components.map((component) => (_jsxs(Link, { href: component.href, className: "group p-5 rounded-xl border-2 border-border hover:border-brand-500 bg-bg-primary hover:shadow-lg transition-all duration-200", children: [_jsx("h3", { className: "text-lg font-semibold mb-2 text-brand-600 dark:text-brand-400 group-hover:text-brand-700 dark:group-hover:text-brand-300", children: component.name }), _jsx("p", { className: "text-sm text-text-secondary leading-relaxed", children: component.description })] }, component.href))) })] }, category.title))) }), _jsxs("div", { className: "mt-16 p-8 bg-gradient-to-r from-brand-50 to-purple-50 dark:from-brand-950 dark:to-purple-950 rounded-xl border-2 border-brand-200 dark:border-brand-800", children: [_jsx("h2", { className: "text-2xl font-bold mb-4", children: "Can't find what you're looking for?" }), _jsx("p", { className: "text-text-secondary mb-6", children: "We're constantly adding new components. Check out our roadmap or request a feature on GitHub." }), _jsxs("div", { className: "flex gap-4 flex-wrap", children: [_jsx(Link, { href: "https://github.com/clarity-chat/ui/issues/new", target: "_blank", rel: "noopener noreferrer", className: "px-6 py-3 bg-brand-500 hover:bg-brand-600 text-white rounded-lg font-semibold transition-colors", children: "Request a Component" }), _jsx(Link, { href: "/reference/hooks", className: "px-6 py-3 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 text-text-primary border-2 border-border rounded-lg font-semibold transition-colors", children: "View Hooks \u2192" })] })] })] }) }));
}
