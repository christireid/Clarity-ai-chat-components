...
export default SimpleContext`, height: "200px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Context Types" }), _jsx("p", { children: "Context cards automatically show appropriate icons and colors based on the content type." }), _jsx(LiveDemo, { title: "Different Context Types", code: `import { ContextCard } from '@clarity-chat/react'
...
export default ContextTypes`, height: "500px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Actions" }), _jsx("p", { children: "Add management actions like toggle, preview, and remove." }), _jsx(LiveDemo, { title: "Interactive Context Card", code: `import { ContextCard } from '@clarity-chat/react'
...
export default InteractiveContext`, height: "350px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Thumbnails" }), _jsx("p", { children: "Show visual previews for images and videos." }), _jsx(LiveDemo, { title: "Context Cards with Thumbnails", code: `import { ContextCard } from '@clarity-chat/react'
...
export default ThumbnailContexts`, height: "300px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Real-World Example: RAG Document Manager" }), _jsx("p", { children: "Build a complete document management interface for RAG applications." }), _jsx(LiveDemo, { title: "RAG Document Manager", code: `import { ContextCard } from '@clarity-chat/react'
import { useState } from 'react'
...
export default RAGDocumentManager`, height: "600px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "ContextCard Props", data: contextCardProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Context Type" }), _jsx("p", { children: "The Context object structure:" }), _jsx("pre", { children: _jsx("code", { children: `interface Context {
  id: string
