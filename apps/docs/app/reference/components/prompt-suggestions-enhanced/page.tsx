  ...
  return (
    <div className="docs-content">
      ...
      <section className="docs-section">
        ...
        <CodePlayground
          code={`import { PromptSuggestionsEnhanced, usePromptSuggestionsEnhanced } from '@clarity-chat/react/internal'
...
render(<ChatWithSuggestions />)`}
      ...
      <section className="docs-section">
        ...
        <CodePlayground
          code={`import { PromptSuggestionsEnhanced } from '@clarity-chat/react/internal'
import type { Message } from '@clarity-chat/types'
