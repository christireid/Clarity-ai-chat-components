...
export const metadata: Metadata = {
  ...
  description: 'Prompt regression testing harness for comparing prompt variants across test datasets.',
}
    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Prompt regression testing harness for comparing prompt variants across curated test datasets before shipping changes.
        </p>
      </div>
  ...
  return (
    ...
    />
      ...
      <section className="docs-section">
        <h2>Test Status</h2>
        <ul>
          <li><strong>pending</strong>: Test not yet run</li>
          <li><strong>running</strong>: Test currently executing</li>
          <li><strong>pass</strong>: Test passed</li>
          <li><strong>fail</strong>: Test failed</li>
        </ul>
      </section>
      ...
      <section className="docs-section">
        ...
        <ul>
          ...
          <li><a href="/reference/components/safety-review-console">SafetyReviewConsole</a> - Safety review</li>
        </ul>
      </section>
    </div>
  )
