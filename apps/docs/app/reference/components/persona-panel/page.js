...
export default BasicPersonas`, height: "400px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "All Persona Types" }), _jsx(LiveDemo, { title: "Complete Persona Set", code: `import { PersonaPanel } from '@clarity-chat/react'
