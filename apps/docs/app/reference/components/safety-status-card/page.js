...
render(<BasicSafety />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Warnings and Failures" }), _jsx(CodePlayground, { initialCode: `function SafetyIssues() {
  const checks = [
    {
      id: '1',
      label: 'Hate Speech',
...
render(<SafetyIssues />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "SafetyStatusCard Props", data: safetyProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Integration Example" }), _jsx("pre", { children: _jsx("code", { children: `// Using OpenAI Moderation API
