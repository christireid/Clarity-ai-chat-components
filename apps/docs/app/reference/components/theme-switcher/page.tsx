  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        Toggle between light and dark themes with smooth transitions and
      ...
      <section className="mb-12">
        <p className="text-muted-foreground">
          Full documentation for this component is coming soon. Try the
          interactive Storybook demo above to explore its features.
        </p>
      </section>
    </div>
  )
