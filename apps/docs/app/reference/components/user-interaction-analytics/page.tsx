  ...
  return (
    <div className="docs-content">
      ...
      <section className="docs-section">
        ...
        <CodePlayground
          code={`import { UserInteractionAnalytics, useInteractionTracking } from '@clarity-chat/react/internal'
  ...
  return (
    ...
    />
      ...
      <section className="docs-section">
        ...
        <CodePlayground
          code={`import { UserInteractionAnalytics } from '@clarity-chat/react/internal'
