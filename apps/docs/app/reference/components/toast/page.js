  ...
  return (
    <Button onClick={() => showToast('This is a basic toast message')}>
      Show Toast
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Toast Options" }), _jsx(ApiTable, { title: "Toast Configuration", data: [
                            {
                                name: 'message',
                        ...
                        ] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Variants" }), _jsx("p", { children: "Use semantic variants to communicate different types of notifications." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Title" }), _jsx("p", { children: "Add a title for more structured notifications." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Positions" }), _jsx("p", { children: "Display toasts at different screen positions." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Custom Duration" }), _jsx("p", { children: "Control how long toasts remain visible before auto-dismissing." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Actions" }), _jsx("p", { children: "Include action buttons for users to respond to toasts." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Toast Queue" }), _jsx("p", { children: "Multiple toasts are automatically queued and displayed sequentially." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Custom Icons" }), _jsx("p", { children: "Customize or remove icons to match your needs." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Progress Toast" }), _jsx("p", { children: "Show progress within a toast notification." }), _jsx(LiveDemo, { code: `import { useState, useEffect } from 'react';
...
}` }), _jsx("h3", { children: "Rich Content Toast" }), _jsx("p", { children: "Display complex content in toast notifications." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
...
}` }), _jsx("h3", { children: "Promise Toast" }), _jsx("p", { children: "Automatically show success/error toasts based on promise resolution." }), _jsx(LiveDemo, { code: `import { Button, useToast } from '@clarity/chat-components';
