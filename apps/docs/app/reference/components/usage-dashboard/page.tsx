    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Visual dashboard for tracking token usage, requests, cost estimates,
          and limits.
        </p>
      </div>
      ...
      <section className="docs-section">
        <h2>Overview</h2>
        <p>
          The <code>UsageDashboard</code> component provides real-time
          visibility into model usage across sessions. It is useful for audits,
          cost awareness, and operational dashboards.
        </p>
        <Callout type="info" title="Use Case">
          Perfect for admin panels, billing dashboards, and monitoring tools
          where you need to track token consumption and costs across users or
          tenants.
        </Callout>
      </section>
...
render(<Example />)`}
      ...
      <section className="docs-section">
        <h2>Props</h2>
        <ApiTable title="UsageDashboard Props" data={usageDashboardProps} />
      </section>
    ...
    <div className="admin-layout">
      ...
      <section className="docs-section">
        ...
        <Callout type="warning" title="Performance">
          Set <code>refreshIntervalMs</code> ≥ 1000ms to avoid excessive
          re-renders and API calls. For high-traffic systems, consider 5000ms or
          higher.
        </Callout>
        <ul>
          <li>Place in admin or developer views, not end-user chat UIs</li>
          <li>
            Use <code>refreshIntervalMs</code> ≥ 1000 to avoid unnecessary
            updates
          </li>
          <li>
            Pair with <code>QuotaManager</code> and <code>RateLimiter</code>{' '}
            utilities
          </li>
          <li>
            Enable <code>showWarnings</code> to alert users approaching quotas
          </li>
