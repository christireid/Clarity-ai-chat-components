...
export default function AvatarPage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsxs("div", { className: "docs-header", children: [_jsx("span", { className: "docs-badge", children: "Component" }), _jsx("h1", { children: "Avatar" }), _jsx("p", { className: "docs-lead", children: "Display user profile pictures with automatic fallbacks, status indicators, sizes, and group avatars." })] }), _jsx(ViewInStorybook, { component: "Avatar" }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsxs("p", { children: ["The ", _jsx("code", { children: "Avatar" }), " component displays user profile pictures with smart fallbacks when images fail to load. It supports various sizes, shapes, status indicators, and can be grouped to show multiple users."] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(CodePlayground, { initialCode: `function BasicAvatar() {
  return (
...
render(<BasicAvatar />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Avatar Props", data: avatarProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Sizes" }), _jsx("p", { children: "Avatars come in multiple predefined sizes from extra small to extra large." }), _jsx(CodePlayground, { initialCode: `function AvatarSizes() {
  return (
...
render(<AvatarSizes />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Fallback Behavior" }), _jsx("p", { children: "When an image fails to load, the Avatar displays initials derived from the user's name with a generated background color." }), _jsx(CodePlayground, { initialCode: `function FallbackAvatars() {
  return (
...
render(<FallbackAvatars />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Status Indicator" }), _jsx("p", { children: "Show user presence status with a colored indicator." }), _jsx(CodePlayground, { initialCode: `function StatusAvatars() {
  return (
    <div className="space-y-6">
      <div>
...
render(<StatusAvatars />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Shapes" }), _jsx("p", { children: "Avatars can be circular (default), rounded square, or square." }), _jsx(CodePlayground, { initialCode: `function AvatarShapes() {
  return (
...
render(<AvatarShapes />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Avatar Group" }), _jsx("p", { children: "Display multiple avatars in a compact, overlapping group." }), _jsx(CodePlayground, { initialCode: `function AvatarGroups() {
  const users = [
...
render(<AvatarGroups />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Badge" }), _jsx("p", { children: "Add notification badges or counts to avatars." }), _jsx(CodePlayground, { initialCode: `function AvatarWithBadge() {
  return (
...
render(<AvatarWithBadge />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Interactive Avatars" }), _jsx("p", { children: "Make avatars clickable for profile views or actions." }), _jsx(CodePlayground, { initialCode: `function InteractiveAvatars() {
...
render(<InteractiveAvatars />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Custom Colors" }), _jsx("p", { children: "Override the default color scheme for fallback avatars." }), _jsx(CodePlayground, { initialCode: `function CustomColorAvatars() {
  return (
    <div className="space-y-6">
      <div>
...
render(<CustomColorAvatars />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Loading State" }), _jsx("p", { children: "Show a skeleton loader while the avatar image is loading." }), _jsx(CodePlayground, { initialCode: `function LoadingAvatars() {
...
render(<LoadingAvatars />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Dynamic Color Generation" }), _jsx("pre", { children: _jsx("code", { children: `// Generate consistent colors based on user ID or name
