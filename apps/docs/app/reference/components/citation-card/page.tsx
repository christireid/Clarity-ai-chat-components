...
export const metadata: Metadata = {
  ...
  description:
    'Display RAG sources and citations with expandable content and confidence scores.',
}
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        Display RAG (Retrieval-Augmented Generation) sources and citations with
        expandable previews, confidence scores, and metadata.
      </p>
      ...
      <section className="mb-12">
        ...
        <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
          <code>{`import { CitationCard } from '@clarity-chat/react/internal'
    ...
    [key: string]: any   // Custom metadata
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-muted-foreground">
          <div>
            <strong className="text-foreground">High (≥0.9):</strong> Green
            badge - Very reliable source
          </div>
          <div>
            <strong className="text-foreground">Medium (0.7-0.89):</strong> Blue
            badge - Reliable source
          </div>
          <div>
            <strong className="text-foreground">Low (0.5-0.69):</strong> Yellow
            badge - Use with caution
          </div>
          <div>
            <strong className="text-foreground">Very Low (&lt;0.5):</strong> Red
            badge - May be irrelevant
          </div>
        </div>
      </section>
...
/>`}</code>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          ...
          <li>
            Handle source clicks with proper security (noopener,noreferrer)
          </li>
