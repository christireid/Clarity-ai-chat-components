  ...
  return (
    <div className="docs-content">
      ...
      <section className="docs-section">
        ...
        <CodePlayground
          code={`import { ConversationSummarizer } from '@clarity-chat/react/internal'
  ...
  return (
    ...
    />
      ...
      <section className="docs-section">
        ...
        <CodePlayground
          code={`import { ConversationSummarizer, type ConversationSummary, type SummaryLevel } from '@clarity-chat/react/internal'
import type { Message } from '@clarity-chat/types'
