...
export default function BadgePage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsxs("div", { className: "docs-header", children: [_jsx("span", { className: "docs-badge", children: "Component" }), _jsx("h1", { children: "Badge" }), _jsx("p", { className: "docs-lead", children: "Display notification counts, status indicators, labels, and tags with customizable colors, sizes, and positions." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsxs("p", { children: ["The ", _jsx("code", { children: "Badge" }), " component is a versatile indicator used to display counts, status, labels, or tags. It can be standalone or overlaid on other components like avatars and icons."] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(LiveDemo, { title: "Basic Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default BasicBadges`, height: "150px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Badge Props", data: badgeProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Variants" }), _jsx("p", { children: "Badges come in multiple semantic variants for different use cases." }), _jsx(LiveDemo, { title: "Badge Variants", code: `import { Badge } from '@clarity-chat/react'
...
export default BadgeVariants`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Sizes" }), _jsx("p", { children: "Choose from small, medium, or large sizes to fit your design." }), _jsx(LiveDemo, { title: "Badge Sizes", code: `import { Badge } from '@clarity-chat/react'
...
export default BadgeSizes`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Icons" }), _jsx("p", { children: "Add icons to badges for better visual communication." }), _jsx(LiveDemo, { title: "Badges with Icons", code: `import { Badge } from '@clarity-chat/react'
...
export default IconBadges`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Dot Badges" }), _jsx("p", { children: "Use minimal dot indicators for subtle notifications." }), _jsx(LiveDemo, { title: "Dot Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default DotBadges`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Positioned Badges" }), _jsx("p", { children: "Overlay badges on other elements like avatars, icons, or buttons." }), _jsx(LiveDemo, { title: "Positioned Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default PositionedBadges`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Max Count" }), _jsx("p", { children: "Automatically format large numbers with a maximum display value." }), _jsx(LiveDemo, { title: "Max Count Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default MaxCountBadges`, height: "300px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Outline Style" }), _jsx("p", { children: "Use outlined badges for a lighter visual weight." }), _jsx(LiveDemo, { title: "Outline Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default OutlineBadges`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Removable Badges" }), _jsx("p", { children: "Make badges removable with an onRemove handler, useful for tags and filters." }), _jsx(LiveDemo, { title: "Removable Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default RemovableBadges`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Pulsing Animation" }), _jsx("p", { children: "Add a pulsing animation to draw attention to live or important badges." }), _jsx(LiveDemo, { title: "Pulsing Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default PulsingBadges`, height: "300px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Interactive Badges" }), _jsx("p", { children: "Make badges clickable for filtering, navigation, or actions." }), _jsx(LiveDemo, { title: "Interactive Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default InteractiveBadges`, height: "350px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Real-world Examples" }), _jsx("h3", { children: "Chat Application Badges" }), _jsx(LiveDemo, { title: "Chat Badges", code: `import { Badge } from '@clarity-chat/react'
...
export default ChatBadges`, height: "550px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Custom Badge Colors" }), _jsx("pre", { children: _jsx("code", { children: `<Badge
  style={{
