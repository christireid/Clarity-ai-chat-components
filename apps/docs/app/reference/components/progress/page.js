...
export default function ProgressPage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsx("header", { className: "docs-header", children: _jsxs("div", { children: [_jsx("h1", { children: "Progress" }), _jsx("p", { className: "text-xl text-neutral-700 dark:text-neutral-300 mt-2", children: "A visual indicator component that shows the completion progress of a task or operation." })] }) }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsx("p", { children: "The Progress component displays a horizontal or circular progress bar to indicate the completion status of tasks, file uploads, downloads, or multi-step processes. It provides clear visual feedback about ongoing operations." }), _jsx(Callout, { type: "info", title: "Determinate vs Indeterminate", children: "Use determinate progress (with value) when you know the completion percentage. Use indeterminate progress when the duration is unknown." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
  ...
  return (
    <div className="space-y-4">
      ...
      <Progress value={90} />
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Progress Props", data: [
                            {
                                name: 'value',
                                type: 'number',
                                default: '0',
                        ...
                        ] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Sizes" }), _jsx("p", { children: "Choose from 3 sizes to match your UI needs." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Colors" }), _jsx("p", { children: "Use semantic colors to indicate different types of progress." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Label" }), _jsx("p", { children: "Display the progress percentage as a label." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Striped Progress" }), _jsx("p", { children: "Add a striped pattern for more visual interest." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Indeterminate Progress" }), _jsx("p", { children: "Use indeterminate progress when the duration is unknown." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Circular Progress" }), _jsx("p", { children: "Display progress as a circular indicator." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Animated Progress" }), _jsx("p", { children: "Simulate progress animation over time." }), _jsx(LiveDemo, { code: `import { useState, useEffect } from 'react';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "File Upload Progress" }), _jsx("p", { children: "A practical example of file upload with progress tracking." }), _jsx(LiveDemo, { code: `import { useState } from 'react';
import { Progress, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Multi-Step Progress" }), _jsx("p", { children: "Track progress through multi-step processes." }), _jsx(LiveDemo, { code: `import { useState } from 'react';
import { Progress, Button } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Progress with Segments" }), _jsx("p", { children: "Show progress divided into segments for multi-part tasks." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
...
}` }), _jsx("h3", { children: "Progress with Custom Label" }), _jsx("p", { children: "Add custom labels and status information." }), _jsx(LiveDemo, { code: `import { Progress } from '@clarity/chat-components';
