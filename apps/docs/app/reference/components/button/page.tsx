...
render(<ConfirmationButtons />)`}
      ...
      <section className="docs-section">
        ...
        <pre>
          <code>{`import { Button, DropdownMenu, DropdownMenuTrigger, DropdownMenuContent, DropdownMenuItem } from '@clarity-chat/primitives'
  ...
  return (
    <div className="inline-flex rounded-lg overflow-hidden">
      ...
      <Dropdown items={actions} placement="bottom-end">
        ...
        <pre>
          <code>{`import { Button, Badge } from '@clarity-chat/primitives'
  ...
  return (
    ...
    >
      {getButtonContent()}
        ...
        <pre>
          <code>{`import { Button, Tooltip } from '@clarity-chat/primitives'
...
>
  Toggle Feature
      ...
      <section className="docs-section">
        <h2>TypeScript</h2>
        <pre>
          <code>{`import { Button, ButtonProps } from '@clarity-chat/primitives'
