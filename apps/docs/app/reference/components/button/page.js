...
export default function ButtonPage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsxs("div", { className: "docs-header", children: [_jsx("span", { className: "docs-badge", children: "Component" }), _jsx("h1", { children: "Button" }), _jsx("p", { className: "docs-lead", children: "Versatile button component with multiple variants, sizes, icons, loading states, and full accessibility support." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsxs("p", { children: ["The ", _jsx("code", { children: "Button" }), " component provides a consistent, accessible way to trigger actions. It supports various styles, sizes, icons, loading states, and can be rendered as a button or link."] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(LiveDemo, { title: "Basic Buttons", code: `import { Button } from '@clarity-chat/react'
...
export default BasicButtons`, height: "150px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Button Props", data: buttonProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Variants" }), _jsx("p", { children: "Choose from multiple semantic variants to convey different actions." }), _jsx(LiveDemo, { title: "Button Variants", code: `import { Button } from '@clarity-chat/react'
...
export default ButtonVariants`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Sizes" }), _jsx("p", { children: "Buttons come in four sizes to fit different contexts." }), _jsx(LiveDemo, { title: "Button Sizes", code: `import { Button } from '@clarity-chat/react'
...
export default ButtonSizes`, height: "150px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Icons" }), _jsx("p", { children: "Add icons before or after button text, or use icon-only buttons." }), _jsx(LiveDemo, { title: "Buttons with Icons", code: `import { Button } from '@clarity-chat/react'
...
export default IconButtons`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Loading State" }), _jsx("p", { children: "Show loading spinner while an action is in progress." }), _jsx(LiveDemo, { title: "Loading Buttons", code: `import { Button } from '@clarity-chat/react'
...
export default LoadingButtons`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Disabled State" }), _jsx("p", { children: "Disable buttons to prevent interaction." }), _jsx(LiveDemo, { title: "Disabled Buttons", code: `import { Button } from '@clarity-chat/react'
...
export default DisabledButtons`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Full Width" }), _jsx("p", { children: "Make buttons span the full width of their container." }), _jsx(LiveDemo, { title: "Full Width Buttons", code: `import { Button } from '@clarity-chat/react'
...
export default FullWidthButtons`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Button Groups" }), _jsx("p", { children: "Group related buttons together for better visual hierarchy." }), _jsx(LiveDemo, { title: "Button Groups", code: `import { Button } from '@clarity-chat/react'
...
export default ButtonGroups`, height: "450px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "As Link" }), _jsx("p", { children: "Render buttons as links for navigation while maintaining button styling." }), _jsx(LiveDemo, { title: "Button Links", code: `import { Button } from '@clarity-chat/react'
...
export default ButtonLinks`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Keyboard Shortcuts" }), _jsx("p", { children: "Display keyboard shortcuts alongside button labels." }), _jsx(LiveDemo, { title: "Buttons with Shortcuts", code: `import { Button } from '@clarity-chat/react'
...
export default ShortcutButtons`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Confirmation Buttons" }), _jsx("p", { children: "Implement confirmation flows with button states." }), _jsx(LiveDemo, { title: "Confirmation Pattern", code: `import { Button } from '@clarity-chat/react'
...
export default ConfirmationButtons`, height: "300px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Split Button with Dropdown" }), _jsx("pre", { children: _jsx("code", { children: `import { Button, Dropdown } from '@clarity-chat/react'
