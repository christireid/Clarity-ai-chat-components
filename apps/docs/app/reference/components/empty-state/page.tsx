...
export const metadata: Metadata = {
  ...
  description:
    'Comprehensive empty state components for various scenarios with actions.',
}
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        ...
        errors, success, and loading scenarios.
      </p>
      ...
      <section className="mb-12">
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          <li>
            <strong>EmptyState</strong> - Base component
          </li>
          <li>
            <strong>EmptyChatState</strong> - No messages
          </li>
          <li>
            <strong>NoSearchResultsState</strong> - No results
          </li>
          <li>
            <strong>NoConversationsState</strong> - No conversations
          </li>
          <li>
            <strong>NoFilesState</strong> - No files uploaded
          </li>
          <li>
            <strong>ErrorState</strong> - Error messages
          </li>
          <li>
            <strong>SuccessState</strong> - Success messages
          </li>
          <li>
            <strong>LoadingState</strong> - Loading spinner
          </li>
          <li>
            <strong>OfflineState</strong> - No connection
          </li>
        </ul>
      </section>
