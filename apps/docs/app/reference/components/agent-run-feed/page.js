...
render(<SimpleAgentFeed />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Live Agent Execution" }), _jsx(CodePlayground, { initialCode: `import { useState, useEffect } from 'react'
...
render(<LiveAgentExecution />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Failed Steps and Retry" }), _jsx(CodePlayground, { initialCode: `import { useState } from 'react'
...
render(<FailureHandling />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "AgentRunFeed Props", data: agentProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Integration with LangChain" }), _jsx("pre", { children: _jsx("code", { children: `// Stream agent steps from LangChain
