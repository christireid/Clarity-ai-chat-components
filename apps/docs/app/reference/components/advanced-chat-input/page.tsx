...
import '@clarity-chat/react/styles.css'`}
      ...
      <ScrollReveal delay={0.5}>
        ...
        <p className="mb-4">
          AdvancedChatInput works similarly to ChatInput but includes additional
          features. The <code>onSubmit</code> callback receives both the message
  ...
  return (
    ...
    />
      ...
      <ScrollReveal delay={0.6}>
        ...
        <p className="mb-4">
          Enable file uploads with drag-and-drop support. Files can be uploaded
          via button click or by dragging files onto the input area:
        </p>
