...
export const metadata: Metadata = {
  ...
  description:
    'Integrate with calendar systems to create events, check availability, and convert action items to calendar events.',
}
    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Integrate with calendar systems to create events, check availability,
          convert action items to events, and manage calendar data.
        </p>
      </div>
    ...
    />
      ...
      <section className="docs-section">
        ...
        <ul>
          ...
          <li>
            <code>description</code>: Event description
          </li>
          <li>
            <code>start</code>: Start date/time
          </li>
          <li>
            <code>end</code>: End date/time
          </li>
          <li>
            <code>location</code>: Event location
          </li>
          <li>
            <code>attendees</code>: Event attendees
          </li>
          <li>
            <code>isAllDay</code>: Whether event is all-day
          </li>
          <li>
            <code>isRecurring</code>: Whether event recurs
          </li>
          <li>
            <code>status</code>: Event status (confirmed, tentative, cancelled)
          </li>
        </ul>
      </section>
      ...
      <section className="docs-section">
        ...
        <ul>
          <li>
            Use <code>fetchEvents</code> to load events for date range
          </li>
