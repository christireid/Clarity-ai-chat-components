...
export default function TooltipPage() {
    return (_jsxs("div", { className: "docs-content", children: [_jsxs("div", { className: "docs-header", children: [_jsx("span", { className: "docs-badge", children: "Component" }), _jsx("h1", { children: "Tooltip" }), _jsx("p", { className: "docs-lead", children: "Display contextual information on hover or focus with customizable positioning, delays, and styling." })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Overview" }), _jsxs("p", { children: ["The ", _jsx("code", { children: "Tooltip" }), " component provides additional context or information when users hover over or focus on an element. It supports multiple positions, custom delays, and rich content."] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Basic Usage" }), _jsx(LiveDemo, { title: "Basic Tooltips", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default BasicTooltips`, height: "150px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Props" }), _jsx(ApiTable, { title: "Tooltip Props", data: tooltipProps })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Positions" }), _jsx("p", { children: "Tooltips can be positioned in 12 different locations around the trigger element." }), _jsx(LiveDemo, { title: "Tooltip Positions", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default TooltipPositions`, height: "400px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "With Delay" }), _jsx("p", { children: "Control when tooltips appear and disappear with custom delays." }), _jsx(LiveDemo, { title: "Tooltip Delays", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default TooltipDelays`, height: "150px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Rich Content" }), _jsx("p", { children: "Tooltips can contain rich HTML content, not just plain text." }), _jsx(LiveDemo, { title: "Rich Content Tooltips", code: `import { Tooltip, Button, Avatar, Badge } from '@clarity-chat/react'
...
export default RichContentTooltips`, height: "200px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Variants" }), _jsx("p", { children: "Use different color variants to convey semantic meaning." }), _jsx(LiveDemo, { title: "Tooltip Variants", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default TooltipVariants`, height: "200px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Arrow Styles" }), _jsx("p", { children: "Choose between arrow, no arrow, or custom arrow styles." }), _jsx(LiveDemo, { title: "Arrow Styles", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default ArrowStyles`, height: "300px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "On Disabled Elements" }), _jsx("p", { children: "Show tooltips even on disabled elements using a wrapper approach." }), _jsx(LiveDemo, { title: "Disabled Elements", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default DisabledTooltips`, height: "350px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Interactive Tooltips" }), _jsx("p", { children: "Allow users to interact with tooltip content (e.g., clicking links)." }), _jsx(LiveDemo, { title: "Interactive Tooltips", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default InteractiveTooltips`, height: "200px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Click to Toggle" }), _jsx("p", { children: "Show tooltips on click instead of hover." }), _jsx(LiveDemo, { title: "Click Tooltips", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default ClickTooltips`, height: "200px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Conditional Tooltips" }), _jsx("p", { children: "Show tooltips only when certain conditions are met." }), _jsx(LiveDemo, { title: "Conditional Tooltips", code: `import { Tooltip, Button } from '@clarity-chat/react'
...
export default ConditionalTooltips`, height: "250px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Tooltip with Keyboard Shortcut" }), _jsx("pre", { children: _jsx("code", { children: `import { Tooltip, Button } from '@clarity-chat/react'
