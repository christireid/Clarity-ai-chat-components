...
export const metadata: Metadata = {
  ...
  description: 'Hook for managing output verbosity preferences with intelligent token limit calculation.',
}
    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Hook for managing output verbosity preferences with intelligent token limit calculation based on context and model capacity.
        </p>
      </div>
      ...
      <section className="docs-section">
        <h2>Basic Usage</h2>
        <p>
          Manage output preference with default configuration:
        </p>
        <CodePlayground
  ...
  return (
    <div>
      ...
      <section className="docs-section">
        ...
        <p>
          Calculate optimal token limits based on model capacity:
        </p>
        <CodePlayground
          initialCode={`import { useOutputPreference } from '@clarity-chat/react'
...
function TokenAwarePreference() {
  ...
  return <ChatInput onSend={sendMessage} />
      ...
      <section className="docs-section">
        ...
        <p>
          Access calculated preference values:
        </p>
        <CodePlayground
          initialCode={`import { useOutputPreference } from '@clarity-chat/react'
  ...
  return (
    <div>
      ...
      <section className="docs-section">
        <h2>Return Values</h2>
        <ul>
          <li><code>preference</code>: Current preference value ('concise' | 'balanced' | 'detailed')</li>
          <li><code>setPreference</code>: Function to update preference</li>
          <li><code>preferenceValue</code>: Full preference object with calculated values</li>
          <li><code>maxTokens</code>: Calculated max tokens for current preference</li>
          <li><code>brevityInstruction</code>: Instruction string to inject into system prompt</li>
        </ul>
      </section>
      ...
      <section className="docs-section">
        ...
        <ul>
          ...
          <li>Inject <code>brevityInstruction</code> into system prompt for better results</li>
          <li>Use <code>maxTokens</code> in API calls to enforce limits</li>
        </ul>
      </section>
      ...
      <section className="docs-section">
        <h2>Related</h2>
        <ul>
          <li><a href="/reference/components/output-preference-selector">OutputPreferenceSelector</a> - Preference selector component</li>
