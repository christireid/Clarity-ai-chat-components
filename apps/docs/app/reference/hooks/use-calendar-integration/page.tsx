...
export const metadata: Metadata = {
  ...
  description: 'Hook for integrating with calendar systems to manage events, check availability, and convert action items.',
}
    ...
    <div className="docs-content">
      <div className="docs-header">
        ...
        <p className="docs-lead">
          Hook for integrating with calendar systems to create events, check availability, convert action items to events, and manage calendar data.
        </p>
      </div>
  ...
  return (
    <div>
      ...
      <section className="docs-section">
        <h2>Return Values</h2>
        <ul>
          <li><code>events</code>: Array of calendar events</li>
          <li><code>actionItems</code>: Array of action items</li>
          <li><code>availability</code>: Array of availability slots</li>
          <li><code>loading</code>: Whether operation is in progress</li>
          <li><code>fetchEvents</code>: Function to fetch events for date range</li>
          <li><code>createEvent</code>: Function to create event</li>
          <li><code>updateEvent</code>: Function to update event</li>
          <li><code>deleteEvent</code>: Function to delete event</li>
          <li><code>checkAvailability</code>: Function to check availability</li>
          <li><code>convertActionToEvent</code>: Function to convert action item to event</li>
        </ul>
      </section>
