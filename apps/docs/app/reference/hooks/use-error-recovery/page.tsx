  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        Automatic error recovery with configurable retry logic, exponential
      ...
      <section className="mb-12">
        ...
        <pre className="bg-muted p-4 rounded-lg overflow-x-auto">
          <code>{`import { useErrorRecovery } from '@clarity-chat/react/internal'
  ...
  Retry ({attemptNumber}/{maxAttempts})
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          <li>
            <strong>network:</strong> Connection errors
          </li>
          <li>
            <strong>ratelimit:</strong> Rate limit errors
          </li>
          <li>
            <strong>server:</strong> 5xx errors
          </li>
          <li>
            <strong>auth:</strong> Authentication errors
          </li>
          <li>
            <strong>unknown:</strong> Other errors
          </li>
        </ul>
      </section>
    </div>
