...
render(<ResponsiveComponent />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Parameters" }), _jsx(ApiTable, { title: "useMediaQuery Parameters", data: [
                            {
                                name: 'query',
                                type: 'string',
                                default: 'undefined',
                        ...
                        ] })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Responsive Breakpoints" }), _jsx("p", { children: "Detect common responsive breakpoints for mobile, tablet, and desktop." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<ResponsiveBreakpoints />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Orientation Detection" }), _jsx("p", { children: "Detect device orientation for tailored layouts." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<OrientationDetection />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Color Scheme Detection" }), _jsx("p", { children: "Detect user's color scheme preference (light or dark mode)." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<ColorSchemeDetection />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Reduced Motion Detection" }), _jsx("p", { children: "Respect user's motion preferences for better accessibility." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
}` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Multiple Queries" }), _jsx("p", { children: "Use multiple media queries for complex responsive logic." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<MultipleQueries />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Conditional Rendering" }), _jsx("p", { children: "Render different components based on media query matches." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<MobileNav />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Custom Breakpoints" }), _jsx("p", { children: "Create reusable breakpoint hooks for your design system." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<useBreakpoint />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Responsive Component State" }), _jsx("p", { children: "Adjust component behavior dynamically based on screen size." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<ResponsiveTable />)` }), _jsx("h3", { children: "Performance Optimization" }), _jsx("p", { children: "Conditionally load heavy components only when needed." }), _jsx(CodePlayground, { initialCode: `import { useMediaQuery } from '@clarity/chat-components';
...
render(<LazyLoadByBreakpoint />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "SSR Considerations" }), _jsx("p", { children: "Handle server-side rendering safely with default values:" }), _jsx("pre", { children: _jsx("code", { children: `import { useMediaQuery } from '@clarity/chat-components';
