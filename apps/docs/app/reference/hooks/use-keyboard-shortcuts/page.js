...
render(<ChatWithShortcuts />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Parameters" }), _jsx(ApiTable, { title: "useKeyboardShortcuts(config)", data: shortcutConfig })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Return Value" }), _jsx(ApiTable, { title: "Return Value", data: returnValue })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Key Sequences" }), _jsxs("p", { children: ["Support for multi-key sequences like Vim or Gmail shortcuts. Define sequences with the ", _jsx("code", { children: "then" }), " keyword."] }), _jsx(CodePlayground, { initialCode: `function ChatWithSequences() {
...
render(<ChatWithSequences />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Scoped Shortcuts" }), _jsx("p", { children: "Use scopes to enable/disable shortcuts based on context. This prevents conflicts when the same key has different meanings in different parts of your app." }), _jsx(CodePlayground, { initialCode: `function ChatWithScopes() {
...
render(<ChatWithScopes />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Preventing Default Behavior" }), _jsx("p", { children: "Control whether the browser's default behavior should be prevented for each shortcut." }), _jsx(CodePlayground, { initialCode: `function ChatWithPreventDefault() {
...
render(<ChatWithPreventDefault />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Dynamic Shortcuts" }), _jsx("p", { children: "Enable or disable shortcuts dynamically based on application state." }), _jsx(CodePlayground, { initialCode: `function ChatWithDynamicShortcuts() {
...
render(<ChatWithDynamicShortcuts />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Input Field Handling" }), _jsx("p", { children: "By default, shortcuts are disabled when typing in input fields. You can customize this behavior." }), _jsx(CodePlayground, { initialCode: `function ChatWithInputHandling() {
  const [message, setMessage] = React.useState('')
  const [log, setLog] = React.useState([])
...
render(<ChatWithInputHandling />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Shortcut Help Panel" }), _jsx("p", { children: "Build an interactive help panel that displays all available shortcuts." }), _jsx(CodePlayground, { initialCode: `function ChatWithHelpPanel() {
...
render(<ChatWithHelpPanel />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Chord Progressions" }), _jsx("p", { children: "Chain multiple shortcuts together to create complex interactions." }), _jsx("pre", { children: _jsx("code", { children: `// Emacs-style chord progressions
useKeyboardShortcuts({
