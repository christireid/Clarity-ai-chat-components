...
export default function UseRAGPipelinePage() {
  return (
    <>
      ...
      <p className="lead">
        Top-level hook for Retrieval-Augmented Generation (RAG) with automatic
        vector store and embedding management. Perfect for building AI
        applications that need to retrieve and use relevant documents from a
        knowledge base.
      </p>

      <Callout type="info" title="RAG Pipeline">
        <p>
          RAG combines retrieval of relevant documents with generation, allowing
          AI models to answer questions using your own knowledge base. This hook
          handles the entire pipeline automatically.
        </p>
      </Callout>
  ...
  embeddingProvider: 'openai',
      ...
      <section className="my-12">
        ...
        <ol className="list-decimal list-inside mb-4 space-y-2 text-gray-600 dark:text-gray-400">
          <li>
            <strong>Query Embedding</strong> - Converts your query into a vector
            embedding
          </li>
          <li>
            <strong>Vector Search</strong> - Searches the vector store for
            similar documents
          </li>
          <li>
            <strong>Reranking (Optional)</strong> - Refines results for better
            relevance
          </li>
          <li>
            <strong>Context Building</strong> - Returns documents ready to use
            as context
          </li>
        </ol>
      </section>
        ...
        <div className="space-y-4">
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-400">
              ...
              <li>
                <strong>Qdrant</strong> - Open-source vector search engine
              </li>
              <li>
                <strong>Weaviate</strong> - Vector database with GraphQL
              </li>
              <li>
                <strong>Chroma</strong> - Embeddings database
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-400">
              <li>
                <strong>OpenAI</strong> - text-embedding-ada-002,
              ...
              <li>
                <strong>Custom</strong> - Use your own embedding service
              </li>
            </ul>
          </div>
          <div>
            ...
            <ul className="list-disc list-inside space-y-1 text-gray-600 dark:text-gray-400">
              <li>
                <strong>Cohere</strong> - rerank-english-v3.0,
                rerank-multilingual-v3.0
              </li>
              <li>
                <strong>Jina</strong> - jina-reranker-v1-base-en
              </li>
              <li>
                <strong>Voyage</strong> - voyage-rerank-lite
              </li>
            </ul>
          </div>
        </div>
      ...
      <section className="my-12">
        ...
        <ul className="list-disc list-inside mb-4 space-y-2 text-gray-600 dark:text-gray-400">
          <li>
            <strong>Use reranking</strong> - Improves relevance, especially for
            top-k retrieval
          </li>
          <li>
            <strong>Limit results</strong> - Start with 5-10 documents, expand
            if needed
          </li>
          <li>
            <strong>Filter by metadata</strong> - Use vector store metadata for
            filtering
          </li>
          <li>
            <strong>Cache embeddings</strong> - Cache query embeddings for
            repeated queries
          </li>
          <li>
            <strong>Monitor costs</strong> - Track embedding and vector store
            API usage
          </li>
          <li>
            <strong>Handle errors</strong> - The hook returns empty array on
