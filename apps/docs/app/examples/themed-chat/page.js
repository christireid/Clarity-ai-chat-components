...
export default function ThemedChatExample() {
    return (_jsxs(_Fragment, { children: [_jsx(Breadcrumbs, {}), _jsx("h1", { children: "Themed Chat Example" }), _jsx("p", { className: "lead", children: "Learn how to customize your chat interface with themes and implement dark mode support. This example shows theme switching, custom colors, and responsive design." }), _jsx(Callout, { type: "info", children: _jsxs("p", { children: [_jsx("strong", { children: "What you'll learn:" }), " Theme configuration, dark mode implementation, custom styling, and ThemeProvider usage."] }) }), _jsx("h2", { id: "live-demo", children: "Live Demo" }), _jsx("p", { children: "Click the theme toggle button to switch between light and dark modes!" }), _jsx(LiveDemo, { title: "Themed Chat Interface", code: themedChatCode, height: "700px" }), _jsx("h2", { id: "how-it-works", children: "How It Works" }), _jsx("h3", { children: "1. Theme State" }), _jsx("p", { children: "Manage theme with React state:" }), _jsx(CodeBlock, { code: `const [theme, setTheme] = useState<'light' | 'dark'>('light')`, language: "tsx" }), _jsx("h3", { children: "2. ThemeProvider" }), _jsx("p", { children: "Wrap your app with ThemeProvider:" }), _jsx(CodeBlock, { code: `import { ThemeProvider } from '@clarity-chat/react'
