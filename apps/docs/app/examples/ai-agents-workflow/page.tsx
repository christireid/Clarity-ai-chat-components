...
export const metadata: Metadata = {
  ...
  description:
    'Multi-agent orchestration with custom tools and task decomposition',
}
    ...
    <div className="container-docs py-12">
      ...
      <div className="max-w-4xl">
        ...
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          <ul>
            <li>
              <strong>Agent Orchestration</strong> - Coordinate multiple
              specialized agents
            </li>
            <li>
              <strong>Custom Tools</strong> - Define domain-specific agent
              capabilities
            </li>
            <li>
              <strong>Task Decomposition</strong> - Break complex tasks into
              subtasks
            </li>
            <li>
            ...
            <li>
              <strong>Tool Invocation Tracking</strong> - Monitor agent actions
              in real-time
            </li>
            <li>
              <strong>Error Recovery</strong> - Automatic retry and fallback
              strategies
            </li>
          </ul>
          ...
          <div className="grid md:grid-cols-3 gap-4 not-prose my-6">
            {[
              ...
              },
              {
                name: 'Strategist',
                icon: '🎯',
                description: 'Creates actionable plans and strategies',
              },
              {
                name: 'Writer',
                icon: '✍️',
              ...
              },
              {
                name: 'Executor',
                icon: '⚡',
                description: 'Performs actions and API calls',
              },
            ].map((agent) => (
              <div
                key={agent.name}
          ...
          <div className="bg-surface-elevated p-6 rounded-lg border border-border not-prose mb-6">
            <p className="font-medium mb-4">
              👤 User: "Analyze our sales and create a marketing strategy"
            </p>
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-text-secondary">
                    Analyzes sales data → Revenue ↑15% YoY, Top products
                    identified
                  </div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-sm text-text-secondary">
                    Studies competitors → Pricing analyzed, growth opportunities
                    found
                  </div>
                </div>
              </div>
              ...
              <div className="mt-4 p-3 bg-green-50 dark:bg-green-950 rounded border border-green-200 dark:border-green-800">
                <div className="text-sm font-medium text-green-800 dark:text-green-200">
                  ✅ Complete: Marketing strategy with projected 30% revenue
                  increase
                </div>
              </div>
            </div>
  ...
  },
  {
    ...
    execute: async (params) => {
      return await emailService.send(params)
          ...
          <ul>
            <li>
              <strong>Specialization</strong> - Each agent excels at specific
              tasks
            </li>
            <li>
