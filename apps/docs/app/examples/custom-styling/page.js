...
render(<TailwindExample />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Method 3: Custom CSS Classes" }), _jsx("p", { children: "For more complex styling, use custom CSS classes with full control." }), _jsx(CodePlayground, { initialCode: `import './custom-chat.css' // Your custom styles
...
render(<CustomCSSExample />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Method 4: Brand Themes" }), _jsx("p", { children: "Create pre-defined brand themes for consistent styling across your app." }), _jsx(CodePlayground, { initialCode: `import { useState } from 'react'
...
export default BrandThemesExample`, height: "700px" })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Method 5: Dark Mode" }), _jsx("p", { children: "Implement dark mode with automatic system preference detection." }), _jsx(CodePlayground, { initialCode: `import { useState, useEffect } from 'react'
...
render(<DarkModeExample />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Method 6: Gradient Themes" }), _jsx("p", { children: "Create stunning gradient-based themes for modern, vibrant UIs." }), _jsx(CodePlayground, { initialCode: `function GradientThemeExample() {
  const messages = [
    {
      id: '1',
...
render(<GradientThemeExample />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Method 7: Component-Specific Styling" }), _jsx("p", { children: "Style individual message components with custom renderers." }), _jsx(CodePlayground, { initialCode: `function CustomMessageStyling() {
  const messages = [
    {
      id: '1',
...
render(<CustomMessageStyling />)` })] }), _jsxs("section", { className: "docs-section", children: [_jsx("h2", { children: "Advanced Patterns" }), _jsx("h3", { children: "Theme Context Provider" }), _jsx("p", { children: "Create a theme context to manage themes across your entire application:" }), _jsx("pre", { children: _jsx("code", { children: `// theme-context.tsx
