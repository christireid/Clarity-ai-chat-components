...
export function TradeConfirmationModal({
  ...
  }, [onApprove, onReject, isProcessing])
          ...
          <div className="px-4 py-3 bg-gradient-to-r from-amber-500 to-orange-500 text-white">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold">Trade Confirmation Required</span>
              </div>
              <button
          ...
          <div className="p-5">
            ...
            >
              ...
              >
                <X className="w-4 h-4" />
                Cancel
                <kbd className="ml-1 px-1.5 py-0.5 text-[10px] bg-gray-200 dark:bg-gray-700 rounded">
                  ESC
                </kbd>
              </button>
              <button
