...
export const metadata: Metadata = {
  title: 'Blog',
  description:
    'Insights, tutorials, and updates about building AI chat interfaces',
}
...
const blogPosts = [
  {
    ...
    description:
      'Learn from $200K in mistakes: the most common UX pitfalls and how to avoid them',
    date: '2024',
    category: 'UX Design',
  },
  {
    ...
    description:
      'A comprehensive guide to solving the most frustrating UX problems in AI chat interfaces',
    date: '2024',
    category: 'Tutorial',
  },
  {
    ...
    description:
      'Research on viral growth strategies for developer tools and component libraries',
    date: '2024',
    category: 'Research',
  },
]
