...
export const metadata: Metadata = {
  ...
  description:
    'Visualize conversation context window with token tracking and pruning.',
}
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      ...
      <p className="text-xl text-muted-foreground mb-8">
        Visual representation of conversation context window showing which
        messages are included and token usage.
      </p>
...
/>`}</code>
      ...
      <section>
        ...
        <ul className="list-disc list-inside space-y-2 text-muted-foreground">
          <li>
            <strong>token_limit:</strong> Exceeds max tokens
          </li>
          <li>
            <strong>pruned:</strong> Manually pruned
          </li>
          <li>
            <strong>too_old:</strong> Outside context window
          </li>
          <li>
            <strong>manual:</strong> User excluded
          </li>
        </ul>
      </section>
    </div>
