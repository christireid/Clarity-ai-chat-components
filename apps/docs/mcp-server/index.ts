 ...
 */
async function fetchAPI<T>(endpoint: string): Promise<T | APIError> {
  try {
    ...
    tools: [
      {
        ...
        description:
          'List all available Clarity Chat React components with their descriptions and categories',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        name: 'get_component',
        description:
          'Get detailed documentation for a specific Clarity Chat component, including props, examples, and accessibility info',
        inputSchema: {
          type: 'object',
          properties: {
            name: {
              type: 'string',
              description:
                'The name of the component (e.g., "ChatInput", "MessageList")',
            },
          },
          required: ['name'],
        },
      },
      {
        name: 'list_hooks',
        description:
          'List all available Clarity Chat React hooks with their descriptions and categories',
        inputSchema: {
          type: 'object',
          properties: {},
        },
      },
      {
        name: 'get_hook',
        description:
          'Get detailed documentation for a specific Clarity Chat hook, including parameters, return values, and examples',
        inputSchema: {
          type: 'object',
          properties: {
            name: {
              type: 'string',
              description:
                'The name of the hook (e.g., "useChat", "useStreaming")',
            },
          },
          required: ['name'],
        },
      },
      {
        name: 'search_docs',
        description:
          'Search Clarity Chat documentation for components, hooks, guides, and examples',
        inputSchema: {
          type: 'object',
          properties: {
            query: {
      ...
      },
      {
        name: 'health_check',
        description:
          'Check the health status of the Clarity Chat documentation API',
        inputSchema: {
          type: 'object',
          properties: {},
        },
...
server.setRequestHandler(CallToolRequestSchema, async (request) => {
  ...
  switch (name) {
    ...
    case 'get_hook': {
      const hookName = (args as { name: string }).name
