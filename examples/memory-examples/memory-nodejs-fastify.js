 ...
 */
fastify.post('/api/preferences/:userId', async (request, reply) => {
    const { userId } = request.params;
 ...
 */
fastify.get('/api/memories/:userId', async (request, reply) => {
    const { userId } = request.params;
 ...
 */
fastify.delete('/api/memories/:memoryId', async (request, reply) => {
...
start();
//# sourceMappingURL=memory-nodejs-fastify.js.map