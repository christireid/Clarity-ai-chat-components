        ...
        children: [
          ...
          stats &&
            _jsxs('div', {
              ...
              children: [
                _jsxs('p', {
                  children: ['Total Memories: ', stats.totalMemories],
                }),
                _jsxs('p', { children: ['Total Tokens: ', stats.totalTokens] }),
                _jsxs('p', {
                  children: [
          ...
          _jsxs(
            'div',
            {
              ...
              children: [
                ...
                _jsx('p', { children: message.content }),
              ],
            },
            index
          )
      ...
      _jsxs('div', {
        ...
        children: [
          _jsx('button', {
            ...
            children: 'Save Theme Preference',
          }),
          _jsx('button', {
            onClick: async () => {
...
export function App() {
  return _jsx(ErrorBoundary, {
    ...
    showReset: true,
    children: _jsx(MemoryProvider, {
      config: memoryConfig,
      vectorStore: vectorStore,
      embeddings: embeddings,
      autoStart: true,
      children: _jsx(ChatWithMemory, {}),
    }),
  })
}
export default App
