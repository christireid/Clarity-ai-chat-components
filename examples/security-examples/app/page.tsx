...
export default function SecurityExamplesPage() {
  const [activeTab, setActiveTab] = useState<'test-bench' | 'monitor' | 'config'>('test-bench')
        ...
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Prompt injection, PII, jailbreak protection</p>
            </div>
          </div>
