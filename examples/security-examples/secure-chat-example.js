...
import { useSecureChat, useSecurityMonitor, useSecurityEvents, SecurityManager, ConsoleAlertHandler, } from '@clarity-chat/react';
/**
...
export function CustomSecurityChat() {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            const secureMessages = security.prepareMessages([systemMessage, ...newMessages]);
            // Step 4: Call LLM
            const response = await fetch('/api/chat', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    return (_jsxs("div", { className: "custom-security-chat", children: [_jsx("h2", { children: "Custom Security Manager" }), error && _jsx("div", { className: "error", children: error }), _jsx("div", { className: "messages", children: messages.map((msg, i) => (_jsxs("div", { className: `message message-${msg.role}`, children: [_jsxs("strong", { children: [msg.role, ":"] }), " ", msg.content] }, i))) }), _jsxs("div", { className: "input-area", children: [_jsx("input", { type: "text", value: input, onChange: (e) => setInput(e.target.value), onKeyPress: (e) => e.key === 'Enter' && handleSend(), placeholder: "Type a message...", disabled: isProcessing }), _jsx("button", { onClick: handleSend, disabled: isProcessing, children: isProcessing ? 'Sending...' : 'Send' })] }), _jsxs("div", { className: "security-stats", children: [_jsx("h3", { children: "Security Statistics" }), _jsx("pre", { children: JSON.stringify(metrics, null, 2) })] })] }));
}
/**
