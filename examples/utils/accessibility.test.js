...
import { accessibleClickHandler, useFocusTrap, useAutoFocus, useEscapeKey, announceToScreenReader, } from './accessibility';
// =============================================================================
...
describe('useAutoFocus', () => {
    ...
    it('focuses element when condition is true', () => {
        ...
        const { rerender } = renderHook(({ condition }) => useAutoFocus(condition), { initialProps: { condition: false } });
...
describe('useFocusTrap', () => {
    ...
    it('stores previously focused element when returnFocus is true', () => {
        ...
        const { unmount } = renderHook(() => useFocusTrap({ enabled: true, returnFocus: true }));
