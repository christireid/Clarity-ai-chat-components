...
async function streamOpenAI(messages, model, controller, encoder) {
    if (!openai)
...
async function streamAnthropic(messages, model, controller, encoder) {
    if (!anthropic)
...
async function streamGoogle(messages, model, controller, encoder) {
    if (!google)
