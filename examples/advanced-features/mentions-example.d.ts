 ...
 */
export declare function BasicMentionExample(): any;
/**
 * Complete mention system with inbox and state management
 */
export declare function MentionInboxExample(): any;
/**
 ...
 */
export declare function AdvancedMentionExample(): any;
/**
 * Production mention system with backend integration
 */
export declare function ProductionMentionExample(): any;
/**
 ...
 */
//# sourceMappingURL=mentions-example.d.ts.map