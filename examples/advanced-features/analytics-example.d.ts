 ...
 */
export declare function BasicInteractionExample(): any;
/**
 * Track when users discover and use features
 */
export declare function FeatureDiscoveryExample(): any;
/**
 * Create and manage A/B tests
 */
export declare function ABTestingExample(): any;
/**
 ...
 */
export declare function CompleteAnalyticsSuiteExample(): any;
/**
 ...
 */
//# sourceMappingURL=analytics-example.d.ts.map