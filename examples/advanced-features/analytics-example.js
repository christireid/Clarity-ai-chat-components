...
import { UserInteractionAnalytics, ABTestingDashboard, useInteractionTracking, useABTesting, ChatWindow, Button, Card, CardContent, CardHeader, CardTitle, } from '@clarity-chat/react';
...
export function BasicInteractionExample() {
    return (_jsxs("div", { className: "space-y-4 p-4", children: [_jsx("h2", { className: "text-2xl font-bold", children: "User Interaction Analytics" }), _jsx(UserInteractionAnalytics, { config: {
                    trackClicks: true,
                    trackFeatureDiscovery: true,
                    samplingRate: 1.0,
                }, realtime: true, updateInterval: 5000, detailed: true, onEventTracked: (event) => {
...
export function FeatureDiscoveryExample() {
    ...
    return (_jsxs("div", { className: "space-y-4 p-4 max-w-2xl", children: [_jsx("h2", { className: "text-2xl font-bold", children: "Feature Discovery Tracking" }), _jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Click features to track discovery" }) }), _jsx(CardContent, { children: _jsx("div", { className: "grid grid-cols-2 gap-3", children: features.map(feature => (_jsxs(Button, { variant: "outline", className: "flex items-center gap-2", onClick: () => handleFeatureClick(feature.id, feature.name), children: [_jsx("span", { children: feature.icon }), _jsx("span", { children: feature.name }), discoveries.has(feature.name) && (_jsxs("span", { className: "ml-auto text-xs text-muted-foreground", children: [discoveries.get(feature.name), "x"] }))] }, feature.id))) }) })] }), events.length > 0 && (_jsxs(Card, { children: [_jsx(CardHeader, { children: _jsx(CardTitle, { children: "Discovery Stats" }) }), _jsx(CardContent, { children: _jsx("div", { className: "space-y-2", children: Array.from(discoveries.entries()).map(([name, count]) => (_jsxs("div", { className: "flex justify-between text-sm", children: [_jsx("span", { children: name }), _jsxs("span", { className: "font-medium", children: [count, " discoveries"] })] }, name))) }) })] }))] }));
}
// =============================================================================
...
export function ABTestingExample() {
    const { experiments, createExperiment, startExperiment, getVariant, recordMetric, } = useABTesting();
    ...
    React.useEffect(() => {
        ...
        if (hasInitialized.current || experiments.length > 0)
            return;
        hasInitialized.current = true;
        // Experiment 1: Button color test
        const exp1 = createExperiment('Button Color Test', [
            {
                id: 'control',
                name: 'Blue Button',
                isControl: true,
        ...
        const exp2 = createExperiment('Message Layout Test', [
            {
                id: 'control',
                name: 'Compact Layout',
                isControl: true,
    ...
    return (_jsxs("div", { className: "p-4", children: [_jsx("h2", { className: "text-2xl font-bold mb-4", children: "A/B Testing Dashboard" }), _jsx(ABTestingDashboard, { experiments: experiments, config: {
                    minSampleSize: 100,
                    confidenceLevel: 0.95,
                    minEffect: 5,
                }, showStatistics: true, onSelectExperiment: (exp) => {
...
export function ChatWithABTestExample() {
    ...
    React.useEffect(() => {
        ...
        if (hasInitialized.current || experiments.length > 0)
            return;
        hasInitialized.current = true;
        const exp = createExperiment('Chat Theme Test', [
    ...
    return (_jsxs("div", { className: "grid grid-cols-3 gap-4 p-4 h-screen", children: [_jsx("div", { className: "col-span-2", children: _jsxs(Card, { className: "h-full", children: [_jsx(CardHeader, { children: _jsxs(CardTitle, { children: ["Chat (Theme: ", variant?.name || 'Loading...', ")"] }) }), _jsxs(CardContent, { children: [_jsx("div", { className: "space-y-2 mb-4", children: messages.map(msg => (_jsx("div", { className: "p-2 border rounded", children: msg.content }, msg.id))) }), _jsxs("div", { className: "flex gap-2", children: [_jsx("input", { type: "text", placeholder: "Type a message...", className: "flex-1 px-3 py-2 border rounded", onKeyDown: (e) => {
                                                if (e.key === 'Enter' && e.currentTarget.value) {
                                                    handleSendMessage(e.currentTarget.value);
                                                    e.currentTarget.value = '';
                                                }
                                            } }), _jsx(Button, { onClick: () => handleSendMessage('Test message'), children: "Send" })] })] })] }) }), _jsx("div", { children: experiments.length > 0 && (_jsx(ABTestingDashboard, { experiments: experiments, showStatistics: true })) })] }));
}
// =============================================================================
...
export function ProductionAnalyticsExample() {
    ...
    if (isLoading) {
        return (_jsx("div", { className: "flex items-center justify-center p-8", children: _jsx(LoadingSpinner, { size: "lg", label: "Loading experiments..." }) }));
    }
    if (error) {
        return (_jsx(ErrorState, { message: error.message, onRetry: () => window.location.reload() }));
    }
    return (_jsx(ErrorBoundary, { children: _jsxs("div", { className: "space-y-4 p-4", children: [_jsx("h2", { className: "text-2xl font-bold", children: "Production Analytics" }), _jsx(UserInteractionAnalytics, { config: {
                        trackClicks: true,
                        trackFeatureDiscovery: true,
                        samplingRate: 0.1, // 10% sampling in production
                    }, realtime: true, onEventTracked: async (event) => {
                    ...
                    } }), _jsx(ABTestingDashboard, { experiments: experiments, showStatistics: true, onDeclareWinner: handleDeclareWinner })] }) }));
}
// =============================================================================
...
export function CompleteAnalyticsSuiteExample() {
    ...
    return (_jsxs("div", { className: "grid grid-cols-2 gap-4 p-4", children: [_jsx("div", { children: _jsx(UserInteractionAnalytics, { config: {
                        trackClicks: true,
                    ...
                    } }) }), _jsx("div", { children: _jsx(ABTestingDashboard, { experiments: experiments, config: {
                        minSampleSize: 100,
                        confidenceLevel: 0.95,
                        minEffect: 5,
                        allocation: 'equal',
