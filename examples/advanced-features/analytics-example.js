...
import { UserInteractionAnalytics, ABTestingDashboard, useInteractionTracking, useABTesting, Button, Card, CardContent, CardHeader, CardTitle, } from '@clarity-chat/react';
// =============================================================================
...
export function ProductionAnalyticsExample() {
    ...
    if (isLoading) {
        return _jsx("div", { className: "p-4", children: "Loading experiments..." });
    }
    return (_jsxs("div", { className: "space-y-4 p-4", children: [_jsx("h2", { className: "text-2xl font-bold", children: "Production Analytics" }), _jsx(UserInteractionAnalytics, { config: {
                    trackClicks: true,
                    trackFeatureDiscovery: true,
