...
// Assertions
assertDefined, assertString, assertNumber, assertObject, assertArray, assertNever, 
// Format validators
isValidEmail, isValidUrl, isValidUUID, isValidJSON, parseJSON, 
// Object utilities
hasKey, hasKeys, pick, omit, } from '../index.js';
...
describe('Assertions', () => {
    ...
    describe('assertString', () => {
        ...
        it('should throw for non-strings', () => {
            ...
            expect(() => assertString(null, 'Must be string')).toThrow('Must be string');
        });
    });
