...
import { LogLevel, configureLogger, setGlobalLogLevel, setRequestId, getRequestId, getLogger, logger, info, warn, error, success, debug, } from '../index.js';
describe('Logger', () => {
    let consoleLogSpy;
    let consoleWarnSpy;
    let consoleErrorSpy;
    ...
    describe('getLogger', () => {
        ...
        it('should pass additional arguments', () => {
            ...
            expect(consoleLogSpy).toHaveBeenCalledWith(expect.any(String), 'Message', { data: 'extra' }, 123);
        });
    });
    describe('Log Levels', () => {
