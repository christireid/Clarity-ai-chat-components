...
export class EnvVarMissingError extends ClarityError {
  constructor(varName: string, description?: string, originalError?: Error) {
    ...
    super(
      ...
      description || `The environment variable ${varName} is not set`,
      solutions,
      {
...
export class FileNotFoundError extends ClarityError {
  constructor(filePath: string, description?: string, originalError?: Error) {
    super(
      'FILE_NOT_FOUND',
      `File not found: ${filePath}`,
      description || `The required file at "${filePath}" does not exist`,
      [
        {
...
export class DependencyMissingError extends ClarityError {
  constructor(packageName: string, version?: string, originalError?: Error) {
    ...
    super(
      ...
      `The package "${packageName}"${version ? ` (version ${version})` : ''} is not installed`,
      [
        {
...
export class ConfigParseError extends ClarityError {
  constructor(
    ...
    super(
      ...
      `Error parsing "${filePath}": ${parseError}`,
      [
        {
