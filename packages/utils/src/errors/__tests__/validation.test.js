...
import { ValidationError, InvalidInputError, MissingFieldError, TypeMismatchError, RangeError, FormatError, } from '../validation.js';
...
describe('ValidationError', () => {
    ...
    it('should include field details when provided', () => {
        const error = new ValidationError('Email is invalid', 'email', 'not-an-email', 'valid email format');
    ...
    it('should provide default solutions', () => {
        ...
        expect(error.solutions[0].steps?.some((s) => s.includes('username'))).toBe(true);
    });
    it('should accept custom solutions', () => {
        ...
        const error = new ValidationError('Invalid', 'field', 'value', 'expected', solutions);
    ...
    it('should preserve original error', () => {
        ...
        const error = new ValidationError('Validation error', 'field', 'value', 'expected', undefined, originalError);
...
describe('MissingFieldError', () => {
    ...
    it('should provide fix instructions', () => {
        ...
        expect(error.solutions[0].steps?.some((s) => s.includes('password'))).toBe(true);
    });
    it('should include custom context', () => {
        const error = new MissingFieldError('apiKey', 'API key is required for authentication');
...
describe('FormatError', () => {
    ...
    it('should include example when provided', () => {
        const error = new FormatError('date', 'yesterday', 'ISO 8601', '2024-01-15T12:00:00Z');
