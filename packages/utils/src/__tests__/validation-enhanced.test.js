...
validateString, validateNumber, validateArray, validateUnion, validateEnum, validateDate, validateOptional, 
...
// Enhanced assertions
assertString, assertNumber, assertBoolean, assertObject, assertArray, assertFunction, assertDefined, assertNever, 
// Enhanced format validators
isValidEmail, isValidUrl, isValidUuid, isValidJson, parseJson, 
// Enhanced object utilities
hasKey, hasKeys, pick, omit, 
// Enhanced strict runtime checking
strictTypeOf, strictProperty, strictArrayAccess, 
// Enhanced format validation
isValidEmail as isValidEmailEnhanced, isValidUrl as isValidUrlEnhanced, isValidUuid as isValidUuidEnhanced, isValidJson as isValidJsonEnhanced, parseJson as parseJsonEnhanced, StrictValidation, } from '../validation/enhanced';
    ...
    describe('Validation Functions', () => {
        ...
        describe('validateArray', () => {
            it('should validate arrays with item validator', () => {
                const result = validateArray([1, 2, 3], (item) => isNumber(item));
                expect(result.success).toBe(true);
                if (result.success) {
            ...
            it('should validate array length', () => {
                const result = validateArray([1, 2], (item) => isNumber(item), { minLength: 3 });
                expect(result.success).toBe(false);
                if (!result.success) {
    ...
    describe('Strict Runtime Checking', () => {
        describe('strictTypeOf', () => {
            ...
            it('should throw if type guard fails', () => {
                expect(() => strictTypeOf(123, isString, 'Expected string')).toThrow(TypeError);
            });
        });
...
//# sourceMappingURL=validation-enhanced.test.js.map