...
describe('Avatar Component', () => {
    describe('Rendering', () => {
        it('should render avatar with image', () => {
            const { container } = render(_jsx(Avatar, { src: "/avatar.jpg", alt: "User" }));
        ...
        it('should render fallback text when no image', () => {
            render(_jsx(Avatar, { fallback: "JD" }));
        ...
        it('should render with default size', () => {
            const { container } = render(_jsx(Avatar, { fallback: "AB" }));
            const avatar = container.querySelector('.h-10');
            expect(avatar).toBeInTheDocument();
        });
        it('should render with xs size', () => {
            const { container } = render(_jsx(Avatar, { size: "xs", fallback: "AB" }));
            const avatar = container.querySelector('.h-6');
            expect(avatar).toBeInTheDocument();
        });
        it('should render with sm size', () => {
            const { container } = render(_jsx(Avatar, { size: "sm", fallback: "AB" }));
            const avatar = container.querySelector('.h-8');
            expect(avatar).toBeInTheDocument();
        });
        it('should render with lg size', () => {
            const { container } = render(_jsx(Avatar, { size: "lg", fallback: "AB" }));
            const avatar = container.querySelector('.h-12');
            expect(avatar).toBeInTheDocument();
        });
        it('should render with xl size', () => {
            const { container } = render(_jsx(Avatar, { size: "xl", fallback: "AB" }));
            const avatar = container.querySelector('.h-16');
            expect(avatar).toBeInTheDocument();
        });
        it('should render with 2xl size', () => {
            const { container } = render(_jsx(Avatar, { size: "2xl", fallback: "AB" }));
    ...
    describe('Image Handling', () => {
        it('should handle image load error', () => {
            ...
            render(_jsx(Avatar, { src: "/invalid.jpg", alt: "User", fallback: "JD" }));
        ...
        it('should show fallback when image fails to load', () => {
            ...
            render(_jsx(Avatar, { src: "/broken.jpg", alt: "User", fallback: "FB" }));
            // Fallback is always rendered, Radix UI will display it when image fails
    ...
    describe('Status Indicator', () => {
        ...
        it('should render custom status badge', () => {
            render(_jsx(Avatar, { statusBadge: _jsx("span", { "data-testid": "custom-badge", children: "Custom" }), fallback: "AB" }));
            expect(screen.getByTestId('custom-badge')).toBeInTheDocument();
        });
        it('should have accessible aria-label for online status', () => {
            render(_jsx(Avatar, { status: "online", fallback: "AB" }));
        ...
        it('should have accessible aria-label for offline status', () => {
            render(_jsx(Avatar, { status: "offline", fallback: "AB" }));
        ...
        it('should have accessible aria-label for away status', () => {
            render(_jsx(Avatar, { status: "away", fallback: "AB" }));
        ...
        it('should have accessible aria-label for busy status', () => {
            render(_jsx(Avatar, { status: "busy", fallback: "AB" }));
    ...
    describe('Hover Effects', () => {
        it('should apply hoverable class when hoverable is true', () => {
            const { container } = render(_jsx(Avatar, { hoverable: true, fallback: "AB" }));
    ...
    describe('Styling', () => {
        ...
        it('should accept custom className', () => {
            const { container } = render(_jsx(Avatar, { className: "custom-avatar", fallback: "AB" }));
    ...
    describe('Accessibility', () => {
        it('should have proper alt text for images', () => {
            const { container } = render(_jsx(Avatar, { src: "/avatar.jpg", alt: "User avatar" }));
        ...
        it('should support aria-label', () => {
            render(_jsx(Avatar, { "aria-label": "User profile picture", fallback: "AB" }));
            expect(screen.getByLabelText('User profile picture')).toBeInTheDocument();
        });
        it('should be focusable when interactive', () => {
            const { container } = render(_jsx(Avatar, { tabIndex: 0, fallback: "AB" }));
    ...
    describe('Fallback Generation', () => {
        ...
        it('should handle three words', () => {
            render(_jsx(Avatar, { alt: "John Michael Doe" }));
            // Takes first letter of first two words: J + M = JM
            expect(screen.getByText('JM')).toBeInTheDocument();
        });
        it('should handle empty alt text', () => {
            render(_jsx(Avatar, { alt: "" }));
            expect(screen.getByText('?')).toBeInTheDocument();
        });
        it('should prioritize fallback prop over alt', () => {
            render(_jsx(Avatar, { alt: "John Doe", fallback: "Custom" }));
