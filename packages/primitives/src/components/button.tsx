...
const buttonVariants = cva(
  'relative inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium tracking-[0.13px] ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-[3px] focus-visible:ring-ring/50 focus-visible:ring-offset-1 disabled:pointer-events-none disabled:opacity-50 overflow-hidden',
  {
    variants: {
      variant: {
        default:
          'bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-sm hover:-translate-y-[1px] active:translate-y-0 active:shadow-xs shadow-xs',
        destructive:
          'bg-destructive text-destructive-foreground hover:bg-destructive/90 hover:shadow-sm hover:-translate-y-[1px] active:translate-y-0 active:shadow-xs shadow-xs',
        outline:
        ...
        secondary:
          'bg-secondary text-secondary-foreground hover:bg-secondary/80 hover:shadow-sm hover:-translate-y-[1px] active:translate-y-0 active:shadow-xs shadow-xs',
        ghost: 'hover:bg-accent hover:text-accent-foreground',
        link: 'text-primary underline-offset-4 hover:underline',
        success:
          'bg-green-600 text-white hover:bg-green-700 hover:shadow-sm hover:-translate-y-[1px] active:translate-y-0 active:shadow-xs shadow-xs',
        error:
          'bg-red-600 text-white hover:bg-red-700 hover:shadow-sm hover:-translate-y-[1px] active:translate-y-0 active:shadow-xs shadow-xs',
        surface:
          'bg-surface text-surface-foreground hover:bg-surface/80 hover:shadow-sm hover:-translate-y-[1px] active:translate-y-0 active:shadow-xs shadow-xs border border-border',
      },
      size: {
