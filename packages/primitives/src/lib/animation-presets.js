 ...
 */
export function getReducedMotionVariants(normalVariants, prefersReducedMotion, useFade = true) {
 ...
 * ```
 */
export function getReducedMotionTransition(normalTransition, prefersReducedMotion) {
    if (prefersReducedMotion) {
        return noAnimation;
    }
 ...
 */
export function getReducedMotionInteractive(prefersReducedMotion) {
    if (prefersReducedMotion) {
...
//# sourceMappingURL=animation-presets.js.map