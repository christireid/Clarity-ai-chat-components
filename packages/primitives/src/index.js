...
// Dialog
export { Dialog, DialogPortal, DialogOverlay, DialogTrigger, DialogClose, DialogContent, DialogHeader, DialogBody, DialogFooter, DialogTitle, DialogDescription, } from './components/ui/dialog';
// Also export with Shadcn prefix for backward compatibility
export { Dialog as ShadcnDialog, DialogPortal as ShadcnDialogPortal, DialogOverlay as ShadcnDialogOverlay, DialogTrigger as ShadcnDialogTrigger, DialogClose as ShadcnDialogClose, DialogContent as ShadcnDialogContent, DialogHeader as ShadcnDialogHeader, DialogFooter as ShadcnDialogFooter, DialogTitle as ShadcnDialogTitle, DialogDescription as ShadcnDialogDescription, } from './components/ui/dialog';
// DropdownMenu
...
// Also export with Shadcn prefix for backward compatibility
export { DropdownMenu as ShadcnDropdownMenu, DropdownMenuTrigger as ShadcnDropdownMenuTrigger, DropdownMenuContent as ShadcnDropdownMenuContent, DropdownMenuItem as ShadcnDropdownMenuItem, DropdownMenuCheckboxItem as ShadcnDropdownMenuCheckboxItem, DropdownMenuRadioItem as ShadcnDropdownMenuRadioItem, DropdownMenuLabel as ShadcnDropdownMenuLabel, DropdownMenuSeparator as ShadcnDropdownMenuSeparator, DropdownMenuShortcut as ShadcnDropdownMenuShortcut, DropdownMenuGroup as ShadcnDropdownMenuGroup, DropdownMenuPortal as ShadcnDropdownMenuPortal, DropdownMenuSub as ShadcnDropdownMenuSub, DropdownMenuSubContent as ShadcnDropdownMenuSubContent, DropdownMenuSubTrigger as ShadcnDropdownMenuSubTrigger, DropdownMenuRadioGroup as ShadcnDropdownMenuRadioGroup, } from './components/ui/dropdown-menu';
// Popover
export { Popover, PopoverTrigger, PopoverContent, } from './components/ui/popover';
// Also export with Shadcn prefix for backward compatibility
export { Popover as ShadcnPopover, PopoverTrigger as ShadcnPopoverTrigger, PopoverContent as ShadcnPopoverContent, } from './components/ui/popover';
...
export { Tooltip as TooltipRoot, TooltipTrigger, TooltipContent, TooltipProvider, } from './components/ui/tooltip';
// Also export raw shadcn/Radix Tooltip components for advanced use (aliased)
export { Tooltip as ShadcnTooltip, TooltipTrigger as ShadcnTooltipTrigger, TooltipContent as ShadcnTooltipContent, TooltipProvider as ShadcnTooltipProvider, Tooltip as RadixTooltip, } from './components/ui/tooltip';
// Checkbox
...
export { LoadingIcon, SuccessIcon, ErrorIcon, CloseIcon, CharacterCount, } from './components/icons';
...
export { useReducedMotion, getReducedMotionPreference, } from './hooks/use-reduced-motion';
export { useControllableState, useControllableBoolean, } from './hooks/use-controllable-state';
export { composeRefs, useComposedRefs, useForwardedRef, } from './hooks/use-composed-refs';
...
// ARIA Utilities
export { generateAriaId, resetAriaIdCounter, announce, clearAnnouncement, getFocusableElements, getFirstFocusableElement, getLastFocusableElement, focusFirstElement, saveFocus, Keys, isKey, isActivationKey, getErrorAriaAttributes, getLoadingAriaAttributes, getExpandedAriaAttributes, } from './lib/aria';
// Animation Presets
export { durations, springPresets, easingPresets, noAnimation, fadeVariants, scaleVariants, slideUpVariants, slideDownVariants, slideLeftVariants, slideRightVariants, popVariants, collapseVariants, getReducedMotionVariants, getReducedMotionTransition, interactiveVariants, getReducedMotionInteractive, staggerContainerVariants, staggerItemVariants, animationPresets, } from './lib/animation-presets';
// ============================================================================
// Context Providers
// ============================================================================
export { A11yProvider, A11yContext, useA11y, useReducedMotionContext, } from './context/a11y-context';
// ============================================================================
// Compound Components
// ============================================================================
// Input Compound (composable sub-components)
export { InputCompound, InputRoot, InputLabel, InputField, InputError, InputHelper, InputCharacterCount, InputFooter, } from './components/input-compound';
// ============================================================================
// Enhanced Custom Components (with advanced accessibility)
// ============================================================================
// Enhanced Dialog with animations and focus trap
export { Dialog as EnhancedDialog, DialogTrigger as EnhancedDialogTrigger, DialogContent as EnhancedDialogContent, DialogHeader as EnhancedDialogHeader, DialogTitle as EnhancedDialogTitle, DialogDescription as EnhancedDialogDescription, DialogBody as EnhancedDialogBody, DialogFooter as EnhancedDialogFooter, DialogClose as EnhancedDialogClose, } from './components/dialog';
// Enhanced Button with ripple and announcements
export { Button as EnhancedButton, buttonVariants as enhancedButtonVariants, } from './components/button';
