...
// Debug tools
import { EnhancedConsole, createEnhancedConsole, getEnhancedConsole, } from '../../debug/enhanced-console';
import { ComponentMonitor, createComponentMonitor, getComponentMonitor, } from '../../debug/component-monitor';
import { TokenTracker, createTokenTracker, getTokenTracker, } from '../../debug/token-tracker';
import { StateDiff, createStateDiff, getStateDiff, quickDiff, } from '../../debug/state-diff';
import { NetworkTimeline, createNetworkTimeline, getNetworkTimeline, } from '../../debug/network-timeline';
import { ErrorTracker, createErrorTracker, getErrorTracker, } from '../../debug/error-tracker';
import { DevNotifications, createDevNotifications, getDevNotifications, } from '../../debug/dev-notifications';
// React hooks
...
describe('useComponentMonitor Hook', () => {
    it('should return metrics', () => {
        const { result } = renderHook(() => useComponentMonitor({ componentName: 'TestComponent', enabled: true }));
...
describe('useStateDiff Hook', () => {
    it('should track state changes', () => {
        const { result, rerender } = renderHook(({ state }) => useStateDiff(state, { autoTrack: true }), { initialProps: { state: { count: 0 } } });
...
describe('useErrorTracker Hook', () => {
    it('should track errors', () => {
        const { result } = renderHook(() => useErrorTracker({ enabled: true, autoTrack: false }));
        let event;
        act(() => {
...
//# sourceMappingURL=enhanced-tools.test.js.map