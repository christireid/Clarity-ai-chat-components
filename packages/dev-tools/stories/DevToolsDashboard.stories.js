...
export const Default = {
    render: () => {
        ...
        return _jsx(DevToolsDashboard, { defaultTab: "inspector" });
    },
};
/**
 * Inspector Only
 */
export const InspectorOnly = {
    render: () => _jsx(DevToolsDashboard, { showProfiler: false, showValidation: false, showTimeTravel: false }),
};
/**
 * Profiler Only
 */
export const ProfilerOnly = {
    render: () => _jsx(DevToolsDashboard, { showInspector: false, showValidation: false, showTimeTravel: false, defaultTab: "profiler" }),
};
/**
 * All Tools
 */
export const AllTools = {
    render: () => _jsx(DevToolsDashboard, {}),
};
//# sourceMappingURL=DevToolsDashboard.stories.js.map