...
export const Default = {
    render: () => {
        ...
        return _jsx(ModelComparisonPanel, { promptId: "prompt-1" });
    },
};
/**
 * Empty State
 */
export const Empty = {
    render: () => _jsx(ModelComparisonPanel, {}),
};
/**
 * With Many Responses
 */
export const ManyResponses = {
    render: () => {
        const { addResponse, compare } = useModelComparison();
        useEffect(() => {
            const models = [
        ...
        return _jsx(ModelComparisonPanel, { promptId: "prompt-many" });
    },
};
//# sourceMappingURL=ModelComparisonPanel.stories.js.map