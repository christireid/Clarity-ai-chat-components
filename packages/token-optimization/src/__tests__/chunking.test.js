...
describe('TextChunker', () => {
    ...
    describe('Utility Methods', () => {
        ...
        it('should detect when chunking is needed', () => {
            ...
            expect(chunker.needsChunking('This is a much longer text with many words that will definitely exceed the token limit of just ten tokens')).toBe(true);
        });
    ...
    describe('Overlap Behavior', () => {
        it('should include overlap in subsequent chunks', () => {
            ...
            const text = 'Sentence number one. Sentence number two. Sentence number three. '.repeat(10);
            const result = chunker.chunk(text);
