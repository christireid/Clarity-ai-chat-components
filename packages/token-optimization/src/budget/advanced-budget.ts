...
export interface AllocationStrategy {
  name: string
  allocate: (budget: number, requirements: AllocationRequirements) => TokenAllocation
  priority: number
}
...
export class AdvancedTokenBudgetManager {
  ...
  private calculateQualityScore(allocation: TokenAllocation, context: ContextFactors): number {
  ...
  private generateRecommendations(allocation: TokenAllocation, context: ContextFactors): string[] {
