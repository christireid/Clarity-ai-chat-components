 ...
 */
import { AccurateTokenCounter, TokenSecurityManager, ToonOptimizer, DEFAULT_TOKENIZER_CONFIG, DEFAULT_SECURITY_CONFIG, DEFAULT_TOON_CONFIG, } from './simple-index';
/**
 * Simple Unified Token Optimizer
 */
export class SimpleUnifiedOptimizer {
    ...
    constructor(enableCaching = true) {
        ...
        this.tokenCounter = new AccurateTokenCounter(DEFAULT_TOKENIZER_CONFIG.enableCaching, DEFAULT_TOKENIZER_CONFIG);
        ...
        try {
            ...
            try {
                ...
                if (words.length > 10) {
                    ...
                    const importantWords = words.filter((_word, index) => index % 2 === 0);
...
//# sourceMappingURL=simple-unified.js.map