 ...
 * ```
 */
export function createGoogleAnalyticsProvider(measurementId) {
    return {
 ...
 * ```
 */
export function createMixpanelProvider(token) {
    return {
        name: 'mixpanel',
        init: async () => {
            if (typeof window === 'undefined')
 ...
 * ```
 */
export function createPostHogProvider(apiKey, options) {
    return {
        name: 'posthog',
        init: async () => {
            if (typeof window === 'undefined')
 ...
 * ```
 */
export function createAmplitudeProvider(apiKey) {
    return {
        name: 'amplitude',
        init: async () => {
            if (typeof window === 'undefined')
 ...
 */
export function createLocalStorageProvider(storageKey = 'analytics_events') {
    return {
        name: 'localStorage',
        track: (event) => {
            if (typeof window === 'undefined')
