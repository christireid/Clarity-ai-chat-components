...
import { assertDefined, isDefined, isNonEmptyString, isValidNumber, isPlainObject, isArray, isFunction, isPromise, assert, assertNever, } from '../assertions';
describe('assertions', () => {
    ...
    describe('assertNever', () => {
        ...
        it('should throw with custom message', () => {
            expect(() => assertNever('unexpected', 'Custom error')).toThrow('Custom error');
        });
    });
});
