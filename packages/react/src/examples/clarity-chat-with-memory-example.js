...
export function ClarityChatWithMemoryExample() {
    ...
    return (_jsx("div", { className: "flex h-screen w-full flex-col", children: _jsx(ChatWindow, { messages: messages, onSendMessage: handleSendMessage, isLoading: isLoading, showHeader: true, sessionTitle: "Clarity Chat with Memory", sessionSubtitle: "Conversations are automatically stored and enriched" }) }));
}
/**
 ...
 */
export function ClarityChatWithMemoryExampleWrapped({ memoryConfig, }) {
    return (_jsx(MemoryProvider, { config: memoryConfig || {
            maxMemories: 1000,
            enableVectorSearch: true,
        }, children: _jsx(ClarityChatWithMemoryExample, {}) }));
}
//# sourceMappingURL=clarity-chat-with-memory-example.js.map