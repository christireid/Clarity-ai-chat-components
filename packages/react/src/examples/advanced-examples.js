...
// ChatComplete,
ClarityChat, useChat, ChatWindow, MemoryProvider, AnalyticsProvider,
...
export function Advanced_MultiChat() {
    ...
    return (_jsxs("div", { className: "h-screen flex flex-col", children: [_jsxs("div", { className: "border-b p-4 flex gap-2", children: [_jsx("button", { onClick: () => setActiveChat('support'), className: `px-4 py-2 rounded ${activeChat === 'support' ? 'bg-primary text-primary-foreground' : ''}`, children: "Support" }), _jsx("button", { onClick: () => setActiveChat('sales'), className: `px-4 py-2 rounded ${activeChat === 'sales' ? 'bg-primary text-primary-foreground' : ''}`, children: "Sales" }), _jsx("button", { onClick: () => setActiveChat('technical'), className: `px-4 py-2 rounded ${activeChat === 'technical' ? 'bg-primary text-primary-foreground' : ''}`, children: "Technical" })] }), _jsx(ChatWindow, { messages: active.messages, isLoading: active.isLoading, onSendMessage: active.sendMessage, showHeader: true, sessionTitle: `${activeChat.charAt(0).toUpperCase() + activeChat.slice(1)} Chat` })] }));
}
/**
