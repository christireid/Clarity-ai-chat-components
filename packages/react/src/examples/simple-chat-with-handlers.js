...
export function SimpleChatWithHandlers() {
    ...
    return (_jsx(ChatWindow, { messages: chat.messages, isLoading: chat.isLoading, onSendMessage: handlers.onSendMessage, onClear: handlers.onClear, onMessageRetry: handlers.onRetry, onEditMessage: (id) => {
...
//# sourceMappingURL=simple-chat-with-handlers.js.map