...
import { useClarityChat, ChatWindow, convertCoreMessagesToMessages, createUserMessage, isUserMessage, } from '@clarity-chat/react';
import { MemoryProvider } from '../memory/memory-provider';
import { Badge, Card } from '@clarity-chat/primitives';
/**
