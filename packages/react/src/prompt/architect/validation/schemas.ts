 ...
 * Use these when you need types that match the validated data
 */
export type ValidatedSecurityFinding = z.infer<typeof SecurityFindingSchema>
export type ValidatedCodeSmellFinding = z.infer<typeof CodeSmellFindingSchema>
export type ValidatedTechnicalDebtItem = z.infer<typeof TechnicalDebtItemSchema>
export type ValidatedAuditResult = z.infer<typeof AuditResultSchema>
export type ValidatedPlanningStep = z.infer<typeof PlanningStepSchema>
export type ValidatedStrategicPlan = z.infer<typeof StrategicPlanSchema>
export type ValidatedImplementationOutput = z.infer<typeof ImplementationOutputSchema>
export type ValidatedReviewResult = z.infer<typeof ReviewResultSchema>
export type ValidatedArchitectConfig = z.infer<typeof ArchitectConfigSchema>
export type ValidatedPatternDefinition = z.infer<typeof PatternDefinitionSchema>
...
export const validators = {
  securityFinding: (data: unknown) =>
    validateOrThrow(SecurityFindingSchema, data, 'SecurityFinding'),
  codeSmellFinding: (data: unknown) =>
    validateOrThrow(CodeSmellFindingSchema, data, 'CodeSmellFinding'),
  technicalDebtItem: (data: unknown) =>
    validateOrThrow(TechnicalDebtItemSchema, data, 'TechnicalDebtItem'),
  auditResult: (data: unknown) =>
    validateOrThrow(AuditResultSchema, data, 'AuditResult'),
  planningStep: (data: unknown) =>
    validateOrThrow(PlanningStepSchema, data, 'PlanningStep'),
  strategicPlan: (data: unknown) =>
    validateOrThrow(StrategicPlanSchema, data, 'StrategicPlan'),
  implementationOutput: (data: unknown) =>
    validateOrThrow(ImplementationOutputSchema, data, 'ImplementationOutput'),
  reviewResult: (data: unknown) =>
    validateOrThrow(ReviewResultSchema, data, 'ReviewResult'),
  architectConfig: (data: unknown) =>
    validateOrThrow(ArchitectConfigSchema, data, 'ArchitectConfig'),
  patternDefinition: (data: unknown) =>
    validateOrThrow(PatternDefinitionSchema, data, 'PatternDefinition'),
}
...
export const safeValidators = {
  securityFinding: (data: unknown) =>
    validateSafe(SecurityFindingSchema, data, 'SecurityFinding'),
  codeSmellFinding: (data: unknown) =>
    validateSafe(CodeSmellFindingSchema, data, 'CodeSmellFinding'),
  technicalDebtItem: (data: unknown) =>
    validateSafe(TechnicalDebtItemSchema, data, 'TechnicalDebtItem'),
  auditResult: (data: unknown) =>
    validateSafe(AuditResultSchema, data, 'AuditResult'),
  planningStep: (data: unknown) =>
    validateSafe(PlanningStepSchema, data, 'PlanningStep'),
  strategicPlan: (data: unknown) =>
    validateSafe(StrategicPlanSchema, data, 'StrategicPlan'),
  implementationOutput: (data: unknown) =>
    validateSafe(ImplementationOutputSchema, data, 'ImplementationOutput'),
  reviewResult: (data: unknown) =>
    validateSafe(ReviewResultSchema, data, 'ReviewResult'),
  architectConfig: (data: unknown) =>
    validateSafe(ArchitectConfigSchema, data, 'ArchitectConfig'),
  patternDefinition: (data: unknown) =>
    validateSafe(PatternDefinitionSchema, data, 'PatternDefinition'),
}
