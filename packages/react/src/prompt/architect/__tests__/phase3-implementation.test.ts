...
import type { ProgrammingLanguage, StyleGuide } from '../types'
...
describe('Phase 3: Implementation', () => {
  ...
  describe('LEGACY_IMPROVEMENT_PATTERNS', () => {
    it('should have all improvement types', () => {
      ...
      for (const type of types) {
        expect(LEGACY_IMPROVEMENT_PATTERNS[type as keyof typeof LEGACY_IMPROVEMENT_PATTERNS]).toBeDefined()
      }
    })
  ...
  describe('createLegacyImprovement', () => {
    it('should create a legacy improvement with defaults', () => {
      const improvement = createLegacyImprovement(
        'ADD_TYPES',
        'Added TypeScript types to function'
      )
