...
import { SecurityFindingSchema, CodeSmellFindingSchema, TechnicalDebtItemSchema, AuditResultSchema, PlanningStepSchema, StrategicPlanSchema, ReviewResultSchema, PatternDefinitionSchema, validators, safeValidators, ValidationError, validateOrThrow, validateSafe, } from '../validation';
import { z } from 'zod';
