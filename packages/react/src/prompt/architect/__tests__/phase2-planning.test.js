...
describe('Phase 2: Strategic Planning', () => {
    ...
    describe('createPatternRecommendation', () => {
        it('should create a recommendation with pattern info', () => {
            const rec = createPatternRecommendation('FACTORY_METHOD', 'Allows flexible object creation');
        ...
        it('should use custom tradeoffs when provided', () => {
            const rec = createPatternRecommendation('SINGLETON', 'Need single instance', ['Custom pro', 'Custom con'], 'Use getInstance()');
    ...
    describe('createRejectedAlternative', () => {
        it('should create a rejected alternative', () => {
            const alt = createRejectedAlternative('Inheritance', 'Use class hierarchy', 'Too rigid for this use case', 'When hierarchy is stable');
...
//# sourceMappingURL=phase2-planning.test.js.map