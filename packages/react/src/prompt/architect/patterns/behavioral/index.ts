...
export const CHAIN_OF_RESPONSIBILITY: PatternDefinition = {
...
export const INTERPRETER: PatternDefinition = {
  id: 'INTERPRETER',
  name: 'Interpreter',
  category: 'behavioral',
...
export const ITERATOR: PatternDefinition = {
  id: 'ITERATOR',
  name: 'Iterator',
  category: 'behavioral',
...
export const MEDIATOR: PatternDefinition = {
  id: 'MEDIATOR',
  name: 'Mediator',
  category: 'behavioral',
...
export const MEMENTO: PatternDefinition = {
  id: 'MEMENTO',
  name: 'Memento',
  category: 'behavioral',
...
export const TEMPLATE_METHOD: PatternDefinition = {
  id: 'TEMPLATE_METHOD',
...
export const VISITOR: PatternDefinition = {
  id: 'VISITOR',
  name: 'Visitor',
  category: 'behavioral',
