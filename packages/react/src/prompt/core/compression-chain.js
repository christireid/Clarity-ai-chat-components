...
export async function compressContext(messages, options) {
    const { targetTokens, tokenizer, strategies = ['semantic-grouping', 'tool-condensing', 'intent-summarization'], summarizeFn, keepRecentMessages = 3, maxToolOutputTokens = 500, } = options;
