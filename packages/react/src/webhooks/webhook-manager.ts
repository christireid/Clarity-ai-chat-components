/**
 * Webhook Manager (Consolidated Secure Implementation)
 *
 ...
 *
 * This is the canonical webhook manager implementation with enterprise-grade security.
 * Replaces both the original WebhookManager and EnhancedWebhookManager.
 *
 * @security CRITICAL: This implementation includes essential security features
 * @security - HMAC-SHA256 cryptographic signatures (not simple hashing)
 * @security - Replay attack prevention via timestamp validation
 * @security - Timing attack prevention via constant-time comparison
 * @security - Rate limiting per endpoint
 * @security - Secure defaults (verifySignatures: true)
 */
...
/**
 * Extended webhook configuration with security and enterprise features
 */
export interface WebhookManagerConfig extends WebhookConfig {
  /**
...
/**
 * @deprecated Use `WebhookManager` instead. This is an alias for backward compatibility.
 * The enhanced features are now the default in WebhookManager.
 */
export class EnhancedWebhookManager extends WebhookManager {}

/**
 * @deprecated Use `WebhookManagerConfig` instead. This is an alias for backward compatibility.
 */
export type EnhancedWebhookConfig = WebhookManagerConfig
