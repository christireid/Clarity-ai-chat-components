...
export const withHaptic = (Component, defaultPattern = 'light') => {
    return React.forwardRef((props, ref) => {
        ...
        return _jsx(Component, { ref: ref, ...rest, onClick: handleClick });
    });
};
export const useHapticFeedback = ({ onSuccess = 'success', onError = 'error', onWarning = 'warning', onSelection = 'selection', enabled = true, } = {}) => {
...
//# sourceMappingURL=use-haptic.js.map