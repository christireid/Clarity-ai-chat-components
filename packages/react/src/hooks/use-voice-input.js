...
export function useVoiceInput(options = {}) {
    const { lang = 'en-US', continuous = false, interimResults = true, maxAlternatives = 1, autoStopTimeout = 0, onTranscript, onSpeechStart, onSpeechEnd, onError, } = options;
    ...
    const autoStopTimeoutRef = React.useRef(undefined);
    /**
 ...
 */
export function useSimpleVoiceInput(lang = 'en-US') {
