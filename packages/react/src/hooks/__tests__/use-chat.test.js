...
describe('useChat', () => {
    ...
    describe('AbortController Support', () => {
        it('should support custom AbortSignal', async () => {
            ...
            expect(onSendMessage).toHaveBeenCalledWith(expect.any(Object), expect.objectContaining({ signal: controller.signal }));
        });
        ...
        it('should cleanup on unmount', () => {
            const onSendMessage = vi.fn().mockImplementation(() => new Promise(() => { }) // Never resolves
            );
    ...
    describe('retry', () => {
        ...
        it('should support AbortSignal in retry', async () => {
            ...
            expect(onSendMessage).toHaveBeenCalledTimes(2);
            expect(onSendMessage.mock.calls[1][1]).toEqual(expect.objectContaining({ signal: controller.signal }));
        });
    });
    describe('clear', () => {
...
//# sourceMappingURL=use-chat.test.js.map