...
describe('useCompletion', () => {
    ...
    it('should initialize with initialCompletion', () => {
        const { result } = renderHook(() => useCompletion({ initialCompletion: 'Initial text' }));
    ...
    it('should handle completion', async () => {
        ...
        const { result } = renderHook(() => useCompletion({ api: '/api/completion', stream: true }));
    ...
    it('should handle errors', async () => {
        ...
        const onError = vi.fn();
        const { result } = renderHook(() => useCompletion({ api: '/api/completion', onError }));
...
//# sourceMappingURL=use-completion.test.js.map