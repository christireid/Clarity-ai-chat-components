...
export function useStreamingWebSocket(options) {
    const { url, protocols, autoReconnect = true, maxReconnectAttempts = 5, reconnectDelay: initialReconnectDelay = 1000, maxReconnectDelay = 30000, enableHeartbeat = true, heartbeatInterval = 30000, heartbeatTimeout = 5000, heartbeatMessage = 'ping', autoParseJson = true, connectOnMount = false, onOpen, onMessage, onError, onClose, onReconnecting, onMaxReconnectAttemptsReached, onHeartbeatFailed, } = options;
    // State
