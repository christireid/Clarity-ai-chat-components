...
import { useChat as useChatEnhanced, } from '../chat/use-chat-enhanced';
...
// Internal helpers
import { useMemorySafe, classifyError, retryOperation, extractTextContent, validateApiEndpoint, warnIfMemoryMisconfigured, warnIfTooManyMessages, } from './helpers';
// Debug utilities
...
export function useClarityChat(options = {}) {
    ...
    return {
        ...chat,
        append: memory?.enabled && memoryContext?.service ? enhancedAppend : chat.append,
        memoryInfo,
        memoryErrorInfo,
