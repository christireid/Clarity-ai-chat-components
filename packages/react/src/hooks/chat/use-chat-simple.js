 ...
 * ```
 */
export function useChatSimple(options) {
    // Deprecation warning
    if (process.env['NODE_ENV'] === 'development') {
        console.warn('[Clarity Chat] useChatSimple is deprecated. Use useClarityChat instead. ' +
...
//# sourceMappingURL=use-chat-simple.js.map