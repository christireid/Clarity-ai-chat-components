...
export class JSONLoader implements DocumentLoader {
  name = 'json'
  supportedTypes = ['application/json', 'json']
  
  async load(source: string | File | Blob, options?: {
...
export class LoaderRegistry {
   ...
   */
  async load(source: string | File | Blob, options?: any): Promise<Document[]> {
    let type: string
