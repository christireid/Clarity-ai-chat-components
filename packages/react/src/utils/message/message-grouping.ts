...
export interface MessageGrouping {
  /** Whether this message is the first in a group */
  isGroupStart: boolean
  /** Whether this message is the last in a group */
  isGroupEnd: boolean
  /** Whether this message is part of a group (not standalone) */
  isGrouped: boolean
  /** Whether to show timestamp for this message */
 ...
 * ```
 */
export function getMessageGroupings(messages: Message[]): MessageGrouping[] {
 ...
 * ```
 */
export function getTimeSeparator(timestamp: string): string {
