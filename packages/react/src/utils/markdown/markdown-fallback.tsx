...
export function useMarkdownAvailability() {
  const [state, setState] = useState<
    MarkdownDependencies & { isLoading: boolean }
  >({
    ...markdownDependencies,
  ...
  return (
    <div className={`prose prose-sm max-w-none ${className}`}>
      {showFallbackMessage && (
        ...
        >
          <strong>Note:</strong> Enhanced markdown rendering is unavailable.
          Install <code>react-markdown</code> for full markdown support.
        </div>
      )}
      <div
