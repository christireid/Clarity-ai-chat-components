 ...
 * ```
 */
export function toonToJson(toon, options = {}) {
 ...
 * Parse list format
 */
function parseList(lines, options) {
    const items = [];
    let currentItem = '';
 ...
 */
function parseObject(lines, options) {
    const obj = {};
    let currentKey = null;
    let currentValue = '';
    let indent = 0;
