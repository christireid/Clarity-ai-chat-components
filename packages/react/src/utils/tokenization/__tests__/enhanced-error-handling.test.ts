...
import { TokenOptimizationErrorHandler, ErrorCategory, ErrorSeverity } from '../enhanced-error-handling.js';
...
describe('Enhanced Error Handling Unit Tests', () => {
  ...
  describe('Error Categorization', () => {
    it('should categorize timeout errors correctly', () => {
      ...
      const normalizedError = (errorHandler as any).normalizeError(timeoutError, {
    ...
    it('should categorize resource errors correctly', () => {
      ...
      const normalizedError = (errorHandler as any).normalizeError(resourceError, {
    ...
    it('should categorize validation errors correctly', () => {
      ...
      const normalizedError = (errorHandler as any).normalizeError(validationError, {
        operation: 'validateInput',
        timestamp: Date.now()
      });
