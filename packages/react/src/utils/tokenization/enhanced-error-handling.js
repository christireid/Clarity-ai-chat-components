...
export class TokenOptimizationErrorHandler {
     ...
     */
    createError(message, code, category, severity, context) {
    ...
    normalizeError(error, context) {
        ...
        return this.createError(error.message, this.generateErrorCode(error), category, severity, context);
    }
    /**
     ...
     */
    isTokenOptimizationError(error) {
        return (error &&
            typeof error === 'object' &&
            'code' in error &&
            'category' in error);
