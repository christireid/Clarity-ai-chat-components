...
export function getModelsByProvider(provider) {
    return getAllModelIds().filter((id) => MODEL_REGISTRY[id].provider === provider);
}
/**
 * Get models with a specific capability
 */
export function getModelsWithCapability(capability) {
    return getAllModelIds().filter((id) => MODEL_REGISTRY[id].capabilities[capability]);
}
/**
 * Get models with context window >= specified size
 */
export function getModelsWithMinContextWindow(minTokens) {
    return getAllModelIds().filter((id) => MODEL_REGISTRY[id].contextWindow >= minTokens);
}
/**
 ...
 */
export function tryGetModelConfig(id) {
