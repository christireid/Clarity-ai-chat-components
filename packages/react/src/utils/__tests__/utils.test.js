...
import { ContextWindowManager, FIFOTruncation, estimateTokens, } from '../context-window';
import { MemoryRateLimitStorage, TokenBucketRateLimiter, SlidingWindowRateLimiter, } from '../rate-limiting';
...
describe('Context Window Management', () => {
    const countTokens = (text) => estimateTokens(text);
    ...
    describe('ContextWindowManager', () => {
        it('should truncate messages to fit window', () => {
            ...
            const totalTokens = manager.countTokens(truncated);
