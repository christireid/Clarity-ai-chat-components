...
describe('Token Optimization Test Suite', () => {
  describe('Text Compression Tests', () => {
    ...
    it('should compress text using semantic strategy', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a simple test sentence for token compression testing.'
    ...
    it('should compress text for specific budget', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer test sentence that will be compressed to fit within a specific token budget.'
    ...
    it('should preserve key terms during compression', async () => {
      const text =
        'The artificial intelligence system uses machine learning algorithms to process natural language.'
      const result = await compressText(text, {
        strategy: 'semantic',
        targetRatio: 0.8,
    ...
    it('should handle multi-strategy compression', async () => {
      const text =
        'This is a test sentence for multi-strategy compression. It should try different approaches and return multiple results.'
      const results = await compressMultiStrategy(
        text,
        ['semantic', 'extractive'],
        {
          strategy: 'semantic',
  ...
  describe('Intelligent Caching Tests', () => {
    ...
    it('should handle cache misses', async () => {
      const result = await cache.get<number>('non-existent-key')
    ...
    it('should provide fallback functionality', async () => {
      ...
      const result1 = await cache.getWithFallback<number>(key, fallback)
      expect(result1).toBe(42)
      expect(callCount).toBe(1)

      // Second call should use cache
      const result2 = await cache.getWithFallback<number>(key, fallback)
    ...
    it('should handle cache eviction', async () => {
      ...
      const result1 = await smallCache.get<number>('key1')
      const result2 = await smallCache.get<number>('key2')
      const result3 = await smallCache.get<number>('key3')
    ...
    it('should provide cache statistics', async () => {
      ...
      await cache.get<number>('key1') // Hit
      await cache.get<number>('non-existent') // Miss
  ...
  describe('Smart Truncation Tests', () => {
    ...
    it('should truncate text semantically', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be truncated. Another sentence here.'
    ...
    it('should truncate text extractively', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be truncated. Another sentence here. Final sentence for testing.'
...
Assistant: Tomorrow will be cloudy with a chance of rain.`
    ...
    it('should generate summaries', async () => {
      ...
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be summarized. Another sentence here for testing.'
    ...
    it('should truncate text using convenience function', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be truncated.'
  ...
  describe('Dynamic Optimization Tests', () => {
    ...
    it('should optimize for specific model', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be optimized for a specific model.'
    ...
    it('should optimize for budget', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be optimized to fit within a specific token budget.'
    ...
    it('should optimize for cost', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be optimized to reduce costs.'
  ...
  describe('Dashboard and Monitoring Tests', () => {
    let monitor: TokenOptimizationMonitor
    ...
    it('should record token usage', async () => {
      const originalText =
        'The quick brown fox jumps over the lazy dog. This is the original text that will be optimized.'
      const optimizedText =
        'The quick brown fox jumps over the lazy dog. Optimized text.'
  ...
  describe('Integration Tests', () => {
    it('should integrate compression with caching', async () => {
      ...
      // Retrieve from cache
      const cached = await cache.get<CompressionResult>(
        'compression-result',
        text
      )
    ...
    it('should integrate truncation with optimization', async () => {
      const text =
        'The quick brown fox jumps over the lazy dog. This is a longer sentence that will be optimized and then truncated.'
    ...
    it('should provide end-to-end token optimization pipeline', async () => {
      ...
      const originalText =
        'The quick brown fox jumps over the lazy dog. This is a comprehensive test of the token optimization pipeline with multiple stages including compression, caching, truncation, and monitoring.'
  ...
  describe('Error Handling Tests', () => {
    ...
    it('should handle cache errors gracefully', async () => {
      ...
      const result = await cache.get<number>('non-existent')
      expect(result).toBeUndefined()
    })
