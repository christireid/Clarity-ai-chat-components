...
import { calculateAnalytics, redactSensitiveInfo, exportToJSON, exportToMarkdown, exportToText, } from '../export-utils';
describe('calculateAnalytics', () => {
    ...
    it('calculates average message length', () => {
        const messages = [
            { id: '1', role: 'user', content: 'Hi' }, // 2 chars
            { id: '2', role: 'assistant', content: 'Hello' }, // 5 chars
        ];
        const analytics = calculateAnalytics(messages);
...
//# sourceMappingURL=export-utils.test.js.map