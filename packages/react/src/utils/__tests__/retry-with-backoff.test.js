...
import { retryWithBackoff, createRetryWrapper, AI_API_RETRY_OPTIONS, STREAMING_RETRY_OPTIONS, } from '../retry-with-backoff';
    ...
    describe('rate limit info', () => {
        it('should use rate limit info for delay calculation', async () => {
            ...
            const resultPromise = retryWithBackoff(fn, {
                ...
                jitter: 0,
                onRetry,
                getRateLimitInfo: (e) => e.rateLimitInfo,
            });
            await vi.runAllTimersAsync();
            await expect(resultPromise).rejects.toThrow();
...
//# sourceMappingURL=retry-with-backoff.test.js.map