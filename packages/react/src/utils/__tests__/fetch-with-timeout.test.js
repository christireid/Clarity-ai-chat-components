...
import { fetchWithTimeout, TimeoutError, isTimeoutError, isAbortError, } from '../fetch-with-timeout';
// Mock global fetch
...
describe('fetchWithTimeout', () => {
    ...
    describe('basic functionality', () => {
        ...
        it('should propagate fetch errors', async () => {
            ...
            const errorPromise = fetchWithTimeout('https://api.example.com/test').catch((e) => e);
...
//# sourceMappingURL=fetch-with-timeout.test.js.map