 ...
 */
export function checkForReview(line, lineNumber) {
    const issues = [];
 ...
 * Migrate a single file
 */
export function migrateFile(filePath, dryRun = true) {
 ...
 */
export function migrateDirectory(dirPath, dryRun = true) {
    const results = [];
...
if (require.main === module) {
    ...
    console.log(`Mode: ${dryRun ? 'Dry Run (use --apply to write changes)' : 'Apply Changes'}`);
...
//# sourceMappingURL=migrate-colors.js.map