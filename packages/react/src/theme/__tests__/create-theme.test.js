...
import { createTheme, mergeTheme, generateCSSVariables, getThemeCSS, } from '../create-theme';
...
describe('create-theme', () => {
    ...
    describe('invalid preset warnings', () => {
        ...
        it('should warn when createTheme uses an invalid preset name', () => {
            ...
            const theme = createTheme({ extends: 'ocean' });
        ...
        it('should not warn in production mode', () => {
            ...
            createTheme({ extends: 'invalid-preset' });
            expect(consoleWarnSpy).not.toHaveBeenCalled();
        });
