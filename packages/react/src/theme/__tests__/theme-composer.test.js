...
import { ThemeBuilder, ColorMixins, TypographyMixins, BorderMixins, ShadowMixins, composeThemes, createVariant, ThemeVariants, createBrandTheme, createMultiColorTheme, } from '../theme-composer';
...
describe('theme-composer', () => {
    ...
    describe('ThemeBuilder', () => {
        describe('constructor', () => {
            ...
            it('should accept base theme option', () => {
                ...
                expect(theme.colors.background).toBe(modernThemes['default-dark'].colors.background);
            });
        ...
        describe('extend()', () => {
            it('should extend from a preset name', () => {
                const theme = new ThemeBuilder()
                    ...
                    .name('extended')
                    .build();
                expect(theme.colors.primary).toBe(modernThemes['vibrant'].colors.primary);
            });
        ...
        describe('build()', () => {
            ...
            it('should merge base theme with overrides', () => {
                ...
                expect(theme.colors.background).toBe(modernThemes['default'].colors.background);
            });
        });
    });
    // ==========================================================================
    ...
    describe('composeThemes()', () => {
        it('should compose multiple themes', () => {
            ...
            expect(result.colors.background).toBe(modernThemes['default'].colors.background);
        });
...
//# sourceMappingURL=theme-composer.test.js.map