...
import { validateThemeConfig, assertValidTheme, validateThemeWithWarnings, } from '../theme-validator';
...
describe('validateThemeConfig', () => {
    ...
    describe('missing required fields', () => {
        ...
        it('should error for invalid mode value', () => {
            const theme = { ...modernThemes['default'], mode: 'invalid' };
            const result = validateThemeConfig(theme);
            expect(result.valid).toBe(false);
            expect(result.errors).toContainEqual(expect.objectContaining({
                code: 'INVALID_MODE',
    ...
    describe('HSL format validation', () => {
        ...
        it('should accept hex colors (they get converted)', () => {
            ...
            const primaryErrors = result.errors.filter((e) => e.path.includes('primary'));
    ...
    describe('contrast pair validation', () => {
        it('should check all required contrast pairs', () => {
            ...
            const result = validateThemeConfig(theme);
            const contrastWarnings = result.warnings.filter((w) => w.code === 'LOW_CONTRAST');
        ...
        it('should include popover in contrast checks', () => {
            ...
            const result = validateThemeConfig(theme);
            const popoverWarning = result.warnings.find((w) => w.code === 'LOW_CONTRAST' && w.path.includes('popover'));
...
describe('validateThemeWithWarnings', () => {
    ...
    it('should log warnings in development', () => {
        ...
        validateThemeWithWarnings(theme);
...
//# sourceMappingURL=theme-validator.test.js.map