...
export const slateLightTheme = createPreset('slate', 'light', slateLightColors);
export const slateDarkTheme = createPreset('slate-dark', 'dark', slateDarkColors, { shadows: darkShadows });
