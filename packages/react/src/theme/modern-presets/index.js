...
// Individual presets
import { defaultLightTheme, defaultDarkTheme, defaultThemeMetadata, } from './default';
export { defaultLightTheme, defaultDarkTheme, defaultThemeMetadata };
import { neutralLightTheme, neutralDarkTheme, neutralThemeMetadata, } from './neutral';
export { neutralLightTheme, neutralDarkTheme, neutralThemeMetadata };
import { vibrantLightTheme, vibrantDarkTheme, vibrantThemeMetadata, } from './vibrant';
export { vibrantLightTheme, vibrantDarkTheme, vibrantThemeMetadata };
import { highContrastLightTheme, highContrastDarkTheme, highContrastThemeMetadata, } from './high-contrast';
export { highContrastLightTheme, highContrastDarkTheme, highContrastThemeMetadata, };
...
import { sunsetLightTheme, sunsetDarkTheme, sunsetThemeMetadata, } from './sunset';
export { sunsetLightTheme, sunsetDarkTheme, sunsetThemeMetadata };
import { forestLightTheme, forestDarkTheme, forestThemeMetadata, } from './forest';
...
import { midnightLightTheme, midnightDarkTheme, midnightThemeMetadata, } from './midnight';
...
import { emeraldLightTheme, emeraldDarkTheme, emeraldThemeMetadata, } from './emerald';
...
// 2025 Trending Themes
import { glassmorphismLightTheme, glassmorphismDarkTheme, glassmorphismThemeMetadata, } from './glassmorphism';
...
import { neumorphismLightTheme, neumorphismDarkTheme, neumorphismThemeMetadata, } from './neumorphism';
 ...
 */
export const modernThemeMetadata = {
    default: {
        name: 'default',
        displayName: 'Default',
 ...
 */
export function getModernThemeNames() {
    return Object.keys(modernThemes);
}
/**
 * Get all modern themes with metadata
 */
export function getAllModernThemes() {
 ...
 */
export function isValidModernThemeName(name) {
    return name in modernThemes;
}
/**
 * Get the dark variant of a modern theme
 */
export function getModernDarkVariant(name) {
 ...
 */
export function getModernLightVariant(name) {
    if (!name.endsWith('-dark'))
        return null;
