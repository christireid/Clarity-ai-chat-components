 ...
 */
const vibrantLightColors: ColorConfig = {
  // Base
  background: '0 0% 100%',
 ...
 */
const vibrantDarkColors: ColorConfig = {
 ...
 * Vibrant Light Theme
 */
export const vibrantLightTheme: CompleteThemeConfig = createPreset(
  'vibrant',
  'light',
  vibrantLightColors
)
 ...
 * Vibrant Dark Theme
 */
export const vibrantDarkTheme: CompleteThemeConfig = createPreset(
  'vibrant-dark',
  'dark',
  vibrantDarkColors,
  {
