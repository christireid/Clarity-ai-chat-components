...
import { highContrastLightColors, highContrastDarkColors, } from '../tokens/colors';
import { darkShadows } from '../tokens/shadows';
/**
 * High Contrast Light Theme
 * Pure black on white for maximum readability
 */
export const highContrastLightTheme = createPreset('high-contrast', 'light', highContrastLightColors, {
 ...
 */
export const highContrastDarkTheme = createPreset('high-contrast-dark', 'dark', highContrastDarkColors, {
    shadows: darkShadows,
    borders: {
        width: {
            thin: '2px',
...
//# sourceMappingURL=high-contrast.js.map