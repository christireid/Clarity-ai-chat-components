 ...
 */
const amberLightColors: ColorConfig = {
  // Base - warm cream
 ...
 */
const amberDarkColors: ColorConfig = {
  // Base - deep bronze
  background: '28 30% 7%',
  foreground: '45 40% 95%',
...
export const amberLightTheme: CompleteThemeConfig = createPreset(
  'amber',
  'light',
  amberLightColors
)

export const amberDarkTheme: CompleteThemeConfig = createPreset(
  'amber-dark',
  'dark',
  amberDarkColors,
  { shadows: darkShadows }
