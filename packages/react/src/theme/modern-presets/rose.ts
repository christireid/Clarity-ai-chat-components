 ...
 * Accent: Soft coral
 */
const roseLightColors: ColorConfig = {
 ...
 */
const roseDarkColors: ColorConfig = {
  // Base - deep rose
  background: '350 35% 8%',
...
export const roseLightTheme: CompleteThemeConfig = createPreset(
  'rose',
  'light',
  roseLightColors
)

export const roseDarkTheme: CompleteThemeConfig = createPreset(
  'rose-dark',
  'dark',
  roseDarkColors,
  { shadows: darkShadows }
