 ...
 */
export const neutralLightTheme = createPreset('neutral', 'light', neutralLightColors, {
    borders: {
        width: {
            thin: '1px',
 ...
 */
export const neutralDarkTheme = createPreset('neutral-dark', 'dark', neutralDarkColors, {
    shadows: darkShadows,
    borders: {
        width: {
            thin: '1px',
