 ...
 */
export const neumorphismLightTheme: CompleteThemeConfig = {
  ...
  shadows: {
    ...
    DEFAULT: '5px 5px 10px rgba(0,0,0,0.1), -5px -5px 10px rgba(255,255,255,0.7)',
    ...
    '2xl': '20px 20px 40px rgba(0,0,0,0.1), -20px -20px 40px rgba(255,255,255,0.7)',
    inner: 'inset 4px 4px 8px rgba(0,0,0,0.1), inset -4px -4px 8px rgba(255,255,255,0.7)',
    neumorphic: '5px 5px 10px rgba(0,0,0,0.1), -5px -5px 10px rgba(255,255,255,0.7)',
  },
  ...
  custom: {
    neumorphic: {
      ...
      concave: 'inset 4px 4px 8px rgba(0,0,0,0.1), inset -4px -4px 8px rgba(255,255,255,0.7)',
      convex: '4px 4px 8px rgba(0,0,0,0.1), -4px -4px 8px rgba(255,255,255,0.7)',
    ...
    tactile: {
      pressed: 'inset 2px 2px 4px rgba(0,0,0,0.1), inset -2px -2px 4px rgba(255,255,255,0.7)',
      raised: '6px 6px 12px rgba(0,0,0,0.1), -6px -6px 12px rgba(255,255,255,0.7)',
      inset: 'inset 3px 3px 6px rgba(0,0,0,0.1), inset -3px -3px 6px rgba(255,255,255,0.7)',
    },
  },
}
 ...
 */
export const neumorphismDarkTheme: CompleteThemeConfig = {
  ...
  shadows: {
    ...
    '2xl': '20px 20px 40px rgba(0,0,0,0.3), -20px -20px 40px rgba(255,255,255,0.05)',
    inner: 'inset 4px 4px 8px rgba(0,0,0,0.3), inset -4px -4px 8px rgba(255,255,255,0.05)',
  ...
  custom: {
    neumorphic: {
      ...
      concave: 'inset 4px 4px 8px rgba(0,0,0,0.3), inset -4px -4px 8px rgba(255,255,255,0.05)',
      convex: '4px 4px 8px rgba(0,0,0,0.3), -4px -4px 8px rgba(255,255,255,0.05)',
    ...
    tactile: {
      pressed: 'inset 2px 2px 4px rgba(0,0,0,0.4), inset -2px -2px 4px rgba(255,255,255,0.05)',
      raised: '6px 6px 12px rgba(0,0,0,0.3), -6px -6px 12px rgba(255,255,255,0.05)',
      inset: 'inset 3px 3px 6px rgba(0,0,0,0.3), inset -3px -3px 6px rgba(255,255,255,0.05)',
    },
  },
}
...
export const neumorphismThemeMetadata: ThemeMetadata = {
  ...
  description: 'Soft, extruded UI elements with tactile realism and subtle depth',
  category: 'modern',
  ...
  compatibility: {
    ...
    features: ['CSS shadows', 'CSS filters', 'CSS transitions', 'CSS Variables'],
  },
}
