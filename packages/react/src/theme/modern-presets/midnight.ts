 ...
 */
const midnightLightColors: ColorConfig = {
 ...
 */
const midnightDarkColors: ColorConfig = {
  // Base - deep night
  background: '270 45% 5%',
...
export const midnightLightTheme: CompleteThemeConfig = createPreset(
  'midnight',
  'light',
  midnightLightColors
)

export const midnightDarkTheme: CompleteThemeConfig = createPreset(
  'midnight-dark',
  'dark',
  midnightDarkColors,
  { shadows: darkShadows }
