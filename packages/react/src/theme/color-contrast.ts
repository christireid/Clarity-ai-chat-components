...
export function checkContrast(
  ...
  if (!fg || !bg) {
    throw new Error(
      `Invalid HSL format. Got fg: "${foregroundHSL}", bg: "${backgroundHSL}"`
    )
  }
 ...
 */
export const semanticColorPairs: ColorPair[] = [
  // Primary colors
  {
    name: 'primary',
 ...
 */
export const darkModeColorPairs: ColorPair[] = [
  {
    name: 'success (dark)',
    foreground: '0 0% 100%',
 ...
 */
export function validateAllColors(): ContrastReport[] {
