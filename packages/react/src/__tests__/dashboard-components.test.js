...
import { DashboardErrorBoundary, useDashboardErrorHandler, } from '../components/dashboard-error-boundary';
import { AnalyticsDashboardSkeleton, UsageDashboardSkeleton, TokenOptimizationDashboardSkeleton, PerformanceDashboardSkeleton, DashboardEmptyState, MetricCardSkeleton, } from '../components/dashboard-skeleton';
// ============================================================================
// Test Data
// ============================================================================
...
const mockLeaderboard = [
    { label: 'Alice', value: 50000, change: 15, trend: 'up' },
    { label: 'Bob', value: 45000, change: 10, trend: 'up' },
    { label: 'Carol', value: 40000, change: -5, trend: 'down' },
];
...
describe('AnalyticsDashboard', () => {
    describe('rendering', () => {
        it('should render with required props', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics }));
            expect(screen.getByRole('region')).toBeInTheDocument();
            expect(screen.getByText('Analytics Overview')).toBeInTheDocument();
        });
        it('should render custom title and subtitle', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, title: "Custom Dashboard", subtitle: "Custom subtitle text" }));
        ...
        it('should render leaderboard when provided', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, leaderboard: mockLeaderboard }));
            expect(screen.getByText('Top Performers')).toBeInTheDocument();
            expect(screen.getByText('Alice')).toBeInTheDocument();
            expect(screen.getByText('Bob')).toBeInTheDocument();
        });
        it('should render activity list when provided', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, recentActivities: mockActivities }));
            expect(screen.getByText('Recent Activity')).toBeInTheDocument();
            expect(screen.getByText('Deal closed with Acme Corp')).toBeInTheDocument();
        });
        it('should render insights when provided', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, insights: mockInsights }));
            expect(screen.getByText('AI-Generated Insights')).toBeInTheDocument();
            expect(screen.getByText('Revenue is up 25% from last period')).toBeInTheDocument();
        });
    });
    describe('change indicators', () => {
        it('should show positive change when metrics increase', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, previousMetrics: mockPreviousMetrics }));
        ...
        it('should show negative change when metrics decrease', () => {
            ...
            render(_jsx(AnalyticsDashboard, { metrics: metricsWithDecrease, previousMetrics: mockPreviousMetrics }));
    ...
    describe('edge cases', () => {
        it('should handle empty metrics gracefully', () => {
            render(_jsx(AnalyticsDashboard, { metrics: {} }));
            // Should render without crashing
            expect(screen.getByRole('region')).toBeInTheDocument();
        });
        it('should handle undefined optional props', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, previousMetrics: undefined, leaderboard: undefined, insights: undefined, recentActivities: undefined }));
            expect(screen.getByRole('region')).toBeInTheDocument();
        });
        it('should handle empty arrays', () => {
            render(_jsx(AnalyticsDashboard, { metrics: mockAnalyticsMetrics, leaderboard: [], insights: [], recentActivities: [] }));
            // Lists should not render
            expect(screen.queryByText('Top Performers')).not.toBeInTheDocument();
            expect(screen.queryByText('Recent Activity')).not.toBeInTheDocument();
            expect(screen.queryByText('AI-Generated Insights')).not.toBeInTheDocument();
        });
    });
});
// ============================================================================
...
describe('TokenOptimizationDashboard', () => {
    describe('rendering', () => {
        it('should render with required props', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics }));
        ...
        it('should hide breakdown when showBreakdown is false', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, showBreakdown: false }));
            expect(screen.queryByText('Optimization Breakdown')).not.toBeInTheDocument();
        });
        it('should show real-time indicator when enabled', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, realTime: true }));
    ...
    describe('onClick handler', () => {
        it('should call onClick when dashboard is clicked', () => {
            ...
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, onClick: handleClick }));
...
describe('DashboardErrorBoundary', () => {
    ...
    const ThrowingComponent = ({ shouldThrow = true, }) => {
        ...
        return _jsx("div", { children: "Content rendered successfully" });
    };
    it('should render children when there is no error', () => {
        render(_jsx(DashboardErrorBoundary, { children: _jsx("div", { children: "Test content" }) }));
        expect(screen.getByText('Test content')).toBeInTheDocument();
    });
    it('should render fallback UI when child throws', () => {
        render(_jsx(DashboardErrorBoundary, { widgetName: "Test Widget", children: _jsx(ThrowingComponent, {}) }));
        expect(screen.getByRole('alert')).toBeInTheDocument();
        expect(screen.getByText('Test Widget failed to load')).toBeInTheDocument();
        expect(screen.getByText('Test error')).toBeInTheDocument();
    });
    it('should render custom fallback when provided', () => {
        render(_jsx(DashboardErrorBoundary, { fallback: _jsx("div", { children: "Custom error message" }), children: _jsx(ThrowingComponent, {}) }));
        expect(screen.getByText('Custom error message')).toBeInTheDocument();
    });
    it('should call onError callback when error occurs', () => {
        const handleError = vi.fn();
        render(_jsx(DashboardErrorBoundary, { onError: handleError, children: _jsx(ThrowingComponent, {}) }));
        expect(handleError).toHaveBeenCalled();
        expect(handleError.mock.calls[0][0]).toBeInstanceOf(Error);
    });
    it('should allow retry after error', () => {
        const { rerender } = render(_jsx(DashboardErrorBoundary, { children: _jsx(ThrowingComponent, { shouldThrow: true }) }));
    ...
    it('should hide retry button when showRetry is false', () => {
        render(_jsx(DashboardErrorBoundary, { showRetry: false, children: _jsx(ThrowingComponent, {}) }));
        expect(screen.queryByText('Retry')).not.toBeInTheDocument();
    });
    it('should have accessible error state', () => {
        render(_jsx(DashboardErrorBoundary, { children: _jsx(ThrowingComponent, {}) }));
...
describe('Dashboard Skeletons', () => {
    describe('AnalyticsDashboardSkeleton', () => {
        it('should render loading state', () => {
            render(_jsx(AnalyticsDashboardSkeleton, {}));
        ...
        it('should accept animate prop', () => {
            const { container } = render(_jsx(AnalyticsDashboardSkeleton, { animate: false }));
    ...
    describe('UsageDashboardSkeleton', () => {
        it('should render loading state', () => {
            render(_jsx(UsageDashboardSkeleton, {}));
            expect(screen.getByRole('status')).toBeInTheDocument();
            expect(screen.getByLabelText('Loading usage dashboard')).toBeInTheDocument();
        });
    });
    describe('TokenOptimizationDashboardSkeleton', () => {
        it('should render loading state', () => {
            render(_jsx(TokenOptimizationDashboardSkeleton, {}));
            expect(screen.getByRole('status')).toBeInTheDocument();
            expect(screen.getByLabelText('Loading token optimization dashboard')).toBeInTheDocument();
        });
    });
    describe('PerformanceDashboardSkeleton', () => {
        it('should render loading state', () => {
            render(_jsx(PerformanceDashboardSkeleton, {}));
            expect(screen.getByRole('status')).toBeInTheDocument();
            expect(screen.getByLabelText('Loading performance dashboard')).toBeInTheDocument();
        });
    });
    describe('MetricCardSkeleton', () => {
        it('should render presentation role', () => {
            render(_jsx(MetricCardSkeleton, {}));
...
describe('DashboardEmptyState', () => {
    it('should render title and description', () => {
        render(_jsx(DashboardEmptyState, { title: "No data available", description: "Start tracking to see metrics" }));
        expect(screen.getByText('No data available')).toBeInTheDocument();
        expect(screen.getByText('Start tracking to see metrics')).toBeInTheDocument();
    });
    it('should render action button when provided', () => {
        const handleAction = vi.fn();
        render(_jsx(DashboardEmptyState, { title: "No data", description: "Get started", actionLabel: "Learn More", onAction: handleAction }));
    ...
    it('should not render button without both props', () => {
        render(_jsx(DashboardEmptyState, { title: "No data", description: "Get started", actionLabel: "Learn More" }));
        expect(screen.queryByRole('button')).not.toBeInTheDocument();
    });
    it('should render custom icon when provided', () => {
        render(_jsx(DashboardEmptyState, { title: "No data", description: "Get started", icon: _jsx("span", { "data-testid": "custom-icon", children: "\uD83D\uDCCA" }) }));
        expect(screen.getByTestId('custom-icon')).toBeInTheDocument();
    });
    it('should have accessible status role', () => {
        render(_jsx(DashboardEmptyState, { title: "No data", description: "Get started" }));
...
describe('PerformanceDashboard', () => {
    it('should render with default props', () => {
        render(_jsx(PerformanceDashboard, {}));
    ...
    it('should show detailed metrics when detailed prop is true', () => {
        render(_jsx(PerformanceDashboard, { detailed: true }));
        expect(screen.getByText(/Tip:/)).toBeInTheDocument();
    });
    it('should accept custom className', () => {
        const { container } = render(_jsx(PerformanceDashboard, { className: "custom-class" }));
        expect(container.firstChild).toHaveClass('custom-class');
    });
    it('should render loading state', () => {
        render(_jsx(PerformanceDashboard, { isLoading: true }));
        expect(screen.getByRole('status')).toHaveAttribute('aria-label', 'Loading Performance Dashboard');
        expect(screen.getByRole('status')).toHaveAttribute('aria-busy', 'true');
    });
    it('should render error state', () => {
        render(_jsx(PerformanceDashboard, { error: "Connection failed" }));
        expect(screen.getByRole('alert')).toBeInTheDocument();
...
describe('Keyboard Navigation and Focus Management', () => {
    describe('DashboardErrorBoundary', () => {
        it('should have focusable retry button', () => {
            ...
            render(_jsx(DashboardErrorBoundary, { widgetName: "Test", children: _jsx(ThrowingComponent, {}) }));
    ...
    describe('TokenOptimizationDashboard', () => {
        it('should have focusable breakdown items', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, showBreakdown: true }));
        ...
        it('should render loading state with proper aria attributes', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, isLoading: true }));
            const loadingContainer = screen.getByRole('status');
            expect(loadingContainer).toHaveAttribute('aria-busy', 'true');
            expect(loadingContainer).toHaveAttribute('aria-label', 'Loading Token Optimization Dashboard');
        });
        it('should render error state with alert role', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, error: new Error('API unavailable') }));
            expect(screen.getByRole('alert')).toBeInTheDocument();
    ...
    describe('AnalyticsDashboard', () => {
        it('should have accessible metric cards', () => {
            render(_jsx(AnalyticsDashboard, { title: "Sales Analytics", metrics: mockAnalyticsMetrics, previousMetrics: mockPreviousMetrics }));
            // Dashboard should have region role
            expect(screen.getByRole('region', { name: 'Sales Analytics' })).toBeInTheDocument();
        });
        it('should have accessible leaderboard items', () => {
            render(_jsx(AnalyticsDashboard, { title: "Sales Analytics", metrics: mockAnalyticsMetrics, leaderboard: mockLeaderboard }));
    ...
    describe('DashboardEmptyState', () => {
        it('should have focusable action button', () => {
            const handleAction = vi.fn();
            render(_jsx(DashboardEmptyState, { title: "No data", description: "Start tracking", actionLabel: "Get Started", onAction: handleAction }));
...
describe('Dashboard Accessibility', () => {
    describe('ARIA Landmarks', () => {
        it('TokenOptimizationDashboard should have proper landmarks', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics }));
            expect(screen.getByRole('region', { name: 'Token Optimization Dashboard' })).toBeInTheDocument();
        });
        it('PerformanceDashboard should have proper landmarks', () => {
            render(_jsx(PerformanceDashboard, {}));
            expect(screen.getByRole('region', { name: 'Performance Metrics Dashboard' })).toBeInTheDocument();
        });
    });
    ...
    describe('Screen Reader Text', () => {
        it('Loading states should have sr-only text', () => {
            render(_jsx(TokenOptimizationDashboard, { metrics: mockOptimizationMetrics, isLoading: true }));
            expect(screen.getByText('Loading token optimization data...')).toHaveClass('sr-only');
        });
