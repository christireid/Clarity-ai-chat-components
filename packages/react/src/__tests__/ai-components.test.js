...
describe('AI experience components', () => {
    ...
    it('renders evaluation dashboard metrics and sparklines', () => {
        render(_jsx(EvaluationDashboard, { metrics: [{ id: 'latency', label: 'Latency', value: '1.8s', trend: 'up', change: '+0.3s' }], sparklines: [{ id: 'cost', label: 'Cost per 1K tokens', percentage: 72 }] }));
    ...
    it('submits SSO configuration wizard', () => {
        ...
        render(_jsx(SSOConfigWizard, { steps: [{ id: '1', title: 'Download metadata', description: 'Copy ACS URL', status: 'complete' }], onSubmit: handleSubmit }));
