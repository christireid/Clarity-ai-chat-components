 ...
 * ```
 */
export function CodeHelperTemplate({ apiKeys, languages = ['javascript', 'typescript', 'python', 'react', 'sql'], }) {
...
Explain your reasoning and suggest improvements when relevant.`;
    return (_jsx(ThemeProvider, { defaultTheme: minimalDarkTheme, children: _jsx(AIAssistantTemplate, { apiKeys: apiKeys, systemPrompt: systemPrompt, defaultModel: "gpt-4-turbo-preview", enableFileUpload: true, enableContextManagement: true, maxTokens: 8192 }) }));
}
