...
const defaultSubtitle =
  'Present curated workflows that help users accomplish routine tasks with minimal prompting.'

export const WorkflowSuggestionList = React.memo(
  function WorkflowSuggestionList({
    workflows,
    onSelect,
    onPreview,
    className,
    ...
    return (
      <Card
        className={cn(
          'border-border/60 bg-[hsl(var(--surface-elevated))] shadow-2xl',
          className
        )}
      >
        ...
        <CardContent className="space-y-4">
          {workflows.length === 0 && (
            <div className="rounded-lg border border-dashed border-border/50 bg-muted p-6 text-center text-sm text-muted-foreground">
              No workflows available. Define templated flows to guide users
