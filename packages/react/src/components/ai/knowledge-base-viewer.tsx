        ...
        <div className="flex items-start justify-between">
          <div>
            <CardTitle className="flex items-center gap-2">
              Knowledge Base
              <Badge
                variant={knowledgeBase.autoGenerated ? 'default' : 'secondary'}
              >
                {knowledgeBase.autoGenerated
                  ? '🤖 Auto-generated'
                  : '✍️ Manual'}
              </Badge>
            </CardTitle>
            <CardDescription>
              {knowledgeBase.sections.length} sections • Version{' '}
              {knowledgeBase.version} • Updated{' '}
              {knowledgeBase.lastUpdated.toLocaleDateString()}
            </CardDescription>
          </div>
          {onExport && (
            <div className="flex gap-2">
