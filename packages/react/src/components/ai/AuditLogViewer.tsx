...
export const AuditLogViewer = React.memo(function AuditLogViewer({
  ...
  if (!logs.length) {
    return (
      <div
        className={cn(
          'rounded-lg border border-dashed border-muted-foreground/20 bg-card/50 p-6 text-center text-sm text-muted-foreground',
          className
        )}
      >
            ...
            return (
              <li
                ...
                className={cn(
                  ...
                  onEntryClick &&
                    'cursor-pointer hover:bg-muted/40 focus:bg-muted/40 focus:outline-none focus:ring-2 focus:ring-ring/40 focus:ring-inset'
                )}
                ...
                aria-label={
                  onEntryClick
                    ? `View details for ${entry.action} by ${entry.user}`
                    : undefined
                }
              >
