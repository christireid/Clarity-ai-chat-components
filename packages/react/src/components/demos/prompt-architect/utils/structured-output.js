 ...
 * ```
 */
export function parseStructuredOutput(rawResponse) {
 ...
 */
export function formatStructuredResponse(response) {
    const parts = [];
    // Thinking section
 ...
 */
export function isStructuredResponse(response) {
 ...
 */
export function validateResultType(result, expectedType) {
 ...
 */
export function createMockStructuredResponse(result, options) {
    const response = {
        result,
        ...options,
    };
 ...
 * @returns Formatted JSON string
 */
export function createErrorStructuredResponse(error) {
    const response = {
        result: null,
 ...
 */
export function updateStreamingState(state, chunk) {
 ...
 */
function tryPartialParse(buffer) {
    const partial = {};
