 ...
 */
export const CODE_REFACTORER_PRESET = {
    id: 'code-refactorer',
 ...
 */
export const CODE_REVIEWER_PRESET = {
    id: 'code-reviewer',
    name: 'Code Reviewer',
 ...
 */
export const EMAIL_WRITER_PRESET = {
    id: 'email-writer',
    name: 'Email Writer',
 ...
 */
export const CONTENT_SUMMARIZER_PRESET = {
 ...
 */
export const DATA_EXTRACTOR_PRESET = {
    id: 'data-extractor',
    name: 'Data Extractor',
 ...
 */
export const JSON_TRANSFORMER_PRESET = {
    id: 'json-transformer',
 ...
 */
export const BUG_ANALYZER_PRESET = {
    id: 'bug-analyzer',
    name: 'Bug Analyzer',
...
{{ reproduction_steps }}`,
  ...
  return data.user;
        ...
        reproduction_steps: 'Call fetchUserData("123") and try to access .name on the result',
    },
};
// =============================================================================
// ALL PRESETS
...
export function searchPresets(query) {
    ...
    return PROMPT_PRESETS.filter((p) => p.name.toLowerCase().includes(lowerQuery) ||
