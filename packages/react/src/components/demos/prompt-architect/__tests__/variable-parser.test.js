...
import { VARIABLE_REGEX, inferVariableType, formatDisplayName, extractVariables, extractVariablesFromMultiple, validateVariableName, containsVariableSyntax, getTemplateSegments, getVariablePositions, } from '../utils/variable-parser';
describe('variable-parser', () => {
    ...
    describe('extractVariables', () => {
        ...
        it('should include inferred types', () => {
            const result = extractVariables('{{ user_count }} {{ is_active }} {{ content }}');
    ...
    describe('extractVariablesFromMultiple', () => {
        ...
        it('should deduplicate warnings', () => {
            ...
            const shortWarnings = result.warnings.filter((w) => w.includes('very short'));
...
//# sourceMappingURL=variable-parser.test.js.map