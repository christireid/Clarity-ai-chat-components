...
const DefaultEnhancedFallback = React.memo(function DefaultEnhancedFallback({
  ...
  return (
    <div
      role="alert"
      className="flex min-h-[200px] flex-col items-center justify-center rounded-lg border border-destructive/20 bg-destructive/10 p-6 shadow-md"
    >
      ...
      <div className="flex gap-3">
        <button
          onClick={resetError}
          className="rounded-lg bg-destructive px-4 py-2 text-destructive-foreground transition-all duration-150 ease-out hover:opacity-90 hover:shadow-md hover:-translate-y-px focus:outline-none focus:ring-2 focus:ring-ring/50 focus:ring-offset-2"
        >
          Try Again
        </button>
        ...
        {enableFeedback && (
          <button
            ...
            className="rounded-lg border border-destructive bg-card px-4 py-2 text-destructive transition-all duration-150 ease-out hover:bg-destructive/10 hover:shadow-md hover:-translate-y-px focus:outline-none focus:ring-2 focus:ring-ring/50 focus:ring-offset-2"
          >
            Report Issue
          </button>
        )}
