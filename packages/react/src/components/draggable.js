...
export const Draggable = React.forwardRef(({ children, onDragStart, onDragEnd, onDrop, dragId, disabled = false, axis = 'both', showGhost = true, className, }, ref) => {
    ...
    return (_jsx(motion.div, { ref: ref, drag: !disabled, dragConstraints: dragConstraints, dragElastic: 0.1, dragMomentum: false, onDragStart: handleDragStart, onDragEnd: handleDragEnd, whileDrag: {
            ...
            stiffness: 300,
            damping: 20,
        }, className: cn('touch-none', !disabled && 'cursor-grab active:cursor-grabbing', isDragging && 'shadow-2xl', className), "data-drag-id": dragId, children: children }));
});
Draggable.displayName = 'Draggable';
export const DropZone = React.forwardRef(({ children, onDrop, dropId, className, activeClassName }, ref) => {
