    ...
    >
      ...
      {icon && (
        <motion.div
          ...
          className="inline-flex items-center justify-center w-20 h-20 rounded-lg bg-gradient-to-br from-primary/10 to-primary/5 shadow-xs ring-1 ring-primary/10"
        >
          {icon}
        </motion.div>
      )}
