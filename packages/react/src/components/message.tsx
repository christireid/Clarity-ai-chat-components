    ...
    return (
      <motion.div
        ...
        className={cn(
          ...
          isHovered && 'bg-muted/50 shadow-[0_2px_8px_rgba(15,23,42,0.08)]',
          className
        )}
      >
        {/* Avatar */}
        ...
        >
          ...
          <div
            className={cn(
              ...
              isUser &&
                'bg-primary text-primary-foreground px-4 py-3 rounded-xl inline-block shadow-[0_1px_3px_rgba(15,23,42,0.1)]'
            )}
          >
            {isUser ? (
