...
export const CommandPalette = React.forwardRef(({ items, open, onClose, placeholder = 'Type a command...', className }, ref) => {
    ...
    return (_jsx(AnimatePresence, { children: open && (_jsxs(_Fragment, { children: [_jsx(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, exit: { opacity: 0 }, transition: { duration: ANIMATION_DURATION.normal / 1000 }, onClick: onClose, className: "fixed inset-0 bg-black/60 backdrop-blur-md z-[var(--z-modal-backdrop)]" }), _jsxs(motion.div, { ref: ref, initial: { opacity: 0, scale: 0.95, y: -20 }, animate: { opacity: 1, scale: 1, y: 0 }, exit: { opacity: 0, scale: 0.95, y: -20 }, transition: {
                        ...
                        ease: ANIMATION_EASING.out,
                                            ...
                                            }) })] }, category))) })) }), _jsxs(motion.div, { initial: { opacity: 0 }, animate: { opacity: 1 }, transition: { delay: 0.2 }, className: "px-4 py-3 border-t text-xs text-muted-foreground flex items-center justify-between bg-muted/50", children: [_jsxs("div", { className: "flex gap-3 sm:gap-4", children: [_jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx("kbd", { className: "px-2 py-1 bg-background border rounded-md text-xs font-mono shadow-sm", children: "\u2191\u2193" }), _jsx("span", { className: "hidden sm:inline", children: "Navigate" })] }), _jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx("kbd", { className: "px-2 py-1 bg-background border rounded-md text-xs font-mono shadow-sm", children: "\u21B5" }), _jsx("span", { className: "hidden sm:inline", children: "Select" })] }), _jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx("kbd", { className: "px-2 py-1 bg-background border rounded-md text-xs font-mono shadow-sm", children: "Esc" }), _jsx("span", { className: "hidden sm:inline", children: "Close" })] })] }), _jsxs("div", { className: "font-medium", children: [filteredItems.length, " ", filteredItems.length === 1 ? 'command' : 'commands'] })] })] })] })) }));
});
