...
import { FileIcon, DownloadIcon, RefreshIcon, CheckIcon, CloseIcon, } from '../ui/icons';
 ...
 * - Cross-platform sync
 */
export function DocumentIntegration({ platforms = ['google-docs', 'notion', 'local'], initialDocuments = [], onDocumentSelect, onContentExtract, onExport, fetchDocument, listDocuments, showPlatformSelector = true, multiSelect = false, maxDocuments = 50, className, ref, ...props }) {
