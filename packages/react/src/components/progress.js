...
export const StreamingProgress = ({ label = 'Streaming', size = 'md', className, }) => {
    ...
    return (_jsxs("div", { className: cn('flex items-center gap-2.5', className), children: [label && (_jsx("span", { className: "text-sm text-muted-foreground/90", children: label })), _jsx("div", { className: cn('flex', sizeClasses[size]), children: [0, 1, 2].map((i) => (_jsx(motion.div, { className: cn('rounded-full bg-current', dotSizeClasses[size]), animate: {
                        opacity: [0.3, 1, 0.3],
                        scale: [0.8, 1, 0.8],
                    }, transition: {
                        duration: 1.5,
...
export const SkeletonProgress = ({ className }) => {
    return (_jsxs("div", { className: cn('space-y-2.5', className), children: [_jsxs("div", { className: "flex items-center justify-between", children: [_jsx("div", { className: "h-4 w-32 bg-muted/60 rounded animate-pulse" }), _jsx("div", { className: "h-4 w-12 bg-muted/60 rounded animate-pulse" })] }), _jsx(Progress, {})] }));
};
