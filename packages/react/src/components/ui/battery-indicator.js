...
import { useBatteryAware, } from '../../hooks/performance/use-battery-aware';
...
export function BatteryIndicator({ config, showTooltip = true, position = 'inline', showLabel = true, compact = false, className, }) {
    ...
    return (_jsxs("div", { className: "relative", children: [content, _jsx(AnimatePresence, { children: showDetails && (_jsx(motion.div, { initial: { opacity: 0, y: -10, scale: 0.95 }, animate: { opacity: 1, y: 0, scale: 1 }, exit: { opacity: 0, y: -10, scale: 0.95 }, transition: { duration: durations.normal }, className: cn('absolute z-50 min-w-[200px] rounded-lg border bg-popover p-3 shadow-lg', position.includes('right') ? 'right-0' : 'left-0', position.includes('top') ? 'top-full mt-2' : 'bottom-full mb-2'), children: _jsxs("div", { className: "space-y-2", children: [_jsx("div", { className: "text-sm font-semibold", children: batteryDescription }), batteryStatus.dischargingTime &&
