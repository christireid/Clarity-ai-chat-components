...
export const createResponsiveSkeleton = ({ baseSize, responsive = {}, containerQueries = true, fluid = false, aspectRatio, }) => {
    const sizes = {
 ...
 */
export const useOptimalAnimation = (preferredVariant) => {
 ...
 */
export const useResponsiveSize = (baseSize, responsive) => {
...
export const AdvancedSkeleton = ({ variant, size = 40, responsive, containerQueries = true, fluid = false, aspectRatio, enableMicroInteractions = true, enablePerformanceMonitoring = false, className, style, }) => {
  ...
  `
    ...
    return (_jsxs(_Fragment, { children: [_jsx("style", { children: `
        ...
        `)
                    .join('\n') || ''}
      ` }), _jsx("div", { ref: elementRef, className: cn('advanced-skeleton', className), style: style })] }));
};
//# sourceMappingURL=skeleton-advanced.js.map