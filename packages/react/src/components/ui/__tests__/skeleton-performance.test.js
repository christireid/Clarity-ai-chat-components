...
import { PerformanceSkeleton, EnhancedSkeleton, SkeletonTransition, SmartSkeleton, AdvancedSkeleton, } from '../skeleton-enhanced';
import { PerformanceMonitor, LoadingPredictor, } from '../skeleton-performance';
...
describe('Performance Monitoring System', () => {
    beforeEach(() => {
        jest.clearAllMocks();
        jest.useFakeTimers()(PerformanceMonitor).instance = null(LoadingPredictor).instance = null;
    });
    afterEach(() => {
        jest.useRealTimers();
    });
    describe('PerformanceMonitor', () => {
        ...
        it('starts and stops monitoring', () => {
            ...
            expect(mockPerformance.measure).toHaveBeenCalledWith('test-monitoring', 'test-monitoring-start', 'test-monitoring-end');
        ...
        it('provides performance warnings for slow operations', () => {
            ...
            expect(consoleSpy.warn).toHaveBeenCalledWith(expect.stringContaining('Performance monitoring took'));
        });
        ...
        it('handles duplicate monitor names', () => {
            ...
            expect(metrics).toBeDefined();
            expect(consoleSpy.warn).toHaveBeenCalledWith(expect.stringContaining('Duplicate performance monitor'));
        });
    ...
    describe('LoadingPredictor', () => {
        ...
        it('handles empty prediction history', () => {
            const predictor = LoadingPredictor.getInstance()(predictor).loadingHistory = [];
            const prediction = predictor.predictDuration();
        ...
        it('limits history size to prevent memory leaks', () => {
            ...
            expect(predictor.loadingHistory.length).toBeLessThanOrEqual(100);
        });
    ...
    describe('PerformanceSkeleton Component', () => {
        it('monitors component lifecycle', () => {
            ...
            const { unmount } = render(_jsx(PerformanceSkeleton, { performanceId: "component-test", onPerformanceReport: onReport, enableDetailedMetrics: true, children: _jsx("div", { children: "Test content" }) }));
        ...
        it('provides detailed performance metrics', () => {
            ...
            const { unmount } = render(_jsx(PerformanceSkeleton, { performanceId: "detailed-test", onPerformanceReport: onReport, enableDetailedMetrics: true, children: _jsx("div", { children: "Test content" }) }));
            unmount();
        ...
        it('handles performance monitoring errors gracefully', () => {
            ...
            const { unmount } = render(_jsx(PerformanceSkeleton, { performanceId: "error-test", onPerformanceReport: onReport, children: _jsx("div", { children: "Test content" }) }));
    ...
    describe('EnhancedSkeleton Performance', () => {
        it('monitors individual skeleton performance', () => {
            render(_jsx(EnhancedSkeleton, { performanceId: "skeleton-perf", variant: "shimmer" }));
        ...
        it('logs performance warnings for slow renders', () => {
            ...
            render(_jsx(EnhancedSkeleton, { performanceId: "slow-skeleton", variant: "shimmer" }));
            expect(consoleSpy.warn).toHaveBeenCalledWith(expect.stringContaining('EnhancedSkeleton render took'));
        });
    });
    describe('AdvancedSkeleton Performance', () => {
        it('monitors advanced skeleton performance', () => {
            render(_jsx(AdvancedSkeleton, { variant: "shimmerRainbow", enablePerformanceMonitoring: true }));
            expect(consoleSpy.warn).toHaveBeenCalledWith(expect.stringContaining('AdvancedSkeleton render took'));
        });
        it('optimizes for device capabilities', () => {
            ...
            const { container } = render(_jsx(AdvancedSkeleton, { variant: "shimmerRainbow", enablePerformanceMonitoring: true }));
    ...
    describe('SkeletonTransition Performance', () => {
        it('monitors transition performance', async () => {
            const TestComponent = () => {
                ...
                return (_jsx(SkeletonTransition, { isLoading: isLoading, skeleton: _jsx("div", { children: "Skeleton" }), monitorPerformance: true, enablePrediction: true, duration: 300, children: _jsx("div", { "data-testid": "transition-content", children: "Content" }) }));
            };
        ...
        it('predicts optimal transition timing', async () => {
            const TestComponent = () => {
                ...
                return (_jsx(SkeletonTransition, { isLoading: isLoading, skeleton: _jsx("div", { children: "Skeleton" }), enablePrediction: true, duration: 400, children: _jsx("div", { children: "Predicted content" }) }));
            };
            render(_jsx(TestComponent, {}));
            act(() => {
    ...
    describe('SmartSkeleton Performance', () => {
        it('provides intelligent loading predictions', () => {
            ...
            const TestComponent = () => {
                ...
                return (_jsx(SmartSkeleton, { isLoading: isLoading, predictionMode: "adaptive", onPredictionUpdate: onUpdate, enableLearning: true, children: _jsx("div", { children: "Smart content" }) }));
            };
            render(_jsx(TestComponent, {}));
    ...
    describe('Performance Optimization', () => {
        it('throttles performance updates', () => {
            ...
            const TestComponent = () => {
                ...
                return (_jsx(PerformanceSkeleton, { performanceId: "throttle-test", onPerformanceReport: onReport, children: _jsxs("div", { children: ["Render count: ", renderCount] }) }));
            };
            render(_jsx(TestComponent, {}));
            act(() => {
    ...
    describe('Edge Cases and Error Handling', () => {
        it('handles missing performance API gracefully', () => {
            ...
            delete global.performance;
            const TestComponent = () => {
                return (_jsx(PerformanceSkeleton, { performanceId: "no-api-test", children: _jsx("div", { children: "Content" }) }));
            };
            expect(() => render(_jsx(TestComponent, {}))).not.toThrow();
            global.performance = originalPerformance;
        });
    ...
    describe('Memory Leak Prevention', () => {
        it('cleans up performance monitoring resources', () => {
            ...
            expect(monitor.activeMonitors.size).toBe(0);
            expect(monitor.completedMonitors.length).toBeLessThanOrEqual(100);
        });
        it('prevents memory leaks in long-running components', () => {
            const TestComponent = () => {
                ...
                return (_jsx(PerformanceSkeleton, { performanceId: "long-running-test", children: _jsxs("div", { children: ["Counter: ", counter] }) }));
            };
...
//# sourceMappingURL=skeleton-performance.test.js.map