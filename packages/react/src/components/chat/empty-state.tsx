    ...
    >
      ...
      <div className="relative inline-flex items-center justify-center">
        ...
        {prefersReducedMotion ? (
          <div className="absolute w-32 h-32 rounded-full border border-primary/10" style={{ opacity: 0.5 }} />
        ) : (
          <motion.div
        ...
        {prefersReducedMotion ? (
          <div className="absolute w-28 h-28 rounded-full border border-primary/20" style={{ opacity: 0.6 }} />
        ) : (
          <motion.div
