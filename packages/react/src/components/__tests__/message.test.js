...
describe('Message Component', () => {
    ...
    describe('Rendering', () => {
        it('should render user message correctly', () => {
            renderWithProviders(_jsx(Message, { message: mockMessage }));
            expect(screen.getByText('Hello, world!')).toBeInTheDocument();
            expect(screen.getByText('You')).toBeInTheDocument();
        });
        it('should render assistant message correctly', () => {
            renderWithProviders(_jsx(Message, { message: mockAssistantMessage }));
            expect(screen.getByText('Hello! How can I help you today?')).toBeInTheDocument();
            expect(screen.getByText('AI Assistant')).toBeInTheDocument();
        });
        it('should render without avatar when showAvatar is false', () => {
            const { container } = renderWithProviders(_jsx(Message, { message: mockMessage, showAvatar: false }));
        ...
        it('should render without timestamp when showTimestamp is false', () => {
            const { container } = renderWithProviders(_jsx(Message, { message: mockMessage, showTimestamp: false }));
    ...
    describe('Status Badges', () => {
        it('should show "Sending" badge for sending status', () => {
            const sendingMessage = { ...mockMessage, status: 'sending' };
            renderWithProviders(_jsx(Message, { message: sendingMessage }));
            expect(screen.getByText('Sending')).toBeInTheDocument();
        });
        it('should show "Error" badge for error status', () => {
            const errorMessage = { ...mockMessage, status: 'error' };
            renderWithProviders(_jsx(Message, { message: errorMessage }));
    ...
    describe('Streaming Animation', () => {
        it('should render assistant message with streaming status', () => {
            ...
            renderWithProviders(_jsx(Message, { message: streamingMessage }));
    ...
    describe('Attachments', () => {
        it('should render attachments', () => {
            ...
            renderWithProviders(_jsx(Message, { message: messageWithAttachments }));
    ...
    describe('Markdown Rendering', () => {
        it('should render markdown in assistant messages', () => {
            ...
            const { container } = renderWithProviders(_jsx(Message, { message: markdownMessage }));
        ...
        it('should render code blocks', () => {
            ...
            const { container } = renderWithProviders(_jsx(Message, { message: codeMessage }));
        ...
        it('should render inline code', () => {
            ...
            const { container } = renderWithProviders(_jsx(Message, { message: inlineCodeMessage }));
    ...
    describe('Feedback Actions', () => {
        it('should call onFeedback with "up" when thumbs up is clicked', async () => {
            ...
            const { container } = renderWithProviders(_jsx(Message, { message: mockAssistantMessage, onFeedback: onFeedback }));
        ...
        it('should show feedback actions for all messages (including user messages)', () => {
            const onFeedback = vi.fn();
            const { container } = renderWithProviders(_jsx(Message, { message: mockMessage, onFeedback: onFeedback }));
            // Hover to reveal actions
            const messageDiv = container.querySelector('.group');
            if (messageDiv) {
                fireEvent.mouseEnter(messageDiv);
    ...
    describe('Retry Action', () => {
        it('should show retry button for error messages', async () => {
            const onRetry = vi.fn();
            const errorMessage = { ...mockAssistantMessage, status: 'error' };
            const { container } = renderWithProviders(_jsx(Message, { message: errorMessage, onRetry: onRetry }));
            // Hover to reveal actions
            const messageDiv = container.querySelector('.group');
            if (messageDiv) {
                fireEvent.mouseEnter(messageDiv);
    ...
    describe('Metadata Display', () => {
        it('should display token count when provided', () => {
            ...
            renderWithProviders(_jsx(Message, { message: messageWithMetadata }));
    ...
    describe('Accessibility', () => {
        it('should have accessible structure', () => {
            const { container } = renderWithProviders(_jsx(Message, { message: mockMessage }));
    ...
    describe('Custom className', () => {
        it('should apply custom className', () => {
            const { container } = renderWithProviders(_jsx(Message, { message: mockMessage, className: "custom-class" }));
    ...
    describe('Edge Cases', () => {
        it('should handle empty content gracefully', () => {
            ...
            renderWithProviders(_jsx(Message, { message: emptyMessage }));
            expect(screen.getByText('You')).toBeInTheDocument();
        });
        it('should handle very long content', () => {
            const longContent = 'A'.repeat(10000);
            const longMessage = { ...mockMessage, content: longContent };
            renderWithProviders(_jsx(Message, { message: longMessage }));
        ...
        it('should handle special characters in content', () => {
            ...
            const { container } = renderWithProviders(_jsx(Message, { message: specialMessage }));
        ...
        it('should handle undefined optional props', () => {
            const messageWithFeedback = {
                ...mockAssistantMessage,
                feedback: { type: 'up', timestamp: new Date() },
            };
            expect(() => renderWithProviders(_jsx(Message, { message: messageWithFeedback }))).not.toThrow();
        });
    });
});
