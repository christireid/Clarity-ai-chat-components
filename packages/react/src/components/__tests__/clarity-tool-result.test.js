...
describe('ClarityToolResult', () => {
    ...
    it('should render registered tool component', () => {
        ...
        const { container } = render(React.createElement(ClarityToolResult, {
            registry,
            toolCall,
            result,
            messages: mockMessages,
        }));
        expect(TestComponent).toHaveBeenCalledWith(expect.objectContaining({
            data: result,
            messages: mockMessages,
            toolCall: {
                name: 'test_tool',
    ...
    it('should render custom fallback component', () => {
        ...
        render(React.createElement(ClarityToolResult, {
            registry,
            toolCall,
            result: { data: 'test' },
            messages: mockMessages,
...
//# sourceMappingURL=clarity-tool-result.test.js.map