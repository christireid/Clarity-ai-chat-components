...
describe('ChatWindow - Enhanced Tests', () => {
    ...
    describe('Rendering', () => {
        it('renders all messages correctly', () => {
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps }) }));
            expect(screen.getByText('Hello! How can I help you?')).toBeInTheDocument();
            expect(screen.getByText('I need help with React')).toBeInTheDocument();
            expect(screen.getByText('I can help with React! What specifically do you need?')).toBeInTheDocument();
        });
        it('renders with custom placeholder', () => {
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, placeholder: "Type your question..." }) }));
            expect(screen.getByPlaceholderText('Type your question...')).toBeInTheDocument();
        });
        it('renders loading state', () => {
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, isLoading: true }) }));
            expect(screen.getByTestId('thinking-indicator')).toBeInTheDocument();
        });
        it('renders empty state when no messages', () => {
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, messages: [] }) }));
    ...
    describe('User Interactions', () => {
        it('sends message on submit', async () => {
            ...
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, onSendMessage: onSendMessage }) }));
        ...
        it('disables input when loading', async () => {
            const user = userEvent.setup();
            const onSendMessage = vi.fn();
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, isLoading: true, onSendMessage: onSendMessage }) }));
            const input = screen.getByPlaceholderText(/type a message/i);
    ...
    describe('Message Operations', () => {
        ...
        it('allows editing user messages', async () => {
            ...
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, onEditMessage: onEditMessage }) }));
        ...
        it('allows regenerating AI messages', async () => {
            ...
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, onRegenerateMessage: onRegenerateMessage }) }));
            const aiMessage = screen.getByText('I can help with React! What specifically do you need?');
            const regenerateButton = within(aiMessage.closest('div')).getByLabelText(/regenerate/i);
    ...
    describe('Accessibility', () => {
        ...
        it('announces new messages to screen readers', async () => {
            const { rerender } = render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps }) }));
            const newMessages = [
                ...mockMessages,
                {
                    id: '4',
            ...
            rerender(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, messages: newMessages }) }));
        ...
        it('has proper heading hierarchy', () => {
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, title: "Customer Support" }) }));
    ...
    describe('Theming', () => {
        it('applies theme correctly', () => {
            render(_jsx(ThemeProvider, { theme: themes.ocean, children: _jsx(ChatWindow, { ...defaultProps }) }));
        ...
        it('switches themes dynamically', () => {
            ...
            rerender(_jsx(ThemeProvider, { theme: themes.dark, children: _jsx(ChatWindow, { ...defaultProps }) }));
    ...
    describe('Performance', () => {
        it('renders large message lists efficiently', () => {
            ...
            const { container } = render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, messages: manyMessages }) }));
        ...
        it('memoizes messages to prevent unnecessary re-renders', () => {
            ...
            rerender(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps }) }));
    ...
    describe('File Attachments', () => {
        it('supports file uploads', async () => {
            const user = userEvent.setup();
            const onSendMessage = vi.fn();
            render(_jsx(ThemeProvider, { theme: themes.default, children: _jsx(ChatWindow, { ...defaultProps, onSendMessage: onSendMessage, enableFileUpload: true }) }));
            ...
            expect(onSendMessage).toHaveBeenCalledWith(expect.any(String), expect.objectContaining({
                attachments: [expect.objectContaining({ name: 'hello.txt' })],
            }));
        });
    });
});
//# sourceMappingURL=chat-window.test.enhanced.js.map