...
describe('ChatWindow - Enhanced Tests', () => {
    ...
    describe('Rendering', () => {
        it('renders all messages correctly', () => {
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps }) }));
        ...
        it('renders loading state', () => {
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, isLoading: true }) }));
            expect(screen.getByTestId('thinking-indicator')).toBeInTheDocument();
        });
        it('renders empty state when no messages', () => {
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, messages: [] }) }));
    ...
    describe('User Interactions', () => {
        it('sends message on submit', async () => {
            ...
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, onSendMessage: onSendMessage }) }));
        ...
        it('disables input when loading', async () => {
            const user = userEvent.setup();
            const onSendMessage = vi.fn();
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, isLoading: true, onSendMessage: onSendMessage }) }));
            const input = screen.getByPlaceholderText(/type a message/i);
    ...
    describe('Accessibility', () => {
        ...
        it('announces new messages to screen readers', async () => {
            const { rerender } = render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps }) }));
            const newMessages = [
                ...mockMessages,
                {
                    id: '4',
            ...
            rerender(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, messages: newMessages }) }));
        ...
        it('has proper heading hierarchy', () => {
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, sessionTitle: "Customer Support" }) }));
    ...
    describe('Theming', () => {
        it('applies theme correctly', () => {
            render(_jsx(ThemeProvider, { defaultTheme: { preset: 'ocean' }, children: _jsx(ChatWindow, { ...defaultProps }) }));
        ...
        it('switches themes dynamically', () => {
            ...
            rerender(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-dark' }, children: _jsx(ChatWindow, { ...defaultProps }) }));
    ...
    describe('Performance', () => {
        it('renders large message lists efficiently', () => {
            ...
            const { container } = render(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps, messages: manyMessages }) }));
        ...
        it('memoizes messages to prevent unnecessary re-renders', () => {
            ...
            rerender(_jsx(ThemeProvider, { defaultTheme: { preset: 'default-light' }, children: _jsx(ChatWindow, { ...defaultProps }) }));
