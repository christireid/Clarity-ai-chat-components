...
describe('ThemePreviewThumbnail', () => {
  describe('basic rendering', () => {
    it('should render with default preset', () => {
      render(<ThemePreviewThumbnail />)

      expect(screen.getByLabelText(/Theme preview/)).toBeInTheDocument()
    })

    it('should render with specified preset', () => {
      render(<ThemePreviewThumbnail preset="neutral-dark" />)

      expect(
        screen.getByLabelText(/Theme preview: Neutral Dark/)
      ).toBeInTheDocument()
    })
    ...
    it('should render with custom theme', () => {
      ...
      render(<ThemePreviewThumbnail theme={customTheme} />)

      expect(
        screen.getByLabelText(/Theme preview: My Custom Theme/)
      ).toBeInTheDocument()
    })

    it('should show label by default', () => {
      render(<ThemePreviewThumbnail preset="vibrant" />)

      expect(screen.getByText('Vibrant')).toBeInTheDocument()
    })

    it('should hide label when showLabel is false', () => {
      render(<ThemePreviewThumbnail preset="vibrant" showLabel={false} />)
  ...
  describe('size variations', () => {
    it('should render small size', () => {
      const { container } = render(<ThemePreviewThumbnail size="sm" />)
    ...
    it('should render medium size (default)', () => {
      const { container } = render(<ThemePreviewThumbnail />)
    ...
    it('should render large size', () => {
      const { container } = render(<ThemePreviewThumbnail size="lg" />)
  ...
  describe('selection state', () => {
    ...
    it('should have aria-pressed false when clickable but not selected', () => {
      render(<ThemePreviewThumbnail preset="default" onClick={() => {}} />)
  ...
  describe('click handling', () => {
    it('should call onClick when clicked', async () => {
      ...
      render(<ThemePreviewThumbnail preset="default" onClick={handleClick} />)
  ...
  describe('className prop', () => {
    it('should apply custom className', () => {
      const { container } = render(
        <ThemePreviewThumbnail preset="default" className="custom-class" />
      )
  ...
  describe('display name formatting', () => {
    it('should format preset name correctly', () => {
      render(<ThemePreviewThumbnail preset="high-contrast-dark" />)
...
describe('ThemePreviewGrid', () => {
  ...
  describe('filtering', () => {
    it('should filter to light themes only', () => {
      render(<ThemePreviewGrid filter="light" />)
    ...
    it('should filter to dark themes only', () => {
      render(<ThemePreviewGrid filter="dark" />)
    ...
    it('should show all themes when filter is "all"', () => {
      render(<ThemePreviewGrid filter="all" />)

      // Should have all 8 themes
      const labels = screen.getAllByText(
        /Default|Neutral|Vibrant|High Contrast/
      )
  ...
  describe('selection', () => {
    it('should indicate selected preset', () => {
      render(<ThemePreviewGrid selectedPreset="neutral" onSelect={() => {}} />)

      expect(
        screen.getByLabelText(/Theme preview: Neutral \(selected\)/)
      ).toBeInTheDocument()
    })

    it('should call onSelect when a theme is clicked', async () => {
      const handleSelect = vi.fn()
      render(<ThemePreviewGrid onSelect={handleSelect} />)

      await userEvent.click(
        screen.getByLabelText(/Theme preview: Vibrant Dark/)
      )
  ...
  describe('className prop', () => {
    it('should apply custom className', () => {
      const { container } = render(<ThemePreviewGrid className="custom-grid" />)
