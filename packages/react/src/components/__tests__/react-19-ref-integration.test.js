...
describe('React 19 Ref Integration Tests', () => {
    describe('KeyboardHint', () => {
        ...
        it('should forward object ref to root element when visible', () => {
            ...
            render(_jsx(KeyboardHint, { shortcuts: shortcuts, visible: true, ref: ref }));
            expect(ref.current).toBeInstanceOf(HTMLDivElement);
            expect(ref.current).toBeInTheDocument();
        });
        it('should call callback ref with DOM element when visible', () => {
            const callbackRef = vi.fn();
            render(_jsx(KeyboardHint, { shortcuts: shortcuts, visible: true, ref: callbackRef }));
        ...
        it('should work with useRef pattern', () => {
            function TestComponent() {
                ...
                return (_jsxs(_Fragment, { children: [_jsx(KeyboardHint, { shortcuts: shortcuts, visible: true, ref: ref }), mounted && _jsx("div", { "data-testid": "mounted", children: "Ref worked!" })] }));
            }
        ...
        it('should not call ref when not visible (AnimatePresence)', () => {
            const ref = React.createRef();
            render(_jsx(KeyboardHint, { shortcuts: shortcuts, visible: false, ref: ref }));
    ...
    describe('ThemeSwitcher', () => {
        it('should forward object ref to root element', () => {
            const ref = React.createRef();
            render(_jsx(ThemeSwitcher, { currentTheme: "light", onThemeChange: vi.fn(), ref: ref }));
            expect(ref.current).toBeInstanceOf(HTMLDivElement);
        });
        it('should call callback ref with DOM element', () => {
            const callbackRef = vi.fn();
            render(_jsx(ThemeSwitcher, { currentTheme: "dark", onThemeChange: vi.fn(), ref: callbackRef }));
            expect(callbackRef).toHaveBeenCalledWith(expect.any(HTMLDivElement));
        });
    });
    describe('DashboardProgress', () => {
        it('should forward object ref to root element', () => {
            const ref = React.createRef();
            render(_jsx(DashboardProgress, { value: 50, max: 100, label: "Progress", ref: ref }));
            expect(ref.current).toBeInstanceOf(HTMLDivElement);
        });
        it('should call callback ref with DOM element', () => {
            const callbackRef = vi.fn();
            render(_jsx(DashboardProgress, { value: 75, max: 100, label: "Loading", ref: callbackRef }));
            expect(callbackRef).toHaveBeenCalledWith(expect.any(HTMLDivElement));
        });
    });
    describe('InteractiveCard', () => {
        it('should forward object ref to root element', () => {
            const ref = React.createRef();
            render(_jsx(InteractiveCard, { ref: ref, children: _jsx("div", { children: "Card content" }) }));
            expect(ref.current).toBeInstanceOf(HTMLDivElement);
        });
        it('should call callback ref with DOM element', () => {
            const callbackRef = vi.fn();
            render(_jsx(InteractiveCard, { ref: callbackRef, children: _jsx("div", { children: "Card content" }) }));
            expect(callbackRef).toHaveBeenCalledWith(expect.any(HTMLDivElement));
        });
    });
    describe('InteractiveButton', () => {
        it('should forward object ref to button element', () => {
            const ref = React.createRef();
            render(_jsx(InteractiveButton, { onClick: vi.fn(), ref: ref, children: "Click me" }));
            expect(ref.current).toBeInstanceOf(HTMLButtonElement);
        });
        it('should call callback ref with button element', () => {
            const callbackRef = vi.fn();
            render(_jsx(InteractiveButton, { onClick: vi.fn(), ref: callbackRef, children: "Click me" }));
    ...
    describe('AdvancedChatInput with useMergedRef', () => {
        it('should forward ref to textarea while maintaining internal ref functionality', async () => {
            ...
            render(_jsx(AdvancedChatInput, { value: "", onChange: vi.fn(), onSubmit: vi.fn(), ref: externalRef }));
        ...
        it('should work with callback ref pattern', () => {
            const callbackRef = vi.fn();
            render(_jsx(AdvancedChatInput, { value: "", onChange: vi.fn(), onSubmit: vi.fn(), ref: callbackRef }));
        ...
        it('should allow parent to imperatively focus the textarea', () => {
            function ParentComponent() {
                ...
                return (_jsxs(_Fragment, { children: [_jsx("button", { onClick: () => inputRef.current?.focus(), children: "Focus Input" }), _jsx(AdvancedChatInput, { value: "", onChange: vi.fn(), onSubmit: vi.fn(), ref: inputRef })] }));
            }
            render(_jsx(ParentComponent, {}));
    ...
    describe('Ref cleanup on unmount', () => {
        it('should handle unmount gracefully for DashboardProgress', () => {
            const ref = React.createRef();
            const { unmount } = render(_jsx(DashboardProgress, { value: 50, max: 100, label: "Test", ref: ref }));
            expect(ref.current).toBeInstanceOf(HTMLDivElement);
        ...
        it('should call callback ref on mount and handle unmount', () => {
            const callbackRef = vi.fn();
            const { unmount } = render(_jsx(InteractiveCard, { ref: callbackRef, children: _jsx("div", { children: "Content" }) }));
    ...
    describe('Ref stability across re-renders', () => {
        it('should maintain ref across prop changes', () => {
            const ref = React.createRef();
            const { rerender } = render(_jsx(DashboardProgress, { value: 25, max: 100, label: "Loading", ref: ref }));
            const initialElement = ref.current;
            expect(initialElement).toBeInstanceOf(HTMLDivElement);
            // Re-render with different props
            rerender(_jsx(DashboardProgress, { value: 75, max: 100, label: "Almost done", ref: ref }));
    ...
    describe('Wrapper component pattern (React 19 migration)', () => {
        ...
        it('should work with wrapper components using ref-as-prop', () => {
            function CustomProgressWrapper({ label, ref }) {
                return (_jsx("div", { "data-testid": "wrapper", children: _jsx(DashboardProgress, { value: 50, max: 100, label: label, ref: ref }) }));
            }
            const ref = React.createRef();
            render(_jsx(CustomProgressWrapper, { label: "Test", ref: ref }));
...
//# sourceMappingURL=react-19-ref-integration.test.js.map