...
describe('ChatWindow Component', () => {
    ...
    describe('Loading State', () => {
        ...
        it('should hide thinking indicator when not loading', () => {
            render(_jsx(ChatWindow, { messages: mockMessages, isLoading: false, onSendMessage: mockOnSendMessage }));
            expect(screen.queryByText(/thinking|processing/i)).not.toBeInTheDocument();
        });
        it('should toggle thinking indicator correctly', () => {
            const { rerender } = render(_jsx(ChatWindow, { messages: mockMessages, isLoading: false, onSendMessage: mockOnSendMessage }));
            expect(screen.queryByText(/thinking|processing/i)).not.toBeInTheDocument();
            rerender(_jsx(ChatWindow, { messages: mockMessages, isLoading: true, onSendMessage: mockOnSendMessage }));
            expect(screen.getByText(/thinking|processing/i)).toBeInTheDocument();
        });
    });
