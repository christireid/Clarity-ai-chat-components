...
const StreamingCursor = React.memo(function StreamingCursor() {
    return (_jsx(motion.span, { animate: { opacity: [1, 0.3, 1] }, transition: {
            // Framer Motion 12: Smoother pulse using spring
            type: 'spring',
            damping: 15,
            stiffness: 100,
            repeat: Infinity,
        }, className: "inline-block ml-1", "aria-hidden": "true", children: "\u258B" }));
});
StreamingCursor.displayName = 'StreamingCursor';
/**
 * Error display component with optional retry button
 */
const ErrorDisplay = React.memo(function ErrorDisplay({ error, onRetry, }) {
    return (_jsx(motion.div, { initial: { opacity: 0, scale: 0.95 }, animate: { opacity: 1, scale: 1 }, transition: {
            // Framer Motion 12: Spring entrance for errors
            type: 'spring',
            damping: 20,
            stiffness: 300,
        }, className: "bg-destructive/5 border border-destructive/20 rounded-lg p-4 shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)]", role: "alert", children: _jsxs("div", { className: "flex items-start gap-3", children: [_jsx("svg", { className: "w-5 h-5 text-destructive flex-shrink-0 mt-0.5", fill: "currentColor", viewBox: "0 0 20 20", "aria-hidden": "true", children: _jsx("path", { fillRule: "evenodd", d: "M10 18a8 8 0 100-16 8 8 0 000 16zM8.707 7.293a1 1 0 00-1.414 1.414L8.586 10l-1.293 1.293a1 1 0 101.414 1.414L10 11.414l1.293 1.293a1 1 0 001.414-1.414L11.414 10l1.293-1.293a1 1 0 00-1.414-1.414L10 8.586 8.707 7.293z", clipRule: "evenodd" }) }), _jsxs("div", { className: "flex-1", children: [_jsx("h4", { className: "font-semibold text-foreground", children: "Error" }), _jsx("p", { className: "mt-1 text-sm text-muted-foreground", children: error }), onRetry && (_jsxs(Button, { variant: "outline", size: "sm", onClick: onRetry, className: "mt-3", "aria-label": "Retry failed request", children: [_jsx("svg", { className: "w-4 h-4 mr-2", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", "aria-hidden": "true", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M4 4v5h.582m15.356 2A8.001 8.001 0 004.582 9m0 0H9m11 11v-5h-.581m0 0a8.003 8.003 0 01-15.357-2m15.357 2H15" }) }), "Try again"] }))] })] }) }));
});
 ...
 */
function useSmoothStreaming(content, isStreaming, enabled, speed = 'normal') {
...
export function StreamingMessage({ content, isStreaming = false, toolCalls = [], citations = [], thinkingSteps = [], currentThinkingStep, error, showThinking = true, showCitations = true, showTools = true, onToolApprove, onToolReject, onRetry, className = '', smoothStreaming = false, streamingSpeed = 'normal', }) {
    const [isVisible, setIsVisible] = React.useState(false);
    // Use smooth streaming hook for polished text rendering
    const displayedContent = useSmoothStreaming(content, isStreaming, smoothStreaming, streamingSpeed);
