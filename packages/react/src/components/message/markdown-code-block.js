...
async function loadPrism() {
    ...
    prismLoadPromise = (async () => {
        try {
            ...
            logger.warn('Prism.js not available, syntax highlighting disabled:', error);
...
export const MarkdownCodeBlock = React.memo(({ inline, className, children, ...rest }) => {
    ...
    return (_jsx("code", { className: cn('block font-mono code-metrics', className), 
        ...
        }, "data-code-string": codeString, ...rest }));
});
