 ...
 * ```
 */
export function ConversationAnalyticsDashboard({ messages, analytics: externalAnalytics, onGenerateAnalytics, autoGenerate = false, updateInterval = 30000, onAnalyticsGenerated, detailed = false, className, isLoading: externalLoading = false, externalError = null, }) {
    ...
    const generateAnalyticsFallback = React.useCallback((msgs) => {
        return {
            ...
            metadata: {
                ...
                averageMessageLength: msgs.reduce((sum, m) => sum + m.content.length, 0) / msgs.length ||
                    0,
            },
        };
    }, []);
    ...
    return (_jsxs("div", { className: cn('space-y-4', className), role: "region", "aria-label": "Conversation Analytics Dashboard", children: [_jsx(Card, { className: "shadow-sm", children: _jsx(CardHeader, { children: _jsxs("div", { className: "flex items-center justify-between", children: [_jsxs("div", { className: "flex items-center gap-3", children: [_jsx("div", { className: "flex h-10 w-10 items-center justify-center rounded-lg bg-primary/10 text-primary", children: _jsx("svg", { className: "h-5 w-5", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24", children: _jsx("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" }) }) }), _jsxs("div", { children: [_jsx(CardTitle, { className: "text-base", children: "Conversation Analytics" }), _jsxs(CardDescription, { className: "text-xs", children: ["AI-powered insights from ", messages.length, " messages"] })] })] }), _jsx(Button, { onClick: generateAnalytics, disabled: isGenerating, size: "sm", variant: "outline", children: isGenerating ? 'Analyzing...' : 'Refresh' })] }) }) }), displayError && (_jsx(Card, { className: "shadow-sm border-destructive", children: _jsx(CardContent, { className: "p-4 text-sm text-destructive", children: displayError }) })), isLoading && !analytics ? (_jsx(Card, { className: "shadow-sm", children: _jsxs(CardContent, { className: "p-8 text-center", children: [_jsx(motion.div, { className: "inline-block h-8 w-8 rounded-full border-2 border-primary border-t-transparent", animate: { rotate: 360 }, transition: {
                                duration: durations.slower,
                                repeat: Infinity,
                                ease: 'linear',
                            } }), _jsx("div", { className: "mt-3 text-sm text-muted-foreground", children: "Analyzing conversation..." })] }) })) : analytics ? (_jsx(AnimatePresence, { mode: "wait", children: _jsxs(motion.div, { initial: { opacity: 0, y: 20 }, animate: { opacity: 1, y: 0 }, className: "space-y-4", children: [_jsxs(Card, { className: "shadow-sm", children: [_jsx(CardHeader, { children: _jsx(CardTitle, { className: "text-sm", children: "Conversation Quality" }) }), _jsx(CardContent, { children: _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: "text-4xl font-bold", "aria-hidden": "true", children: Math.round(analytics.quality.score) }), _jsxs("div", { className: "flex-1", children: [_jsx("div", { className: "h-2 w-full rounded-full bg-muted overflow-hidden", role: "progressbar", "aria-label": "Conversation quality score", "aria-valuenow": Math.round(analytics.quality.score), "aria-valuemin": 0, "aria-valuemax": 100, "aria-valuetext": `Quality score: ${Math.round(analytics.quality.score)} out of 100`, children: _jsx(motion.div, { className: "h-full bg-primary", initial: { width: 0 }, animate: { width: `${analytics.quality.score}%` }, transition: {
                                                                duration: durations.slower,
                                                                ease: 'easeOut',
