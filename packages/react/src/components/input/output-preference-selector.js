...
import { getPreferenceConfig, calculateDynamicOutputLimit, } from '../../utils/optimization/dynamic-output-limit';
/**
...
export function UncontrolledOutputPreferenceSelector({ defaultValue = 'balanced', onValueChange, modelCapacity = 128000, inputTokens = 0, taskType = 'chat', ref, ...props }) {
