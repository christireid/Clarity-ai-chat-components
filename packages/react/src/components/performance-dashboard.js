...
export function PerformanceBadge({ className }) {
    ...
    return (_jsxs("div", { className: `performance-badge inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-medium border shadow-sm transition-all duration-200 hover:shadow-md ${status === 'good'
