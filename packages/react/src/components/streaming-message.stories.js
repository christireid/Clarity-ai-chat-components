...
export const ThinkingInProgress = {
    args: {
        content: '',
        isStreaming: true,
...
export const InteractiveStreaming = {
    render: () => {
        ...
        return (_jsxs("div", { className: "space-y-4", children: [_jsx("button", { onClick: startStreaming, className: "px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-all duration-200 shadow-[0_1px_3px_rgba(15,23,42,0.1)] hover:shadow-[0_4px_12px_rgba(15,23,42,0.15)]", children: "Start Streaming Demo" }), _jsx(StreamingMessage, { content: content, isStreaming: isStreaming })] }));
    },
    parameters: {
        docs: {
            description: {
...
//# sourceMappingURL=streaming-message.stories.js.map