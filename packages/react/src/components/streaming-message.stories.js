...
export const InteractiveStreaming = {
    render: () => {
        ...
        return (_jsxs("div", { className: "space-y-4", children: [_jsx("button", { onClick: startStreaming, className: "px-4 py-2 bg-primary text-primary-foreground rounded-lg hover:opacity-90 transition-all duration-200 shadow-sm hover:shadow-md", children: "Start Streaming Demo" }), _jsx(StreamingMessage, { content: content, isStreaming: isStreaming })] }));
    },
    parameters: {
        docs: {
            description: {
