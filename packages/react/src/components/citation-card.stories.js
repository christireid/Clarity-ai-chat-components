...
export const HighConfidence = {
    args: {
        citation: {
            ...
            chunkText: 'Recent developments in artificial intelligence have demonstrated remarkable progress across various domains. Large language models exhibit emergent capabilities that were not explicitly programmed, suggesting a fundamental shift in how we approach AI systems.',
            confidence: 0.95,
...
export const MediumConfidence = {
    args: {
        citation: {
            ...
            chunkText: 'Machine learning systems trained on massive datasets can generalize to novel scenarios. However, the exact mechanisms behind this generalization remain poorly understood by researchers.',
            confidence: 0.78,
...
export const WithAllMetadata = {
    args: {
        citation: {
            id: 'cite_7',
            source: 'Research Paper: Neural Networks',
            chunkText: 'Convolutional neural networks have revolutionized computer vision by automatically learning hierarchical feature representations from raw pixel data.',
            confidence: 0.93,
...
export const MultipleInList = {
    render: () => {
        ...
        return (_jsx("div", { className: "space-y-3 max-w-2xl", children: citations.map((citation) => (_jsx(CitationCard, { citation: citation, showConfidence: true }, citation.id))) }));
    },
    parameters: {
        docs: {
            description: {
...
export const CustomPreviewLength = {
    args: {
        citation: {
            id: 'cite_8',
            source: 'Book: Deep Learning',
            chunkText: 'Deep learning is a form of machine learning that enables computers to learn from experience and understand the world in terms of a hierarchy of concepts.',
            confidence: 0.87,
...
//# sourceMappingURL=citation-card.stories.js.map