 ...
 * ```
 */
export const StreamCancellation = React.memo(function StreamCancellation({ isStreaming, onCancel, cancelLabel = 'Cancel', iconOnly = false, size = 'default', className, showProgress = true, progressMessage = 'Streaming...', }) {
    if (!isStreaming)
        return null;
