...
export const PersonaPanel = React.memo(function PersonaPanel({ personas, activePersonaId, onSelect, onConfigure, toneSubtitle = 'Switch between tailored assistants optimised for different AI chat workflows.', showTemperature = true, className, }) {
