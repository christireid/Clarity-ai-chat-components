...
export function UsageDashboard({ balance, stats, limits = [], onPurchaseCredits, className, }) {
    ...
    return (_jsxs(Card, { className: cn('h-full flex flex-col', className), children: [_jsx(CardHeader, { children: _jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { children: [_jsxs(CardTitle, { className: "flex items-center gap-2 text-foreground", children: ["Usage Dashboard", isLowBalance && (_jsx(Badge, { variant: "destructive", pulse: true, children: "Low Balance" }))] }), _jsx(CardDescription, { className: "text-muted-foreground/80", children: "Track your usage and manage credits" })] }), onPurchaseCredits && (_jsx(Button, { onClick: onPurchaseCredits, size: "sm", children: "\uD83D\uDCB3 Buy Credits" }))] }) }), _jsx(CardContent, { className: "flex-1 overflow-hidden", children: _jsx(ScrollArea, { className: "h-full", children: _jsxs("div", { className: "space-y-6 pb-4", children: [_jsxs("div", { children: [_jsxs("div", { className: "flex items-center justify-between mb-3", children: [_jsx("h3", { className: "text-sm font-semibold", children: "Credit Balance" }), _jsxs("div", { className: "text-right", children: [_jsx("p", { className: "text-2xl font-bold", children: formatNumber(balance.available) }), _jsxs("p", { className: "text-xs text-muted-foreground", children: ["of ", formatNumber(balance.total), " credits"] })] })] }), _jsx("div", { className: "relative h-3 bg-muted/30 rounded-full overflow-hidden shadow-inner", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${usagePercentage}%` }, transition: { duration: 1, ease: [0.25, 0.1, 0.25, 1] }, className: cn('h-full rounded-full', isLowBalance ? 'bg-gradient-to-r from-red-500 to-destructive' : 'bg-gradient-to-r from-primary/80 to-primary') }) }), _jsxs("div", { className: "flex items-center justify-between mt-2 text-xs text-muted-foreground", children: [_jsxs("span", { children: [formatNumber(balance.used), " used"] }), _jsxs("span", { children: [usagePercentage.toFixed(1), "%"] })] }), balance.nextRefillDate && (_jsxs("p", { className: "text-xs text-muted-foreground mt-2", children: [balance.autoRefill ? '🔄 Auto-refill' : 'Next refill', " on", ' ', balance.nextRefillDate.toLocaleDateString()] }))] }), _jsxs("div", { children: [_jsxs("h3", { className: "text-sm font-semibold mb-3", children: ["Usage This ", stats.period] }), _jsx("div", { className: "grid grid-cols-2 gap-3", children: Object.keys(stats.metrics).map((key) => {
                                            ...
                                            return (_jsxs(motion.div, { initial: { opacity: 0, scale: 0.95, y: 10 }, animate: { opacity: 1, scale: 1, y: 0 }, transition: {
                                                    ...
                                                    'border-amber-500/50 bg-amber-50 dark:bg-amber-950/20'), children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx(motion.span, { className: "text-2xl", initial: { scale: 0 }, animate: { scale: 1 }, transition: { delay: Object.keys(stats.metrics).indexOf(key) * 0.05 + 0.1, type: 'spring', stiffness: 500, damping: 30 }, children: metricIcons[key] }), _jsxs("div", { className: "flex-1 min-w-0", children: [_jsx("p", { className: "text-xs text-muted-foreground/80 truncate", children: metricLabels[key] }), _jsx("p", { className: "text-xl font-bold text-foreground", children: formatNumber(value) })] })] }), limit && (_jsxs("div", { children: [_jsx("div", { className: "h-1.5 bg-muted/30 rounded-full overflow-hidden", children: _jsx(motion.div, { initial: { width: 0 }, animate: { width: `${Math.min(percentage, 100)}%` }, transition: { delay: Object.keys(stats.metrics).indexOf(key) * 0.05 + 0.2, duration: 0.6, ease: [0.25, 0.1, 0.25, 1] }, className: cn('h-full rounded-full', isNearLimit
