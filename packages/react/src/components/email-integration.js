 ...
 * - Email digests
 */
export const EmailIntegration = React.forwardRef(function EmailIntegration({ accounts = [], initialThreads = [], showAccountSelector = true, showNotifications = true, maxThreads = 20, onThreadSelect, onSendEmail: _onSendEmail, onReply, fetchThreads, fetchMessages, markAsRead, className, ...props }, ref) {
