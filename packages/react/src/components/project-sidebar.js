...
export const ProjectSidebar = React.memo(function ProjectSidebar({ projects, selectedProjectId, selectedChatId, onProjectSelect, onProjectCreate, onProjectEdit, onProjectDelete, onChatSelect, onChatCreate, onChatEdit, onChatDelete, className, }) {
