...
export const InteractiveCard = React.memo(React.forwardRef(function InteractiveCard({ interactive = false, selected = false, disabled = false, hoverIntensity = 'medium', showFocusRing = true, showRipple = false, onCardClick, className, children, ...props }, ref) {
    ...
    const { onDrag: _onDrag, onDragStart: _onDragStart, onDragEnd: _onDragEnd, onDragOver: _onDragOver, onDragEnter: _onDragEnter, onDragLeave: _onDragLeave, onDrop: _onDrop, ...motionProps } = props;
    return (
    // @ts-expect-error - framer-motion HTMLMotionProps type complexity issue
    _jsxs(motion.div, { ref: ref, className: cn('relative overflow-hidden rounded-lg border bg-card transition-all duration-150 ease-out shadow-[0_1px_2px_0_rgb(0_0_0_/_0.05)]', interactive && 'cursor-pointer hover:shadow-[0_4px_6px_-1px_rgb(0_0_0_/_0.1),0_2px_4px_-2px_rgb(0_0_0_/_0.1)]', disabled && 'opacity-50 cursor-not-allowed', selected && 'ring-2 ring-primary/50 ring-offset-2 shadow-[0_4px_6px_-1px_rgb(0_0_0_/_0.1),0_2px_4px_-2px_rgb(0_0_0_/_0.1)]', showFocusRing &&
