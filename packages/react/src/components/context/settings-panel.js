...
export function SettingsPanel({ settings, onUpdate, onReset, className, }) {
    ...
    return (_jsxs(Card, { className: cn('h-full flex flex-col', className), children: [_jsxs(CardHeader, { children: [_jsxs("div", { className: "flex items-start justify-between", children: [_jsxs("div", { children: [_jsx(CardTitle, { children: "Settings" }), _jsx(CardDescription, { children: "Customize your AI chat experience" })] }), hasChanges && (_jsx(Badge, { variant: "default", className: "animate-pulse", children: "Unsaved Changes" }))] }), _jsx("div", { className: "flex gap-2 mt-4 overflow-x-auto", children: tabs.map((tab) => (_jsxs(Button, { variant: activeTab === tab.id ? 'default' : 'outline', size: "sm", onClick: () => setActiveTab(tab.id), className: "whitespace-nowrap", children: [tab.icon, " ", tab.label] }, tab.id))) })] }), _jsx(CardContent, { className: "flex-1 overflow-hidden", children: _jsx(ScrollArea, { className: "h-full", children: _jsxs(motion.div, { initial: { opacity: 0, x: 20 }, animate: { opacity: 1, x: 0 }, transition: {
                            ...
                            stiffness: 300,
                                                        ...
                                                        ? 'default'
                                                        : 'outline', size: "sm", onClick: () => handleUpdateUI({
                                                        messageLayout: layout,
                                                    }), children: layout.charAt(0).toUpperCase() + layout.slice(1) }, layout))) })] }), _jsxs("div", { className: "space-y-3", children: [_jsx("h3", { className: "text-sm font-semibold", children: "Display Options" }), [
                                            ...
                                            ].map(({ key, label, description }) => (_jsxs("label", { className: "flex items-start justify-between p-4 rounded-lg border hover:bg-muted/50 cursor-pointer", children: [_jsxs("div", { className: "flex-1", children: [_jsx("p", { className: "text-sm font-medium", children: label }), _jsx("p", { className: "text-xs text-muted-foreground mt-1", children: description })] }), _jsx("input", { type: "checkbox", checked: settings.privacy[key], onChange: (e) => handleUpdatePrivacy({ [key]: e.target.checked }), className: "w-4 h-4 mt-1 ml-4" })] }, key)))] }), _jsxs("div", { className: "p-4 bg-[hsl(var(--warning))]/10 border border-[hsl(var(--warning))]/20 rounded-lg shadow-[0_1px_3px_rgba(15,23,42,0.1)]", children: [_jsx("h4", { className: "text-sm font-medium mb-2", children: "\u26A0\uFE0F Privacy Notice" }), _jsx("p", { className: "text-xs text-muted-foreground", children: "We take your privacy seriously. Your data is encrypted and never shared with third parties without your explicit consent. You can export or delete your data at any time." })] })] })), activeTab === 'notifications' && (_jsxs("div", { className: "space-y-6", children: [_jsxs("div", { className: "space-y-3", children: [_jsx("h3", { className: "text-sm font-semibold", children: "Notification Channels" }), [
