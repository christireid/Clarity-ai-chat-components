...
export const MemoryInspector = ({ memories, isLoading = false, onRemove, onPromote, onRefresh, className, title = defaultTitle, subtitle = defaultSubtitle, showHeaderActions = true, }) => {
    ...
    return (_jsxs(Card, { className: cn('border-border/50 bg-background shadow-[0_4px_6px_-1px_rgb(0_0_0_/_0.1),0_2px_4px_-2px_rgb(0_0_0_/_0.1)]', className), children: [_jsxs(CardHeader, { className: "flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between", children: [_jsxs("div", { className: "space-y-1.5", children: [_jsx(CardTitle, { className: "text-lg font-semibold text-foreground", children: title }), _jsx(CardDescription, { className: "text-sm text-muted-foreground/80", children: subtitle })] }), showHeaderActions && (_jsx("div", { className: "flex items-center gap-2", children: _jsx(Button, { variant: "ghost", size: "sm", onClick: onRefresh, disabled: isLoading, className: "text-muted-foreground hover:text-primary", children: "Refresh" }) }))] }), _jsxs(CardContent, { className: "space-y-6", children: [isLoading && (_jsxs("div", { className: "space-y-4", children: [_jsx(SkeletonText, { lines: 2 }), _jsx(SkeletonText, { lines: 2 }), _jsx(SkeletonText, { lines: 2 })] })), !isLoading && memories.length === 0 && (_jsx("div", { className: "rounded-lg border border-dashed border-border/50 bg-muted p-6 text-center text-sm text-muted-foreground", children: "No memories captured yet. Engage with the assistant to seed persistent context." })), !isLoading &&
                        memories.length > 0 &&
                        Object.keys(grouped)
                            .filter((scope) => grouped[scope].length > 0)
                            .map((scope) => (_jsxs("section", { className: "space-y-3", children: [_jsxs("header", { className: "flex items-center gap-2", children: [_jsx(Badge, { variant: scopeVariant[scope], children: scopeLabel[scope] }), _jsxs("span", { className: "text-xs font-medium text-muted-foreground/70", children: [grouped[scope].length, " item", grouped[scope].length > 1 ? 's' : ''] })] }), _jsx("ul", { className: "space-y-3", children: grouped[scope].map((memory) => (_jsx("li", { className: "rounded-lg border border-border/50 bg-muted p-4 shadow-[0_4px_6px_-1px_rgb(0_0_0_/_0.1),0_2px_4px_-2px_rgb(0_0_0_/_0.1)]", children: _jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3", children: [_jsxs("div", { className: "flex-1 space-y-2", children: [_jsxs("div", { className: "flex flex-wrap items-center gap-2", children: [_jsx("span", { className: "text-sm font-semibold text-foreground", children: memory.label }), memory.type && (_jsx(Badge, { variant: "outline", className: "text-[11px]", children: typeLabel[memory.type] })), memory.layer && (_jsx(Badge, { variant: "outline", className: "text-[11px]", children: layerLabel[memory.layer] })), memory.tokens !== undefined && (_jsxs(Badge, { variant: "outline", className: "text-[11px]", children: [memory.tokens, " tokens"] })), memory.confidence !== undefined && (_jsxs(Badge, { variant: memory.confidence >= 0.7
                                                                        ? 'success'
                                                                        : memory.confidence >= 0.4
                                                                            ? 'warning'
                                                                            : 'destructive', children: ["Confidence", ' ', (memory.confidence * 100).toFixed(0), "%"] })), memory.importanceScore !== undefined && (_jsxs(Badge, { variant: "outline", className: "text-[11px]", children: ["Importance:", ' ', (memory.importanceScore * 100).toFixed(0), "%"] }))] }), _jsx("p", { className: "text-sm text-muted-foreground/85 whitespace-pre-wrap", children: memory.value })] }), _jsxs("div", { className: "flex flex-col items-end gap-2 text-xs text-muted-foreground/70", children: [_jsxs("span", { children: ["Updated ", formatRelative(memory.lastUpdated)] }), memory.source && (_jsxs("span", { children: ["Source: ", memory.source] })), _jsxs("div", { className: "flex gap-2", children: [onPromote && scope !== 'global' && (_jsx(Button, { variant: "ghost", size: "sm", onClick: () => onPromote(memory), className: "text-muted-foreground hover:text-primary", children: "Promote" })), onRemove && (_jsx(Button, { variant: "ghost", size: "sm", onClick: () => onRemove(memory), className: "text-destructive hover:text-destructive", children: "Remove" }))] })] })] }) }, memory.id))) })] }, scope)))] })] }));
};
