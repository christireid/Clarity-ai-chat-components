...
describe('LineNumbers', () => {
  describe('rendering', () => {
    ...
    it('starts from custom line number', () => {
      render(<LineNumbers count={3} startFrom={10} />)
    ...
    it('renders with zero count', () => {
      const { container } = render(<LineNumbers count={0} />)
  ...
  describe('highlighting', () => {
    it('highlights specified lines', () => {
      const { container } = render(
        <LineNumbers count={5} highlightedLines={new Set([2, 4])} />
      )
    ...
    it('highlights added lines (diff)', () => {
      const { container } = render(
        <LineNumbers count={3} addedLines={new Set([2])} />
      )
    ...
    it('highlights removed lines (diff)', () => {
      const { container } = render(
        <LineNumbers count={3} removedLines={new Set([1])} />
      )
  ...
  describe('styling', () => {
    it('applies custom className', () => {
      const { container } = render(
        <LineNumbers count={3} className="custom-class" />
      )
