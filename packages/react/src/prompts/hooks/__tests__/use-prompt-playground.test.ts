...
describe('usePromptPlayground', () => {
  ...
  describe('initialization', () => {
    ...
    it('should initialize with PromptTemplate object', () => {
      ...
      const { result } = renderHook(() =>
        usePromptPlayground({ initialTemplate: template })
      )
  ...
  describe('variable management', () => {
    it('should set single variable', () => {
      const { result } = renderHook(() =>
        usePromptPlayground({ initialTemplate: 'Hello {{name}}' })
      )
    ...
    it('should set multiple variables', () => {
      const { result } = renderHook(() =>
        usePromptPlayground({ initialTemplate: 'Hello {{name}}, age {{age}}' })
      )
  ...
  describe('cost estimation', () => {
    ...
    it('should change model', () => {
      const { result } = renderHook(() =>
        usePromptPlayground({ model: 'gpt-4o' })
      )
