 ...
 */
const getDefaultChromaEndpoint = () => {
 ...
 */
const validateEndpoint = (endpoint, isExplicitConfig) => {
    ...
    if (isLocalhost && isProduction && !isExplicitConfig) {
        console.warn('[ChromaVectorStore] Using localhost endpoint in production environment. ' +
    ...
    if (isLocalhost && !isExplicitConfig && typeof window !== 'undefined') {
        console.info('[ChromaVectorStore] Using default localhost:8000 endpoint. ' +
...
export class ChromaVectorStore {
    ...
    async upsert(vectors, options) {
        ...
        const response = await fetch(`${this.endpoint}/api/v1/collections/${this.collectionId}/upsert`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    async query(query) {
        ...
        const response = await fetch(`${this.endpoint}/api/v1/collections/${this.collectionId}/query`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    async delete(ids, namespace) {
        ...
        const response = await fetch(`${this.endpoint}/api/v1/collections/${this.collectionId}/delete`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    async getStats() {
        ...
        const response = await fetch(`${this.endpoint}/api/v1/collections/${this.collectionId}/count`, {
            method: 'GET',
            headers: {
                'Content-Type': 'application/json',
            },
    ...
    async fetch(ids, namespace) {
        ...
        const response = await fetch(`${this.endpoint}/api/v1/collections/${this.collectionId}/get`, {
            method: 'POST',
            headers: {
                'Content-Type': 'application/json',
            },
