 ...
 */
export function getFramerEasing(key) {
    const easing = EASING_FRAMER[key];
 ...
 */
export function getPreset(key, prefersReducedMotion) {
 ...
 */
export function getInteractionVariant(key, prefersReducedMotion) {
    return prefersReducedMotion
 ...
 */
export function getTransition(duration = 'normal', easing = 'default', prefersReducedMotion = false, delay = 'none') {
 ...
 */
export function getTailwindTransition(duration = 'normal', easing = 'default', properties = 'transition-all') {
 ...
 * ```
 */
export function getCSSEasing(name) {
