...
import { cssKeyframes, easings, durations, animationClasses, prefersReducedMotion, getAccessibleAnimation, createAnimation, createTransition, injectKeyframes, buttonAnimation, cardAnimation, iconAnimation, useReducedMotion, useAnimations, } from '../zero-dependency';
// Mock matchMedia
...
describe('Zero-Dependency Animation System', () => {
    ...
    describe('Easing Functions', () => {
        it('contains all expected easings', () => {
            ...
            expectedEasings.forEach((easing) => {
                expect(easings[easing]).toBeDefined();
            });
        });
    ...
    describe('Duration Standards', () => {
        it('contains all expected durations', () => {
            ...
            expectedDurations.forEach((duration) => {
                expect(durations[duration]).toBeDefined();
            });
        });
    ...
    describe('Animation Classes', () => {
        it('contains all expected animation classes', () => {
            ...
            expectedClasses.forEach((className) => {
                expect(animationClasses[className]).toBeDefined();
            });
        });
        ...
        it('has shimmer background properties', () => {
            const shimmer = animationClasses.shimmer;
    ...
    describe('Utility Functions', () => {
        ...
        describe('createAnimation', () => {
            ...
            it('creates animation style with custom parameters', () => {
                const style = createAnimation('slideIn', '0.5s', easings.spring, '0.1s', 'infinite', 'alternate', 'forwards');
    ...
    describe('Edge Cases', () => {
        ...
        it('handles null/undefined parameters gracefully', () => {
            const style1 = createAnimation(null, null, null);
            const style2 = createTransition(null, null, null);
    ...
    describe('Integration Tests', () => {
        it('integrates all components correctly', () => {
            const TestComponent = () => {
                ...
                return (_jsxs("div", { children: [_jsx("div", { "data-testid": "reduced-motion", children: reducedMotion.toString() }), _jsx("div", { "data-testid": "accessible-class", children: accessibleClass }), _jsx("div", { "data-testid": "custom-animation", children: customAnimation.animation }), _jsx("div", { "data-testid": "custom-transition", children: customTransition.transition })] }));
            };
            render(_jsx(TestComponent, {}));
            expect(screen.getByTestId('reduced-motion')).toHaveTextContent('false');
        ...
        it('handles reduced motion integration', () => {
            ...
            const TestComponent = () => {
                const reducedMotion = useReducedMotion();
                const accessibleClass = getAccessibleAnimation('fade-in', 'opacity-100');
                return (_jsxs("div", { children: [_jsx("div", { "data-testid": "reduced-motion", children: reducedMotion.toString() }), _jsx("div", { "data-testid": "accessible-class", children: accessibleClass })] }));
            };
            render(_jsx(TestComponent, {}));
...
//# sourceMappingURL=zero-dependency.test.js.map