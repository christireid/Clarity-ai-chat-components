...
export function ResizableChatExample() {
  ...
  return (
    <ResizableChatLayout
      ...
      header={<div className="p-3 font-semibold">AI Assistant</div>}
      footer={
        <ChatInput
          onSubmit={(msg) => chat.append({ role: 'user', content: msg })}
        />
      }
...
export function FlowTokenStreamingExample() {
  ...
  const simulateStream = () => {
    const text =
      'This is a demonstration of FlowToken streaming animations. Each word animates in smoothly.'
    setContent('')
    setIsStreaming(true)
    let index = 0
        ...
        sidebar={
          <div className="p-4">
            ...
            <button
              ...
              className="w-full px-3 py-2 text-sm rounded bg-muted hover:bg-muted/80"
            >
              Clear Chat
            </button>
          </div>
