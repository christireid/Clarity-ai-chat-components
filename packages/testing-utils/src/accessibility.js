 ...
 * ```
 */
export async function expectAccessible(container, options) {
 ...
 * ```
 */
export async function expectWCAGLevel(container, level) {
 ...
 * ```
 */
export function expectKeyboardAccessible(element) {
    // Check tabindex
 ...
 * ```
 */
export function expectProperLabels(element) {
 ...
 * ```
 */
export function expectFocusManagement(container) {
 ...
 * ```
 */
export async function expectColorContrast(container) {
    const results = await axe(container, {
        runOnly: {
            type: 'tag',
