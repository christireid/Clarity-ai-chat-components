 ...
 */
export function expectHasClass(element, className) {
    expect(element.classList.contains(className)).toBe(true);
}
/**
 * Assert component has aria attribute
 */
export function expectHasAria(element, attribute, value) {
 ...
 */
export function expectVisible(element) {
 ...
 */
export function expectHasFocus(element) {
 ...
 * Assert error state
 */
export function expectError(container, message) {
 ...
 */
export function expectMatchesSnapshot(container, name) {
    expect(container).toMatchSnapshot(name);
}
/**
 * Assert proper shadow DOM structure
 */
export function expectShadowClasses(element, expectedClasses) {
 ...
 */
export function expectTransitionClasses(element) {
    const classes = Array.from(element.classList);
    const hasTransition = classes.some(c => c.includes('transition') || c.includes('duration') || c.includes('ease'));
    expect(hasTransition).toBe(true);
}
/**
 * Assert design system patterns
 */
export function expectDesignSystemPatterns(element) {
    const classes = Array.from(element.classList);
