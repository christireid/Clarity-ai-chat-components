...
describe('FileStore', () => {
  ...
  describe('search', () => {
    it('should find memories by text content', async () => {
      const memories = [
        { id: '1', type: 'episodic' as const, content: 'The quick brown fox', timestamp: Date.now(), importance: 0.5 },
        { id: '2', type: 'episodic' as const, content: 'Lazy dog sleeping', timestamp: Date.now(), importance: 0.5 },
        { id: '3', type: 'episodic' as const, content: 'Fox and dog playing', timestamp: Date.now(), importance: 0.5 },
      ]
    ...
    it('should filter by type', async () => {
      const memories = [
        { id: '1', type: 'episodic' as const, content: 'Episodic memory', timestamp: Date.now(), importance: 0.5 },
        { id: '2', type: 'semantic' as const, content: 'Semantic memory', timestamp: Date.now(), importance: 0.5 },
      ]
