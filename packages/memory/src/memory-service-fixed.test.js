...
describe('MemoryServiceFixed', () => {
    ...
    describe('constructor', () => {
        ...
        it('should handle missing config gracefully', () => {
            expect(() => new MemoryServiceFixed({})).toThrow();
        });
    });
    describe('addMemory', () => {
        ...
        it('should handle null content gracefully', async () => {
            await expect(service.addMemory(null, 'episodic', 'session')).rejects.toThrow('Content cannot be empty');
        });
    });
    describe('addMemories', () => {
        ...
        it('should handle null input gracefully', async () => {
            const memories = await service.addMemories(null);
            expect(memories).toEqual([]);
        });
    });
    describe('get', () => {
        ...
        it('should return null for null id', async () => {
            const retrieved = await service.get(null);
            expect(retrieved).toBeNull();
        });
    ...
    describe('query', () => {
        ...
        it('should handle null query gracefully', async () => {
            const results = await service.query(null);
            expect(results).toEqual([]);
        });
    });
    describe('getStats', () => {
