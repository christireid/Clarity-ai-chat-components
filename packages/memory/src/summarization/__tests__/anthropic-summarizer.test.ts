...
describe('AnthropicSummarizer', () => {
  let summarizer: AnthropicSummarizer
  let noRetrySummarizer: AnthropicSummarizer
  ...
  describe('summarize', () => {
    ...
    it('should fail after max retries', async () => {
      ...
      await expect(fastSummarizer.summarize('Test', 100)).rejects.toThrow(
  ...
  describe('response validation', () => {
    it('should throw on null response', async () => {
      ...
      await expect(noRetrySummarizer.summarize('Test', 100)).rejects.toThrow(
        'Invalid Anthropic response: expected object'
      )
    })
    ...
    it('should throw on missing content array', async () => {
      ...
      await expect(noRetrySummarizer.summarize('Test', 100)).rejects.toThrow(
        'missing or empty content array'
      )
    })
  ...
  describe('summarizeBatch', () => {
    ...
    it('should handle partial failures', async () => {
      ...
      await expect(
        noRetrySummarizer.summarizeBatch(['Good', 'Bad'], 100)
      ).rejects.toThrow()
    })
  })
