...
export function useFocusManagement(containerRef, options = {}) {
    ...
    useEffect(() => {
        ...
        focusableElementsRef.current = Array.from(containerRef.current.querySelectorAll(focusableSelectors)).filter((el) => el instanceof HTMLElement && isFocusable(el));
 ...
 */
export function useScreenReaderAnnounce(message, options = {}) {
 ...
 */
export function useColorContrast(foregroundColor, backgroundColor) {
 ...
 */
export function usePrefersReducedMotionLegacy() {
 ...
 */
export function useIdLegacy(prefix) {
