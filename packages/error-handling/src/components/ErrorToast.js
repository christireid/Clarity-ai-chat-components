...
// =============================================================================
function ErrorIcon() {
    return (_jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("line", { x1: "15", y1: "9", x2: "9", y2: "15" }), _jsx("line", { x1: "9", y1: "9", x2: "15", y2: "15" })] }));
}
function WarningIcon() {
    return (_jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("path", { d: "M10.29 3.86L1.82 18a2 2 0 001.71 3h16.94a2 2 0 001.71-3L13.71 3.86a2 2 0 00-3.42 0z" }), _jsx("line", { x1: "12", y1: "9", x2: "12", y2: "13" }), _jsx("line", { x1: "12", y1: "17", x2: "12.01", y2: "17" })] }));
}
function SuccessIcon({ animate }) {
    return (_jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("path", { d: "M9 12l2 2 4-4", style: {
                    strokeDasharray: 24,
...
function InfoIcon() {
    return (_jsxs("svg", { width: "18", height: "18", viewBox: "0 0 24 24", fill: "none", stroke: "white", strokeWidth: "2.5", strokeLinecap: "round", strokeLinejoin: "round", children: [_jsx("circle", { cx: "12", cy: "12", r: "10" }), _jsx("line", { x1: "12", y1: "16", x2: "12", y2: "12" }), _jsx("line", { x1: "12", y1: "8", x2: "12.01", y2: "8" })] }));
}
function getIcon(type, animate) {
    switch (type) {
        case 'error':
        ...
        case 'success':
            return _jsx(SuccessIcon, { animate: animate });
        case 'info':
...
function ToastItem({ toast, onRemove, position, index }) {
    ...
    const remainingTimeRef = React.useRef(toast.duration ?? 5000);
    ...
    const getAnimation = () => {
        if (prefersReducedMotion)
            return 'none';
        if (isExiting)
            return 'toastSlideOut 0.3s ease-out forwards';
    ...
    if (toast.error && isClarityError(toast.error)) {
        errorCode = toast.error.code;
        errorSolution = toast.error.solution;
    }
    return (_jsxs("div", { role: "alert", "aria-live": "polite", style: {
            ...
            overflow: 'hidden',
                    ...
                    background: config.gradient,
                }, "aria-hidden": "true" }), _jsxs("div", { style: { display: 'flex', alignItems: 'flex-start', gap: '12px' }, children: [_jsx("div", { style: {
                            flexShrink: 0,
                            width: '32px',
                            height: '32px',
                            borderRadius: '10px',
                            ...
                            animation: !prefersReducedMotion
                                ...
                                : 'none',
                        }, children: getIcon(toast.type, !prefersReducedMotion) }), _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [toast.title && (_jsxs("div", { style: {
                                    display: 'flex',
                                    alignItems: 'center',
                                    gap: '8px',
                                    marginBottom: '4px',
                                            ...
                                            lineHeight: 1.3,
                                        }, children: toast.title }), errorCode && (_jsx("span", { style: {
                                            fontSize: '0.65rem',
                                            fontWeight: 600,
                                            padding: '2px 6px',
                                            borderRadius: '4px',
                                ...
                                }, children: toast.message }), errorSolution && (_jsxs("p", { style: {
                                    margin: '8px 0 0',
                                    fontSize: '0.75rem',
                                    color: '#059669',
                                    lineHeight: 1.4,
                                    ...
                                    gap: '4px',
                                }, children: [_jsx("span", { "aria-hidden": "true", children: "\uD83D\uDCA1" }), errorSolution] })), toast.action && (_jsx("button", { onClick: toast.action.onClick, style: {
                                    marginTop: '10px',
                                    padding: '6px 12px',
                                    fontSize: '0.75rem',
                                    fontWeight: 600,
                                ...
                                }, children: toast.action.label }))] }), toast.dismissible !== false && (_jsx("button", { onClick: handleDismiss, "aria-label": "Dismiss notification", style: {
                            flexShrink: 0,
                            width: '24px',
                            height: '24px',
                            display: 'flex',
                            ...
                            e.currentTarget.style.outline = 'none';
                        }, children: _jsxs("svg", { width: "14", height: "14", viewBox: "0 0 24 24", fill: "none", stroke: "currentColor", strokeWidth: "2", children: [_jsx("line", { x1: "18", y1: "6", x2: "6", y2: "18" }), _jsx("line", { x1: "6", y1: "6", x2: "18", y2: "18" })] }) }))] }), showProgress && (_jsx("div", { style: {
                    position: 'absolute',
                    bottom: 0,
                    left: 0,
                    right: 0,
 ...
 * ```
 */
export function ToastProvider({ children, position = 'top-right', maxToasts = 5, defaultDuration = 5000, gap = 12, offset = 16, }) {
    ...
    const showError = React.useCallback((error, options) => {
        ...
        return addToast({
            ...
            message: options?.message ??
                (isClarity ? err.userMessage : err.message),
            error: err,
            ...options,
        });
    }, [addToast]);
    ...
    return (_jsxs(ToastContext.Provider, { value: value, children: [_jsx("style", { children: toastKeyframes }), children, _jsx("div", { style: getPositionStyles(), "aria-live": "polite", "aria-label": "Notifications", children: toasts.map((toast, index) => (_jsx("div", { style: { pointerEvents: 'auto' }, children: _jsx(ToastItem, { toast: toast, onRemove: () => removeToast(toast.id), position: position, index: index }) }, toast.id))) })] }));
}
// =============================================================================
// Hook
// =============================================================================
