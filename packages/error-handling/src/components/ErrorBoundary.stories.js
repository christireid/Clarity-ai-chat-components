...
export const CustomFallback = {
    args: {
        children: _jsx(ThrowError, {}),
        fallback: ({ error, resetError }) => (_jsxs("div", { style: {
                padding: '2rem',
                border: '2px solid red',
                borderRadius: '8px',
            }, children: [_jsx("h2", { children: "Custom Error UI" }), _jsx("p", { children: error.message }), _jsx("button", { onClick: resetError, children: "Reset" })] })),
    },
};
