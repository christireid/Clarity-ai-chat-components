...
import { useFocusManagement, useScreenReaderAnnounce, useHighContrastMode, useReducedMotion, useColorContrast, useKeyboardNavigation, useFocusManagementLegacy, useFocusTrap, useAnnounce, usePrefersReducedMotion, useIdLegacy, } from '../accessibility';
// Mock SecureLogger
...
describe('Enhanced Accessibility Utilities', () => {
    ...
    describe('useFocusManagement', () => {
        it('should manage focus within container', () => {
            ...
            querySelectorSpy.mockReturnValue(mockFocusableElements);
        ...
        it('should trap focus when enabled', () => {
            ...
            const { result, unmount } = renderHook(() => useFocusManagement({ current: container }, { trapFocus: true }));
            act(() => {
                // Simulate component mount
            });
        ...
        it('should restore focus on unmount', () => {
            ...
            previousFocus.focus();
            const { result } = renderHook(() => useFocusManagement({ current: container }, { restoreFocus: true }));
            act(() => {
                // Simulate component mount
            });
            // Simulate unmount
    ...
    describe('useScreenReaderAnnounce', () => {
        it('should create ARIA live region', () => {
            ...
            const { result } = renderHook(() => useScreenReaderAnnounce('Test announcement'));
            act(() => {
                // Allow effect to run
            });
        ...
        it('should announce messages with delay', () => {
            vi.useFakeTimers();
            const { result } = renderHook(() => useScreenReaderAnnounce('Delayed message', { delay: 500 }));
            act(() => {
        ...
        it('should handle different priority levels', () => {
            const { result: politeResult } = renderHook(() => useScreenReaderAnnounce('Polite message', { priority: 'polite' }));
            const { result: assertiveResult } = renderHook(() => useScreenReaderAnnounce('Assertive message', { priority: 'assertive' }));
            act(() => {
        ...
        it('should cleanup on unmount', () => {
            ...
            const { unmount } = renderHook(() => useScreenReaderAnnounce('Test message'));
            act(() => {
                // Allow effect to run
            });
            unmount();
    ...
    describe('useColorContrast', () => {
        ...
        it('should handle invalid colors', () => {
            const { result } = renderHook(() => useColorContrast('invalid', '#ffffff'));
    ...
    describe('Integration Tests', () => {
        ...
        it('should handle error scenarios gracefully', () => {
            ...
            const { result } = renderHook(() => useFocusManagement(invalidContainerRef));
