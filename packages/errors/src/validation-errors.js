...
export class ValidationError extends ClarityError {
    constructor(message, errors, originalError) {
        ...
        super('VALIDATION_ERROR', 'Input validation failed', message, solutions, {
...
export class InvalidInputError extends ClarityError {
    constructor(fieldName, expectedFormat, actualValue, originalError) {
        const solutions = [
            {
        ...
        super('INVALID_INPUT', `Invalid value for ${fieldName}`, `Expected ${expectedFormat}, got ${typeof actualValue}`, solutions, {
            location: 'Input validation',
...
export class MissingFieldError extends ClarityError {
    constructor(fieldName, originalError) {
        const solutions = [
            {
  ...
  // ... other fields
        ...
        super('MISSING_FIELD', `Required field '${fieldName}' is missing`, `The field '${fieldName}' is required but was not provided`, solutions, {
            location: 'Input validation',
...
export class TypeMismatchError extends ClarityError {
    constructor(fieldName, expectedType, actualType, originalError) {
        const solutions = [
            {
        ...
        super('TYPE_MISMATCH', `Type mismatch for ${fieldName}`, `Expected ${expectedType}, got ${actualType}`, solutions, {
...
// Helper functions
function getValidationExample(fieldName, format) {
    const examples = {
...
function getTypeConversionExample(field, from, to) {
    const conversions = {
        string: {
