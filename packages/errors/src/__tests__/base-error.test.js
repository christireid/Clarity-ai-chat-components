...
describe('ClarityError', () => {
    describe('Constructor', () => {
        it('should create error with basic properties', () => {
            const error = new TestError('TEST_ERROR', 'Something went wrong', 'Technical details here');
        ...
        it('should preserve original error', () => {
            ...
            const error = new TestError('TEST', 'message', 'technical', [], {}, originalError);
...
//# sourceMappingURL=base-error.test.js.map