...
describe('EnvVarMissingError', () => {
  ...
  it('should suggest copying from example file', () => {
    ...
    const copyExample = error.solutions.find((s) =>
      s.description.includes('Copy from')
    )
...
describe('PortAlreadyInUseError', () => {
  ...
  it('should suggest killing the process', () => {
    ...
    const killSolution = error.solutions.find((s) =>
      s.description.includes('Kill')
    )
...
describe('FileNotFoundError', () => {
  ...
  it('should suggest checking path', () => {
    ...
    const pathSolution = error.solutions.find((s) =>
      s.description.includes('Check the file path')
    )
...
describe('DependencyMissingError', () => {
  ...
  it('should suggest clean install', () => {
    ...
    const cleanInstall = error.solutions.find((s) =>
      s.description.includes('Install all')
    )
