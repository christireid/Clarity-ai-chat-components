...
export function useKeyboardShortcuts({ onShare, onRun, onCopy, onReset, onToggleTheme, onToggleConsole, onToggleSettings, onEscape, enabled = true, }) {
    const handleKeyDown = useCallback((event) => {
        ...
        const isMonacoEditor = typeof target.closest === 'function'
...
export function getShortcutLabel(key) {
