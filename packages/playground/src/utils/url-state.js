 ...
 */
export function decodePlaygroundState(encoded) {
    try {
 ...
 */
export function createShareableUrl(state, baseUrl) {
...
export function parseUrlState() {
    ...
    if (codeParam) {
        ...
        if (code) {
            return {
                code,
                theme: params.get(URL_THEME_PARAM) || 'light',
 ...
 */
export function estimateCompressionRatio(code) {
