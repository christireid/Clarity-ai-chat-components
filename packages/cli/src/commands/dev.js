...
export async function devCommand(options) {
    ...
    try {
        ...
        console.log();
        console.log(errorBox(error instanceof Error ? error.message : 'Invalid port number', '✗ Configuration Error'));
        console.log();
        process.exit(1);
    }
    console.log();
    ...
    try {
        ...
        console.log();
        console.log(errorBox('Failed to start development server. Check the error above.', '✗ Error'));
        console.log();
        process.exit(1);
    }
}
