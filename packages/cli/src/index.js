...
program
    ...
    .alias('g')
    .description('⚡ Generate code (component, hook, context, chat-component, adapter, api-route, test)')
    ...
    .option('-y, --yes', 'Skip confirmation prompts')
    .option('--provider <provider>', 'AI provider: openai, anthropic, google (for adapter/api-route)')
    .option('--with-streaming', 'Include streaming support (for chat-component/api-route)')
