...
import type { ClarityLicensePayload, GenerateLicenseOptions } from './types'
...
export function generateLicenseKey(
  ...
  // Build payload
  const payload: ClarityLicensePayload = {
    orderNumber,
    licensee,
    email,
    plan,
 ...
 */
export function verifyLicenseChecksum(
  licenseKey: string,
  secretKey: string
): boolean {
 ...
 */
export function generateLicenseKeyBatch(
  licenses: GenerateLicenseOptions[],
  secretKey: string
): string[] {
