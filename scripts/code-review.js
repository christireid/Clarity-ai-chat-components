...
const REVIEW_TYPES = {
    full: {
        name: 'Full Review',
        description: 'All domains: security, performance, TypeScript, Tailwind, architecture',
...
async function selectReviewType(rl) {
...
function generatePrompt(type, files, fileContents) {
