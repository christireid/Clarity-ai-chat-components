...
**Purpose**: Document specific API improvements inspired by competitive analysis

This document outlines 15 concrete API improvement opportunities for Clarity Chat Components, based on competitive research of 24+ AI UI libraries. Each improvement includes before/after examples, benefits, effort estimates, and breaking change assessments.
...
**Effort**: 1 week
**Breaking change**: No (keep old API, add new pattern)
**Migration path**: Provide codemod to convert prop-based to slot-based
...
**Effort**: 1.5 weeks
**Breaking change**: No (keep simple API, add compound pattern)
**Migration path**: Simple API becomes shorthand for compound pattern
...
**Effort**: 2 weeks
**Breaking change**: No (layer on top of existing API)
...
**Impact**: Low - Naming change only
**Effort**: 1 day
**Breaking change**: Yes (provide aliases for old props)
**Migration path**:
```tsx
...
**Migration path**: Optional enhancement for advanced users
...
**Impact**: Medium - Better HTML semantics
**Effort**: 3 days
**Breaking change**: No (default behavior unchanged)
**Migration path**: Opt-in feature via `as` prop
...
**Impact**: High - Maximum customization power
**Effort**: 3 days
**Breaking change**: No (additive pattern)
**Migration path**: Optional advanced pattern
...
**Impact**: High - Better composability
**Effort**: 1 week
**Breaking change**: No (keep simple API for defaults)
**Migration path**: Simple API remains, compound pattern is opt-in
...
**Effort**: 2 days
**Breaking change**: Minor (event structure changes)
**Migration path**: Update event.data['field'] to event.field
...
**Effort**: 1 day
**Breaking change**: Yes (function name changes)
**Migration path**: Provide aliases for old names with deprecation warnings
...
**Effort**: 2 days
**Breaking change**: Yes (config structure changes)
**Migration path**: Merge `config` into `features`
...
**Impact**: Medium - Better for multi-chat apps
**Effort**: 2 days
**Breaking change**: No (additive feature)
**Migration path**: Opt-in enhancement
...
**Effort**: 3 days
**Breaking change**: No (improves defaults)
**Migration path**: Automatic - better defaults apply immediately
...
**Effort**: 1 week
**Breaking change**: Minor (stricter types)
...
**Impact**: High - Enables new use cases
**Effort**: 2 weeks
**Breaking change**: No (separate import path)
**Migration path**: Opt-in via `@clarity-chat/react/primitives`
...
### Complexity Increase
**Risk**: New patterns confuse beginners
**Mitigation**:
...
### Maintenance Burden
**Risk**: Supporting both old and new APIs
**Mitigation**:
...
These 15 API improvements represent a significant evolution of Clarity Chat Components toward best-in-class developer experience. By adopting proven patterns from successful competitors while maintaining our unique strengths (token optimization, memory management, production-readiness), we can establish Clarity as the definitive React component library for AI chat interfaces.
