...
This directory contains all the business, sales, marketing, and legal documentation needed to commercialize Clarity Chat. These materials are separate from the technical component library and can be moved to a dedicated business/sales repository.
...
- `/apps/docs-site` - Technical documentation
