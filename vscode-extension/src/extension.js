...
export function activate(context) {
    ...
    // Register commands
    context.subscriptions.push(vscode.commands.registerCommand('clarity-chat.initProject', initProjectCommand), vscode.commands.registerCommand('clarity-chat.addProvider', addProviderCommand), vscode.commands.registerCommand('clarity-chat.validateConfig', validateConfigCommand), vscode.commands.registerCommand('clarity-chat.showExamples', showExamplesCommand), vscode.commands.registerCommand('clarity-chat.showPreview', () => {
    ...
    vscode.workspace.onDidChangeConfiguration((e) => {
        if (e.affectsConfiguration('clarity-chat')) {
            vscode.window
                .showInformationMessage('Clarity Chat configuration changed. Reload window to apply changes.', 'Reload')
                .then((selection) => {
                if (selection === 'Reload') {
...
function showWelcomeMessage(context) {
    ...
    vscode.window
        .showInformationMessage(message, 'Initialize Project', 'Show Examples', "Don't Show Again")
        .then((selection) => {
